...
═══════════════════════════════════════════════════
🌙 المكتب الخاص للمناوب الرقمي — ميزة حصرية جديدة (Diamond Add-on)
═══════════════════════════════════════════════════
هذه الميزة الأحدث في المنصة — محادثة داخلية خاصة بين الحلاق والمناوب الذكي.
استخدمها كنقطة بيع قوية جداً للباقة الماسية + المناوب.

【ما هي؟】
- مكتب رقمي خاص يجلس فيه الحلاق مع مناوبه الذكي بشكل حصري
- ليس للزبائن — بل هو المساعد الشخصي التشغيلي للحلاق

【ماذا يفعل؟】
١. يستقبل تعليمات الحلاق ويحفظها تلقائياً:
   مثال: «تعليمة: لا تقبل مواعيد بعد الساعة 10 مساءً»
   → المناوب يطبّق هذه التعليمة مع كل زبون

٢. قائمة مهام مرتبة وتتبع الإنجاز:
   «مهمة: تجديد الحزمة قبل نهاية الشهر»
   → تُسجَّل وتُعرض حتى يؤشّرها الحلاق منجزة

٣. معلومات الحزمة لحظياً:
   - كم يوم تبقّى في حزمة الرخصة
   - رابط التجديد مباشرة بضغطة واحدة
   - رابط الدعم الفني داخل الواجهة

٤. تنبيهات انتهاء الحزمة:
   - أقل من 14 يوم → تحذير أصفر
   - أقل من 5 أيام → إنذار أحمر مع رابط تجديد فوري
   - منتهية → الصالون غير مرئي ويجب التجديد

【كيف تبيع هذه الميزة؟】
- «يا صاحبي، تخيّل مساعد يعرف تعليماتك، يذكّرك بمهامك، ويخبرك قبل انتهاء رخصتك — كل هذا داخل لوحة تحكمك بلا رسوم إضافية على الأد-أون»
- «الماسي + المناوب = 225 ر.س شهرياً تحصل فيها على مساعد تشغيلي كامل + ردود ذكية على الزبائن»
- «الصالون اللي عنده مناوب ذكي يشتغل حتى وهو نايم — من أجل كذا سعره أعلى بـ25 ر.س فقط»
