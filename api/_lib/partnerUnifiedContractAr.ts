  ...
  sections: [
    {
      ...
      content:
        'الطرف الأول: منصة حلاق ماب (الجهة المشغّلة للخدمة الرقمية)، المعرّف النظامي — الرقم الوطني الموحد للسجل التجاري: 7054117093. الطرف الثاني (الشريك): صاحب الصلاحية التجارية والنظامية لممارسة النشاط التجاري، وتعتبر بياناته المدخلة في مسار الخدمات البرمجية للمنصة صحيحة ومحدثة.',
    },
    {
      id: 2,
    ...
    },
    {
      ...
      content:
        'يلتزم الشريك بدفع رسوم الباقة المحددة المتفق عليها (150، 200، 300 ريال) بشكل دوري عبر بوابة الدفع المعتمدة. جميع المدفوعات غير قابلة للاسترداد بعد تفعيل الباقة والظهور.',
    },
    {
      id: 5,
    ...
    },
    {
      ...
      content:
        "يقر الشريك بأن كافة حقوق الملكية الفكرية، الكود المصدري (Source Code)، الواجهات، التصاميم، والعلامة التجارية لـ 'حلاق ماب' هي ملكية حصرية ومطلقة لمنصة حلاق ماب، ويُرجَع في تحديد الجهة النظامية المالكة إلى الرقم الوطني الموحد للسجل التجاري: 7054117093.",
    },
    {
      id: 7,
