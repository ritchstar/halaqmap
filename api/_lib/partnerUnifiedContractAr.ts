...
export const PARTNER_UNIFIED_CONTRACT = {
  ...
  sections: [
    ...
    },
    {
      ...
      content:
        'مسار الخدمات البرمجية للمنصة: المسار الرقمي الموحد للتعريف بالخدمة وإتمام الاشتراك والدفع. الخدمة الرقمية: خدمات البرمجيات والاستضافة والواجهات للظهور على منصة حلاق ماب.',
    },
    {
      id: 3,
      title: 'المادة (3) — طبيعة الخدمة وحدود المسؤولية',
      content:
        'يقتصر دور المنصة على توفير البنية التحتية الرقمية والربط التقني عبر نظام الرصد الذكي والواجهات المتاحة. الشريك هو المسؤول الحصري والكامل عن دقة المواعيد المحددة وجودة الخدمات والالتزام بالاشتراطات النظامية والصحية.',
    },
    {
      id: 4,
