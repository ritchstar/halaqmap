...
const B2C_MARKETING_SKILLS = [
  ...
  '- محتوى قصير (`Reels`/`Shorts`): سيناريو «أبحث عن حلاق في الحي → أفتح حلاق ماب → أجد الأقرب» — الشعار في أول 3 ثوانٍ.',
...
export function buildB2cMarketingSystemPrompt(ctx: B2cMarketingContext): string {
  return appendUniversalAgentDoctrines(
    ...
    '- كل توصية يجب أن تجيب ضمناً: كيف نجذب باحثاً عن حلاق قريب في هذه المنطقة؟',
