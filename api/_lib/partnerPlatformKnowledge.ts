...
function composePartnerProductFactsPack(): string {
  return [
    ...
    '- **البرونزي:** بداية رسمية بأقل تعقيد: ظهور عند الطلب للزبائن القريبين، بطاقة صالون فيها موقع/اتصال/واتساب/صور أساسية، أوقات عمل وحالة مفتوح/مغلق، وشهادة تفعيل بعد الدفع.',
