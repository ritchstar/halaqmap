...
export type StoreMailThemeId = 'wedding' | 'event' | 'lounge' | 'grocers' | 'restaurant' | 'cafe' | 'kitchen' | 'produce' | 'halana' | 'dates' | 'bakhurna' | 'affiliate';
...
export function buildBakhurnaLiveLinksHtml(input: {
  shopUrl: string;
  deskUrl: string;
  expiresLabel: string;
  renewed?: boolean;
