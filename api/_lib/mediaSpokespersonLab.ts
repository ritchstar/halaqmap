...
const PLATFORM_TIMELINE = [
  ...
  '- المرحلة الثالثة: عقيدة «الظهور عند الطلب» (On-Demand Visibility) — حضور جغرافي غير ثابت يُفعَّل برمجياً عند تنشّط الطلب في محيط المزود، ضمن حزم رخصة بمدة 30 يوم نفاذ لكل حزمة. تموضع تقني صريح لا يخلط بين الترخيص البرمجي والوساطة التجارية.',
