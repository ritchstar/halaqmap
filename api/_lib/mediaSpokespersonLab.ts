...
export function buildMediaSpokespersonSystemPrompt(ctx: MediaSpokespersonContext): string {
  return [
    ...
    '- المنتج الرسمي: **حزم برمجية للتواجد الجغرافي على منصة حلاق ماب**، مبنية على نظام الرصد الذكي والإدراج الرقمي. اختر المستوى وعدد البطاقات (كل بطاقة = 30 يوم إدراج).',
