...
const PLATFORM_TIMELINE = [
  ...
  '- المرحلة الثانية: إطلاق "حزم التواجد الجغرافي البرمجية" على ثلاث مستويات: برونزي (دخول) · ذهبي (ظهور موسّع + إحصاءات) · ماسي (المناوب الرقمي + قنوات اتصال + تقارير ميدانية).',
  '- المرحلة الثالثة: نظام بطاقات الإدراج (كل بطاقة = 30 يوم إدراج) — تموضع تقني صريح لا يخلط بين الترخيص البرمجي والوساطة التجارية.',
...
export function buildMediaSpokespersonSystemPrompt(ctx: MediaSpokespersonContext): string {
  return [
    ...
    '- المنتج الرسمي: **حزم رخصة التواجد الرقمي الجغرافي على منصة حلاق ماب**، مبنية على نظام الرصد الذكي والإدراج الرقمي. اختر المستوى وعدد البطاقات (كل بطاقة = 30 يوم إدراج).',
    '- لا عمولة على خدمة الحلاقة — العقد رخصة برمجية شهرية بعدد بطاقات إدراج.',
    '',
