...
const PLATFORM_TIMELINE = [
  ...
  '- المرحلة الثانية: إطلاق "حزم التواجد الجغرافي البرمجية" على ثلاث مستويات: برونزي (دخول) · ذهبي (ظهور موسّع + إحصاءات) · ماسي (رخصة تقنية + Add-on المناوب الرقمي اختياري).',
