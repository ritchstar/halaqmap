...
export const PARTNER_CONSULTABLE_AGENTS: readonly PartnerCouncilAgentDef[] = [
  ...
  },
  {
    ...
    publicBriefLines: [
      'مسار الانضمام: (1) طلب شراكة + تأشيرات التعهد الإلزامية (2) الدفع عبر بوابة الدفع (3) تفعيل تلقائي + شهادة نجاح (4) لوحة الحلاق.',
      'لا وثائق حكومية إلزامية — لا سجل تجاري ولا رخصة بلدية في التسجيل؛ الامتثال = التعهد القانوني + التحقق التقني.',
      'لا «اعتماد يدوي» ولا «مراجعة وثائق» افتراضي بعد الدفع — الاستثناءات إدارية فقط عند تأخير.',
      'حزم رخصة 30 يوم: برونزي 200 · ذهبي 300 · ماسي 400 ر.س — Add-on المناوب +50 للماسية.',
    ],
  },
  {
  ...
  },
  {
    ...
    topicKeywords: ['ترقية', 'باقة', 'ذهبي', 'ماسي', 'برونز', 'فرق', 'مقارنة', 'معرض', 'بنر', 'مجتمع', 'ماب', 'فيديو', 'شات'],
    publicBriefLines: [
      ...
      'مجتمع ماب: مساحة مهنية للحلاقين المفعّلين ومنسوبي المنصة؛ فيديوهات قصيرة + Map Chat + مساعد ماب.',
      'إضاءة أيقونة مجتمع ماب بفوشيا/سماوي نابض تعني وجود مشاركات جديدة؛ لا يحتاج الشريك لقراءة تنبيه طويل.',
      'الدخول للمجتمع محصور بالإداريين/المشرفين والحلاقين المفعّلين.',
    ],
  },
  {
    ...
    publicBriefLines: [
      'الحلاق يتحمل مسؤولية امتثال منشأته عبر التعهد القانوني الإلزامي — المنصة مزوّد حلول تقنية لا وسيط تجاري.',
      'لا وثائق حكومية مطلوبة في التسجيل — لا تدقيق سجل تجاري ولا رخصة بلدية كمرفقات.',
...
export const PARTNER_ORCHESTRATION_RULES_AR = [
  ...
  '**حقيقة نمو المنصة — ضمّنها عند التردد:** وصول حلاق ماب للمستخدمين مسألة وقت. الحلاقة حاجة متكررة غير قابلة للإلغاء — السؤال الوحيد: هل الصالون في القائمة حين يبحث عنه الزبون؟',
  ...
  '**مسموح** أن تقول: «منصة حلاق ماب»، «المناوب الرقمي»، «نظام الاستجابة الذكية»، «حزمة الرخصة» — بلغة منتج واضحة.',
