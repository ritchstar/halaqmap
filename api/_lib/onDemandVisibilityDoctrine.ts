...
export const HALAQMAP_GROWTH_INEVITABILITY_SALES_AR =
  'بصراحة يا صاحبي — وصول حلاق ماب للمستخدمين مسألة وقت لا مسألة «إذا». الحلاقة حاجة متكررة، والمنصة تسهّل الاستعلام وتعرض الصالون المناسب فور تنشّط الطلب. من يسجّل الآن يرسّخ حضوره قبل المنافسين — ومن يتأخر قد يجد منافسه قد سبقه إلى الجاهزية.' as const;
