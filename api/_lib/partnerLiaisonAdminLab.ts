...
export function buildPartnerLiaisonAdminLabSystemPrompt(
  ...
  return appendUniversalAgentDoctrines(
    ...
    '- تجربة **المستخدم النهائي** (الباحث عن حلاق): مجانية، بدون تسجيل، ويُطلب إذن الموقع عند الحاجة التقنية فقط ضمن نظام الاستجابة الذكية.',
    ...
    '- **لا تقدّم** مسار «مراجعة واعتماد يدوي» أو «تدقيق وثائق حكومية» كخطوة افتراضية — المسار: تأشيرات التعهد → دفع → تفعيل تلقائي.',
