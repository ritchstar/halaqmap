...
async function markShiftWalletEmpty(
  ...
  await upsertRecommendation(supabase, {
    ...
    body: 'توقفت الردود الآلية لأن رصيد محفظة المناوب منتهٍ. شحن الرصيد يعيد تفعيل المناوبة فوراً.',
  });
}
  ...
  await upsertRecommendation(supabase, {
    ...
    body:
      decision.trigger === 'shop_closed'
        ? 'تفضل، المناوب رد على عميل أثناء إغلاق المحل. راجع المحادثة عند فتح الصالون.'
