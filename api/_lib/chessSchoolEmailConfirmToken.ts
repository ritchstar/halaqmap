 ...
 */
/**
 * رمز تأكيد بريد تسجيل مدرسة الشطرنج — HMAC قصير العمر (على نمط bronzeTrialEmailConfirmToken.ts).
 */
...
function resolveSecret(): string | null {
  const s = (
    process.env.CHESS_SCHOOL_EMAIL_CONFIRM_SECRET ||
...
export function mintChessSchoolEmailConfirmToken(input: {
...
export function verifyChessSchoolEmailConfirmToken(
  token: string,
