...
export async function sendBakhurnaGiftConfirmEmail(input: { to: string; confirmUrl: string }): Promise<boolean> {
      ...
      [
        {
          ...
          markAr: STORE_LINK_ROLE_EMOJI.gift,
          titleAr: 'تأكيد البريد',
          captionAr: 'هدية بخورنا1',
          theme: 'bakhurna',
        },
      ],
    ],
  ...
  return sendStoreResendEmail({
    to: input.to,
    subject: 'تأكيد المشاركة في هدية بخورنا1',
    html,
  });
}
