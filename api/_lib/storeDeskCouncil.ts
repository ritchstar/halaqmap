...
export function buildStoreDeskCouncilPrompt(brief: StoreDeskRequestBrief): string {
  ...
  return [
    ...
    'وكيل العروض الفاخرة: يصوغ عرضاً جذاباً يستعرض البرمجيات دون أسعار ثابتة ودون وعد تنفيذ قبل المراجعة الإدارية. إن ناسب الطلب منتج كوافير ماب فليُشر إلى صفحة خطط الظهور بلغة مطمئنة، دون ذكر ترتيب صفحات البحث أو عبارات داخلية.',
