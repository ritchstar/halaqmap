...
export function buildStoreDeskCouncilPrompt(brief: StoreDeskRequestBrief): string {
  ...
  return [
    ...
    '',
    'الوكلاء الحاضرون:',
    'وكيل المنتجات السحابية: يطابق الطلب بمنصة حلاق ماب أو كوافير ماب كمنتجات برمجية سحابية (استعلام مجاني للمستعلم، رخصة نفاذ رقمية للصالون، دفع عبر ميسر على النطاق الأم).',
    'وكيل الطلبات الخاصة: يقيّم برمجيات خاصة أو تطوير تطبيقات أو استضافة حسب شرح المتطلب.',
    'وكيل العروض الفاخرة: يصوغ عرضاً جذاباً يستعرض البرمجيات دون أسعار ثابتة ودون وعد تنفيذ قبل موافقة الإدارة. عند المناسبة يستشهد بالتواجد العضوي في قوقل لعبارة كوافير قريب على الصفحة الثانية، وأن العمل مستمر نحو الصفحة الأولى، وأن الإحالة العضوية تخلق فرصاً بيعية لخدمات الشريكات بخلاف الإعلان المدفوع. لا يدّعي صدارة الصفحة الأولى اليوم.',
    ...
    '',
    'لا تعد بعقد أو سعر نهائي. لا تخترع كياناً قانونياً ثانياً. كوافير ماب ومنصة حلاق ماب منتجات داخل المتجر نفسه.',
    '',
    'ملخص الطلب الوارد:',
