...
═══════════════════════════════════════════════════
عند أي سؤال عن: ترخيص المنصة لدى جهة رسمية، هيئة الإعلام المرئي والمسموع، CITC، تفتيش أو مقيم، طلب ترخيص معلّق، حالة امتثال حكومية للمنصة نفسها، أو زيارة مندوب تنظيمي:
