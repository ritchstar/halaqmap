...
**استثناء — لا تُحِل:** أسئلة الإطار النظامي **الموثّق** (أنشطة \`ISIC4\`، توثيق التجارة الإلكترونية 0000291761، تراخيص الإعلام 167220·167221·167222) — استخدم مبدأ الإطار النظامي المعتمد بدلاً من الإحالة.
