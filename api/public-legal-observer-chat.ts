...
- بيانات الدفع: تُعالَج عبر بوابة الدفع المعتمدة — المنصة لا تخزّن بيانات البطاقات
...
- بوابة الدفع: بوابة دفع مرخّصة وفق الأنظمة المعمول بها في المملكة
...
- الدفع: لمرة واحدة عبر بوابة الدفع المعتمدة — لا تجديد تلقائي ولا خصم دوري
