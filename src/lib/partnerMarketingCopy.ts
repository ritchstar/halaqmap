...
export const PARTNER_LANDING_PLAN_CARDS = [
  {
    ...
    tier: 'bronze',
    title: 'برونزية',
    subtitle: 'بداية رسمية: كن موجوداً عندما يبحث زبون قريب',
    points: [
      'ظهور عند الطلب في محيطك حتى لا تخسر زبوناً يبحث عن صالون قريب الآن.',
  ...
  },
  {
    ...
    points: [
      'كل مزايا البرونزي مع أولوية ذهبية تزيد فرصة اختيارك عند تنشّط الطلب في محيطك.',
  ...
  },
  {
    ...
    points: [
      'كل مزايا الذهبي مع أعلى أولوية ماسية للطلبات القريبة في منطقتك.',
      ...
      'مناسبة لمن يريد صدارة المنطقة وتجربة أقرب إلى VIP بدون تشغيل يدوي زائد.',
    ],
  },
] as const;
