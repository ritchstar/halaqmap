...
export const PARTNER_LANDING_HERO = {
  ...
  lead: PARTNER_MALL_HERO_LEAD_DESKTOP_AR,
...
export const PARTNER_LANDING_BENEFITS_SECTION = {
  ...
  items: [
    ...
    },
    {
      ...
      body: 'تابع منشأتك من جوالك — حالة المحل، النشاط، والتنبيهات — قراءة فقط بلا نصوص زبائن. رابط جاهز في بريد التفعيل (ذهبي وماسي).',
    },
    {
...
export const PARTNER_LANDING_PLAN_CARDS = [
  ...
  },
  {
    ...
    points: [
      ...
      'ملاحظة: يلزم آيباد أو لابتوب خاص بالصالون لإدارة الحساب واستقبال العملاء عبر اللوحة.',
  ...
  sections: [
    {
      ...
      body:
        'تظهر عند استعلام يناسب موقعك وفلترك — لا إشغالاً دائماً لملفك. كل ظهور = مستعلم في لحظة الحاجة؛ والقرار متى تكون «مفتوحاً» بيدك لحظياً.',
    },
    {
    ...
    },
    {
      ...
      body:
        'نموذجنا: استعلام حي بعد إذن الموقع، ظهور عند تطابق الفلتر، وتواصل مباشر مع صالونك. الجماهيرية والسيو قائمان والمزيد قادم. زبون واحد إضافي شهرياً يغطي الذهبي في أغلب الحالات — بدون وعد بعدد زبائن.',
    },
  ],
  ...
  chapters: [
    {
      title: 'لماذا نظام الاستجابة الذكية؟',
      body:
        'لأنه يجعل المنافسة صادقة: النية قابلة للتحويل، والاستجابة تتم في نفس لحظة الطلب. عندما يفهم العميل أنك متاح الآن وتظهر له ضمن البيانات المناسبة، يقلّ حاجز التجربة.',
    },
    {
...
export const PARTNER_DIGITAL_ASSISTANT = {
  ...
  tips: [
    ...
    'اقرأ صفحة «خطط التسويق» و«لماذا تنضم؟» و«القصة والمسار» إن أردت الإقناع العميق قبل تعبئة الطلب.',
...
export function partnerAssistantHintForPath(pathname: string): string {
  ...
  if (p.includes('/partners/marketing')) {
    return 'هنا تعهدات الانتشار السبعة: بحث، إعلان، ميدان، مواسم، وكلاء ذكاء، وكروت طلب. إن اتضحت لك الخطة، أكمل طلب الانضمام.';
  }
