/**
 * محادثة دعم فني لمسار الخدمات البرمجية للمنصة — جلسة 60 دقيقة، معزولة لكل رابط فريد (?t=).
 * التخزين محلي في المتصفح لعرض الرسائل داخل الصفحة فقط؛ الإرسال الفعلي للفريق يتم عبر واتساب من الواجهة.
 */
