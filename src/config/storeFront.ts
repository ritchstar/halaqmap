...
export const STORE_LANDING_COPY = {
  ...
  pitchH1Ar: 'شغلك ما يحتاج متجر إلكتروني يفرض عليك طريقته.',
  pitchDedicatedLineAr:
    'صفحة مستقلة باسم نشاطك، تعرض ما تقدمه وتوجّه زبائنك إليك مباشرة.',
  pitchNotMarketplaceAr: 'ليست سوقاً مشتركاً، ولا صفحة تجمعك مع أنشطة أخرى.',
  pitchTransformAr: 'منتجاتنا تنقلك من انتظارهم… إلى جوالاتهم.',
  pitchExploreCtaAr: 'اكتشف المنتج المناسب لشغلك',
  /** زر ثانوي في الشاشة الأولى — يدخل تجربة صفحة المسارات (/store/paths-lab) للتحقق من الاهتمام قبل أي قرار دمج نهائي. */
