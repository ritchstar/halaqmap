...
export const STORE_LANDING_COPY = {
  documentTitle: `منصة خريطة الحل — ${STORE_BRAND_LATIN}`,
  shopNameAr: 'منصة خريطة الحل',
  ...
  heroLead:
    'سواء كنت تملك نشاطاً تجارياً، وثيقة عمل حر، أو مهنة خاصة؛ نقدّم لك في منصة خريطة الحل منظومة متكاملة من البرمجيات والخدمات السحابية المبتكرة الجاهزة للتنفيذ، والمصممة خصيصاً لرفع كفاءة أعمالك وتنميتها.',
  ...
  heroShotAlt: 'واجهة برمجية حية لمنصة خريطة الحل',
  heroShotCaption: 'منتجات برمجية حية ضمن منصة خريطة الحل',
  softwareStripTitle: 'طابع برمجي من المنتجات الحالية',
  roleLine: 'متجر إلكتروني للبيع بالتجزئة للبرمجيات.',
  requestTitle: 'طلب خدمات منصة خريطة الحل',
  requestLead:
  ...
  newestLeadAr:
    'خضارنا1، وتمويناتا1، وطبختنا1، وحلانا1، ومطعمنا1، وكافينا1، وافراحي1، واجواء1، ولاونجا1. كل منتج على صفحته بسعره، وصفحة نشاطك الحية مخصصة لك وحدك باسم نشاطك.',
  pitchH1Ar: 'خلِّ شغلك مرتب وواضح من جوالك',
  pitchKickerAr: 'مفهوم حديث للمتاجر الإلكترونية',
  pitchDedicatedLineAr:
    'اختر الأداة المناسبة لنشاطك، اعرض ما تقدمه لعملائك، وأدر صفحتك وبياناتك من مكان واحد.',
  pitchNotMarketplaceAr:
    'لا قالب عام يفرض أسلوبه عليك، ولا وسيط يتدخل في علاقتك بزبونك ومدفوعاتك.',
  pitchTransformAr: '',
  pitchExploreCtaAr: 'ساعدني في الاختيار',
  /** زر أساسي في الشاشة الأولى — صفحة المسارات. */
  pitchPathsCtaAr: 'اختر ما يناسب نشاطك',
  /** زر ثانوي — تطبيق المشغّلين على Google Play. */
  pitchOperatorsAppCtaAr: 'حمّل تطبيق إدارة نشاطك',
  pitchOperatorsAppNoteAr: 'بعد التسجيل، استخدم تطبيقك لإدارة نشاطك من جوالك.',
  ...
  philosophyBodyAr: [
    ...
    'تطوّر منصة خريطة الحل صفحات وأدوات رقمية مخصصة لطبيعة المهنة والخدمة، تساعدك على عرض ما تقدمه وتنظيم الطلب أو التواصل بطريقة تناسب شغلك.',
    'لا نعد بنتيجة لا يستطيع أحد ضمانها، لكننا نبني السبب العملي للوصول والتنظيم والاستمرار.',
  ],
  philosophyClosingAr: 'منتج مخصص لطبيعة نشاطك، وصفحة زبائن مخصصة لك.',
  pitchProductsBridgeAr: 'اختر المسار الرقمي الذي يناسب طريقة شغلك.',
  ...
  deskChatLead: 'من واجهة منصة خريطة الحل. جلسة ستون دقيقة، والرد يصلك هنا.',
  ...
  /** بوابة ساحة الشطرنج على المنصة الأم — منتج من منتجات خريطة الحل. */
  chessDoorTitleAr: 'العب الشطرنج ضد الذكاء الاصطناعي',
  chessDoorLeadAr: 'ساحة شطرنج من منتجات منصة خريطة الحل: العب ضد الذكاء الاصطناعي من جوالك أو جهازك.',
  chessDoorCtaAr: 'افتح ساحة الشطرنج',
  chessDoorHref: 'https://www.halaqmap.com/#/chess',
  ...
  bakhurnaLiveLeadAr: 'اعرض أصناف البخور والعود والعطور واستقبل طلبات الحي.',
  bakhurnaLiveCtaAr: 'افتح بخورنا1',
...
export const STORE_ENGAGE_COPY = {
  rateAr: 'قيّم منصة خريطة الحل',
  shareAr: 'شارك منصة خريطة الحل',
  rateTitleAr: 'قيّم منصة خريطة الحل',
  rateLeadAr: 'إن أعجبتك منصة خريطة الحل، اختر عدد النجوم.',
  rateSendAr: 'إرسال التقييم',
  rateThanksAr: 'شكراً لتقييمك.',
  shareTitleAr: 'شارك منصة خريطة الحل',
  shareLeadAr: 'أرسل رابط منصة خريطة الحل لمن يحتاجه.',
  shareTextAr: 'منصة خريطة الحل — برمجيات وخدمات سحابية. كاردي8، افراحي1، اجواء1، لاونجا1، وتمويناتا1.',
  copyAr: 'نسخ الرابط',
  copiedAr: 'تم النسخ',
  whatsappAr: 'واتساب',
} as const;
...
export const STORE_ABOUT_COPY = {
  documentTitle: `عن منصة خريطة الحل — ${STORE_BRAND_LATIN}`,
  kickerAr: 'عن منصة خريطة الحل',
  titleAr: 'نصنع حضوراً رقمياً ينقلك من انتظار عملائك… إلى جوالاتهم.',
  introLeadAr:
    'منصة خريطة الحل منظومة رقمية سعودية تطوّر منتجات برمجية سحابية متخصصة للمنشآت والمهن والأعمال الفردية.',
  introBodyAr:
  ...
  howTitleAr: 'كيف تعمل منصة خريطة الحل؟',
  howBodyAr:
  ...
  samplesLeadAr:
    'تطوّر منصة خريطة الحل منتجات متخصصة لقطاعات ومهن مختلفة. لكل منتج نطاقه التشغيلي وصفحته ومزاياه وطريقة طلبه، وتتوسع المنظومة مع دراسة احتياجات الأنشطة والأسواق.',
  samplesEcosystemAr:
  ...
  specializedGroupTitleAr: 'منتجات منصة خريطة الحل المتخصصة',
  ...
  pathCards: [
    ...
    {
      titleAr: 'طلب تجربة',
      bodyAr: 'سجل ثم أكد ايميلك واستلم متجرك فوراً.',
      ctaAr: 'اطلب التجربة',
  ...
  reliabilityBodyAr:
    'تعمل منصة خريطة الحل وفق الأنشطة التجارية والتراخيص المسجلة للمنشأة، وتُراجع الطلبات البرمجية الخاصة قبل التنفيذ للتحقق من ملاءمتها للنطاق الفني والأنشطة المقدمة.',
  officialChannelsTitleAr: 'القنوات الرسمية للشراء',
  officialChannelsBodyAr:
    'متجر منصة خريطة الحل ونطاقاته الرسمية هي المرجع المعتمد لعرض المنتجات وطلبها والتحقق من معلوماتها. ننصح بعدم إجراء أي عملية شراء أو تحويل بناءً على روابط أو حسابات غير موضحة في صفحاتنا الرسمية.',
  governanceTitleAr: 'الالتزام والحوكمة',
  governanceBodyAr:
    'نوضح نطاق كل منتج أو خدمة، وطريقة الدفع أو الاشتراك، ومسؤوليات الأطراف قبل التنفيذ، مع المحافظة على الفصل بين دور منصة خريطة الحل ودور مشغّل المنتج في علاقته بعملائه.',
  trustLegalAr:
    'تضم منظومة منصة خريطة الحل مصنفات برمجية مسجلة لدى الهيئة السعودية للملكية الفكرية.',
  ...
  customBodyAr:
    'إذا لم يناسبك أحد المنتجات الجاهزة، يمكنك شرح احتياجك من خلال نموذج الطلب. تدرس الإدارة الفكرة ونطاقها الفني ومدى ملاءمتها لخدمات منصة خريطة الحل، ثم تقدم تصوراً وعرضاً قبل بدء التنفيذ.',
  ...
  processSteps: [
    ...
    },
    {
      ...
      bodyAr:
        'تراجع الإدارة الاحتياج ونطاقه الفني، وتتحقق من ملاءمته لخدمات منصة خريطة الحل وإمكانات التنفيذ.',
    },
    {
      titleAr: 'تقديم العرض',
      bodyAr:
...
export const STORE_ABOUT_FEATURED_PRODUCTS = [
  ...
  },
  {
    ...
    imageAlt: 'قاعة مناسبة من منتجات منصة خريطة الحل',
  },
] as const;
...
export const STORE_TRUST_COPY = {
  ...
  metaDescriptionAr:
    'بيانات توثيق متجر منصة خريطة الحل، والأنشطة التجارية المسجلة، والمصنفات البرمجية المسجلة، وروابط فحوص الاتصال وسمعة النطاق.',
  navAr: 'التوثيق والتحقق',
  titleAr: 'التوثيق والتحقق',
  leadAr:
    'تجمع هذه الصفحة بيانات توثيق متجر منصة خريطة الحل، والأنشطة التجارية المسجلة، وشهادات تسجيل المصنفات البرمجية، وفحوص الاتصال وسمعة النطاق. ويمكن فتح المصادر الخارجية للاطلاع على البيانات والنتائج المتاحة مباشرة.',
  scansTimingNoteAr:
  ...
  ecomBodyAr:
    'متجر منصة خريطة الحل موثّق لدى المركز السعودي للأعمال، ويمكن التحقق من بيانات التوثيق باستخدام الرقم الظاهر أدناه من خلال بوابة الاستعلام الرسمية.',
...
export const STORE_COMMISSION_COPY = {
  ...
  leadAr:
    'تدير المنظومة برامج تسويق منفصلة لحلاق ماب، وكوافير ماب، ومنتجات متجر منصة خريطة الحل. لكل برنامج شروطه وبوابته وآلية احتساب العمولة الخاصة به.',
