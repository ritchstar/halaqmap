...
export const STORE_LANDING_COPY = {
  ...
  heroReadyExample:
    'من أمثلة الأعمال الحالية: حلاق ماب وكوافير ماب، وكاردي8، وافراحي1، واجواء1، ولاونجا1، وتمويناتا1.',
  ...
  newestLeadAr:
    'افراحي1 رجالي ونسائي، واجواء1، ولاونجا1، وتمويناتا1، ومطعمنا1. كل منتج على صفحته بسعره.',
...
export const STORE_ABOUT_COPY = {
  ...
  activitiesLicenseNoticeAr:
    'نعمل وفق أنشطة تجارية وتراخيص إعلامية تخوّلنا التصميم والإنتاج والبيع بالتجزئة للبرمجيات، ونقدّم خلالها حلولًا برمجية لا تجدها إلا في متجر خريطة الحل. لا تتعامل أبدًا مع أي موقع إن لم تتأكد من امتلاكه للتراخيص ونظاميته، فبدونها قد تتعرّض لعمليات احتيالية من منظمات غير مرخّصة.',
  activitiesLicenseNoticeCloseAr:
    'نملك السجلات والتراخيص التي تخوّلنا لمثل هذه الممارسات، وهي تخضع لشروط وتعهدات وقيد قبل أن يُرخص لها.',
  activitiesLead:
  ...
  productsLead:
    'من أعمال المتجر الحالية: حلاق ماب وكوافير ماب كمنتجين قطاعيين لهما بنرهما، وكاردي8، وافراحي1، واجواء1، ولاونجا1، وتمويناتا1. القائمة تتوسع مع الطلبات والابتكارات.',
