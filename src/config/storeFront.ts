...
export const STORE_LANDING_COPY = {
  ...
  weddingLiveTitleAr: 'افراحي1',
  weddingLiveLeadAr:
    'دعوة زفاف حيّة: يسرنا دعوتكم إلى حفل زفاف ابننا أو ابنتنا، مع قاعة الشاشة والتهاني. السعر الافتتاحي 899 ر.س.',
  weddingLiveCtaAr: 'افتح افراحي1',
  weddingLiveWomenTitleAr: 'افراحي1 نسائي',
  weddingLiveWomenLeadAr:
    'دعوة زفاف نسائية حيّة تدعو منها والدة العريس أو والدة العروس بصفة الداعية. السعر الافتتاحي 899 ر.س.',
