...
export const STORE_TRUST_COPY = {
  documentTitle: `${STORE_BRAND_LATIN} — التوثيق والتحقق`,
  navAr: 'التوثيق والتحقق',
  kicker: STORE_ENGLISH_LINE,
  titleAr: 'التوثيق والتحقق',
  leadAr:
    'تجمع هذه الصفحة بيانات التوثيق والفحوص المستقلة لمتجر البرمجيات، مع توثيق التجارة الإلكترونية ونشاط السجل. ليست ترتيب بحث، وليست وعداً بعدد زبائن. الروابط علنية، فتأكد بنفسك.',
