...
export const STORE_LANDING_COPY = {
  documentTitle: `منصة طريقة الحل — ${STORE_BRAND_LATIN}`,
  shopNameAr: 'منصة طريقة الحل',
  ...
  heroLead:
    'سواء كنت تملك نشاطاً تجارياً، وثيقة عمل حر، أو مهنة خاصة؛ نقدّم لك في منصة طريقة الحل منظومة متكاملة من البرمجيات والخدمات السحابية المبتكرة الجاهزة للتنفيذ، والمصممة خصيصاً لرفع كفاءة أعمالك وتنميتها.',
  ...
  heroShotAlt: 'واجهة برمجية حية لمنصة طريقة الحل',
  heroShotCaption: 'منتجات برمجية حية ضمن منصة طريقة الحل',
  softwareStripTitle: 'طابع برمجي من المنتجات الحالية',
  roleLine: 'متجر إلكتروني للبيع بالتجزئة للبرمجيات.',
  requestTitle: 'طلب خدمات منصة طريقة الحل',
  requestLead:
  ...
  philosophyBodyAr: [
    ...
    'تطوّر منصة طريقة الحل صفحات وأدوات رقمية مخصصة لطبيعة المهنة والخدمة، تساعدك على عرض ما تقدمه وتنظيم الطلب أو التواصل بطريقة تناسب شغلك.',
  ...
  deskChatLead: 'من واجهة منصة طريقة الحل. جلسة ستون دقيقة، والرد يصلك هنا.',
...
export const STORE_ENGAGE_COPY = {
  rateAr: 'قيّم منصة طريقة الحل',
  shareAr: 'شارك منصة طريقة الحل',
  rateTitleAr: 'قيّم منصة طريقة الحل',
  rateLeadAr: 'إن أعجبتك منصة طريقة الحل، اختر عدد النجوم.',
  rateSendAr: 'إرسال التقييم',
  rateThanksAr: 'شكراً لتقييمك.',
  shareTitleAr: 'شارك منصة طريقة الحل',
  shareLeadAr: 'أرسل رابط منصة طريقة الحل لمن يحتاجه.',
  shareTextAr: 'منصة طريقة الحل — برمجيات وخدمات سحابية. كاردي8، افراحي1، اجواء1، لاونجا1، وتمويناتا1.',
  copyAr: 'نسخ الرابط',
  copiedAr: 'تم النسخ',
  whatsappAr: 'واتساب',
} as const;
...
export const STORE_ABOUT_COPY = {
  documentTitle: `عن منصة طريقة الحل — ${STORE_BRAND_LATIN}`,
  kickerAr: 'عن منصة طريقة الحل',
  titleAr: 'نصنع حضوراً رقمياً ينقلك من انتظار عملائك… إلى جوالاتهم.',
  introLeadAr:
    'منصة طريقة الحل منظومة رقمية سعودية تطوّر منتجات برمجية سحابية متخصصة للمنشآت والمهن والأعمال الفردية.',
  introBodyAr:
  ...
  howTitleAr: 'كيف تعمل منصة طريقة الحل؟',
  howBodyAr:
  ...
  samplesLeadAr:
    'تطوّر منصة طريقة الحل منتجات متخصصة لقطاعات ومهن مختلفة. لكل منتج نطاقه التشغيلي وصفحته ومزاياه وطريقة طلبه، وتتوسع المنظومة مع دراسة احتياجات الأنشطة والأسواق.',
  samplesEcosystemAr:
  ...
  specializedGroupTitleAr: 'منتجات منصة طريقة الحل المتخصصة',
  ...
  reliabilityBodyAr:
    'تعمل منصة طريقة الحل وفق الأنشطة التجارية والتراخيص المسجلة للمنشأة، وتُراجع الطلبات البرمجية الخاصة قبل التنفيذ للتحقق من ملاءمتها للنطاق الفني والأنشطة المقدمة.',
  officialChannelsTitleAr: 'القنوات الرسمية للشراء',
  officialChannelsBodyAr:
    'متجر منصة طريقة الحل ونطاقاته الرسمية هي المرجع المعتمد لعرض المنتجات وطلبها والتحقق من معلوماتها. ننصح بعدم إجراء أي عملية شراء أو تحويل بناءً على روابط أو حسابات غير موضحة في صفحاتنا الرسمية.',
  governanceTitleAr: 'الالتزام والحوكمة',
  governanceBodyAr:
    'نوضح نطاق كل منتج أو خدمة، وطريقة الدفع أو الاشتراك، ومسؤوليات الأطراف قبل التنفيذ، مع المحافظة على الفصل بين دور منصة طريقة الحل ودور مشغّل المنتج في علاقته بعملائه.',
  trustLegalAr:
    'تضم منظومة منصة طريقة الحل مصنفات برمجية مسجلة لدى الهيئة السعودية للملكية الفكرية.',
  ...
  customBodyAr:
    'إذا لم يناسبك أحد المنتجات الجاهزة، يمكنك شرح احتياجك من خلال نموذج الطلب. تدرس الإدارة الفكرة ونطاقها الفني ومدى ملاءمتها لخدمات منصة طريقة الحل، ثم تقدم تصوراً وعرضاً قبل بدء التنفيذ.',
  ...
  processSteps: [
    ...
    },
    {
      ...
      bodyAr:
        'تراجع الإدارة الاحتياج ونطاقه الفني، وتتحقق من ملاءمته لخدمات منصة طريقة الحل وإمكانات التنفيذ.',
    },
    {
      titleAr: 'تقديم العرض',
      bodyAr:
...
export const STORE_ABOUT_FEATURED_PRODUCTS = [
  ...
  },
  {
    ...
    imageAlt: 'قاعة مناسبة من منتجات منصة طريقة الحل',
  },
] as const;
...
export const STORE_TRUST_COPY = {
  ...
  metaDescriptionAr:
    'بيانات توثيق متجر منصة طريقة الحل، والأنشطة التجارية المسجلة، والمصنفات البرمجية المسجلة، وروابط فحوص الاتصال وسمعة النطاق.',
  navAr: 'التوثيق والتحقق',
  titleAr: 'التوثيق والتحقق',
  leadAr:
    'تجمع هذه الصفحة بيانات توثيق متجر منصة طريقة الحل، والأنشطة التجارية المسجلة، وشهادات تسجيل المصنفات البرمجية، وفحوص الاتصال وسمعة النطاق. ويمكن فتح المصادر الخارجية للاطلاع على البيانات والنتائج المتاحة مباشرة.',
  scansTimingNoteAr:
  ...
  ecomBodyAr:
    'متجر منصة طريقة الحل موثّق لدى المركز السعودي للأعمال، ويمكن التحقق من بيانات التوثيق باستخدام الرقم الظاهر أدناه من خلال بوابة الاستعلام الرسمية.',
...
export const STORE_COMMISSION_COPY = {
  ...
  leadAr:
    'تدير المنظومة برامج تسويق منفصلة لحلاق ماب، وكوافير ماب، ومنتجات متجر منصة طريقة الحل. لكل برنامج شروطه وبوابته وآلية احتساب العمولة الخاصة به.',
