...
export const STORE_LANDING_COPY = {
  ...
  pitchSupportAr: 'منتجات خريطة الحل مصممة حول سير عملك.',
  pitchTransformAr: 'منتجاتنا تنقلك من انتظارهم… إلى جوالاتهم.',
  pitchClosingAr: 'وبطريقة تمشي مع شغلك، لا بطريقة يفرضها عليك نظام عام.',
  pitchFlowAr: 'عرضك → طلب العميل → تشغيلك',
  pitchExploreCtaAr: 'استكشف المنتج المناسب لشغلك',
