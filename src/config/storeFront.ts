...
export const STORE_LANDING_COPY = {
  ...
  pitchH1Ar: 'متجرك على مقاس مهنتك.',
  pitchDedicatedLineAr:
    'منتجات تشغيل رقمية متخصصة تبدأ من طبيعة عملك؛ تمنح نشاطك صفحة خاصة، وعرضاً أوضح، ومساراً أبسط للطلب والتشغيل.',
  ...
  pitchPathsCtaAr: 'استكشف المسارات',
