...
export const STORE_ABOUT_COPY = {
  ...
  productsLead:
    'من أعمال المتجر الحالية: حلاق ماب وكوافير ماب كمنتجين قطاعيين لهما بنرهما، وبطاقة مناسبة، وقاعات حيّة، ولاونجا1. القائمة تتوسع مع الطلبات والابتكارات.',
  ...
  cloudPoints: [
    ...
    'بطاقة مناسبة وقاعات حيّة ولاونجا1 على صفحاتها.',
