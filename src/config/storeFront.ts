...
export const STORE_LANDING_COPY = {
  ...
  pitchH1Ar: 'اختر مسارك، وابدأ تشغيله من جوالك.',
  pitchKickerAr: 'مفهوم حديث للمتاجر الإلكترونية',
  pitchDedicatedLineAr:
    'اختر المنتج الأقرب لطبيعة مهنتك، وبعد التفعيل استخدم تطبيق مشغّلي خريطة الحل للوصول إلى تشغيلاتك المرتبطة ببريدك من مكان واحد.',
