...
export const STORE_PRODUCT_BENEFITS_COPY = {
  documentTitle: 'مزايا المنتجات — منصة خريطة الحل',
  ...
  markAfterAr: '، والاسم الظاهر منصة خريطة الحل. منصة حلاق ماب المنتج البرمجي الأول، لا اسم المتجر.',
  ...
  legalPoints: [
    ...
    'ستة مصنفات برمجية مسجّلة لدى الهيئة السعودية للملكية الفكرية: كافينا1، تمويناتا1، خضارنا1، طبختنا1، لاونجا1، وأجواء1. الأرقام في التوثيق والتحقق وفي تذييل المتجر.',
    LEGAL_MEDIA_LICENSE_FOOTER_LINE_AR,
  ...
  aboutCtaAr: 'من نحن',
  trustCtaAr: 'عرض بيانات التوثيق والتحقق',
  aboutTeaserKickerAr: 'شرح مبسط قبل الاختيار',
  aboutTeaserTitleAr: 'ما المقصود بالمنتجات السحابية؟',
  aboutTeaserBodyAr:
