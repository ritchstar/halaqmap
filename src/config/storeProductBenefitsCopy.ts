...
export const STORE_PRODUCT_BENEFITS_COPY = {
  ...
  aboutTeaserKickerAr: 'لماذا المنتجات السحابية؟',
  aboutTeaserTitleAr: 'ما هي الخدمات السحابية؟',
  aboutTeaserBodyAr:
    'المنتج يعمل عبر الإنترنت من جوالك أو حاسوبك، دون خادم في المحل أو قرص تثبيت. التفاصيل العملية والفرق بين عائلات المنتجات في صفحة مزايا المنتجات.',
} as const;
