...
export const FOUNDER_DESK_COPY = {
  ...
  whatsappPrefillAr: 'مرحباً، أريد محادثة مباشرة مع halaqmap — منصة خريطة الحل.',
  ...
  visitorPageTitleAr: 'halaqmap — منصة خريطة الحل — محادثة خاصة',
