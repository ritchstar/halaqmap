...
export const FOUNDER_DESK_COPY = {
  ...
  whatsappPrefillAr: 'مرحباً، أريد محادثة مباشرة مع halaqmap — منصة طريقة الحل.',
  ...
  visitorPageTitleAr: 'halaqmap — منصة طريقة الحل — محادثة خاصة',
