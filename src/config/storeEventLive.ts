...
export const STORE_EVENT_LIVE = {
  documentTitle: 'دعوة حرة تفاعلية — خريطة الحل',
  kickerAr: 'قاعة مناسبتك على الشاشة — حيّة من أول تجربة',
  titleAr: 'دعوة حرة تفاعلية',
  leadAr:
  ...
  termsFoldBodyAr:
    'المنتج مستقل عن رخصة النفاذ وعن بطاقة المناسبة وعن دعوة الزواج. السعر الافتتاحي 899 ر.س، والدفع عبر ميسر على نطاق www.halaqmap.com. الروابط سرية ومؤقتة، ويمكن حفظ الصفحة قبل انتهائها. التهاني جدار عام من رابط ضيف واحد، بلا قائمة حضور وبلا إرسال جماعي وبلا شات. التفاصيل الكاملة في شروط إصدار البطاقات.',
  hubKickerAr: 'صنّف الدعوة من البداية',
  hubTitleAr: 'دعوة حرة تفاعلية',
  hubLeadAr:
...
export const STORE_EVENT_LIVE_WOMEN = {
  documentTitle: 'دعوة حرة تفاعلية نسائية — خريطة الحل',
  kickerAr: 'قاعة مناسبتكن على الشاشة — حيّة من أول تجربة',
  titleAr: 'دعوة حرة تفاعلية نسائية',
  leadAr:
