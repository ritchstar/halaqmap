...
export const STORE_EVENT_LIVE = {
  documentTitle: 'اجواء1 — منصة خريطة الحل',
  ...
  hostInviteLeadAr: 'جهّزوا من هذه اللوحة ما يكفي مناسبتكم من الروابط الخاصة. كل رابط لمدعو واحد. أرسلوا واحداً واحداً، أو دفعة لمفوض من واتساب جهازكم.',
...
export const STORE_EVENT_LIVE_WOMEN = {
  documentTitle: 'اجواء1 نسائي — منصة خريطة الحل',
