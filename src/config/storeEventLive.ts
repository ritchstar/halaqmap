...
export const STORE_EVENT_LIVE = {
  ...
  termsFoldBodyAr:
    'قاعة حفل حيّة لمناسبة تسميها بنفسك: تهاني، صور أو يوتيوب، وكرت الدعوة. السعر 899 ر.س، والدفع عبر ميسر على www.halaqmap.com. صنّف الدعوة رجالية أو نسائية من البداية. رابط واحد للضيوف، ولوحة لك. التفاصيل في شروط الخدمة.',
