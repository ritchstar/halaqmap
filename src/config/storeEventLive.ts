...
export const STORE_EVENT_LIVE = {
  ...
  termsFoldBodyAr:
    'قاعة حفل حيّة لمناسبة تسميها بنفسك: تهاني، صور أو يوتيوب، وكرت الدعوة. السعر 899 ر.س، والدفع عبر بوابة الدفع الآمنة. روابط المدعوين تصدر من لوحة المشتري فقط؛ كل رابط لمدعو واحد وجهاز واحد، وإعادة إرساله من مدعو تُحظر. حماية الخصوصية الصارمة هي منطلق النموذج. التفاصيل في شروط الخدمة.',
