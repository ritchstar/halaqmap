...
export const STORE_BEREAVEMENT_COPY = {
  documentTitle: 'إعلان وفاة وترتيبات الصلاة والدفن والعزاء — منصة خريطة الحل',
  kicker: 'خدمة مجتمعية مجانية ومستقلة',
  titleAr: 'إعلان وفاة وترتيبات الصلاة والدفن والعزاء',
  leadAr:
    'بلاغات الوفاة والعزاء — خدمة مجتمعية مجانية ومستقلة من منصة خريطة الحل. ليست مناسبة، ولا تدخل أسعار البطاقات المدفوعة.',
  consolationAr:
    'منصة خريطة الحل تتقدم بخالص المواساة، وتسأل الله أن يتغمّد الفقيد بواسع رحمته.',
  stampAr: 'خدمة مجتمعية مقدمة من منصة خريطة الحل',
  stampAltAr: 'أُعد هذا البلاغ عبر منصة خريطة الحل',
