...
export const STORE_BEREAVEMENT_COPY = {
  documentTitle: 'إعلان وفاة وترتيبات الصلاة والدفن والعزاء — منصة طريقة الحل',
  kicker: 'خدمة مجتمعية مجانية ومستقلة',
  titleAr: 'إعلان وفاة وترتيبات الصلاة والدفن والعزاء',
  leadAr:
    'بلاغات الوفاة والعزاء — خدمة مجتمعية مجانية ومستقلة من منصة طريقة الحل. ليست مناسبة، ولا تدخل أسعار البطاقات المدفوعة.',
  consolationAr:
    'منصة طريقة الحل تتقدم بخالص المواساة، وتسأل الله أن يتغمّد الفقيد بواسع رحمته.',
  stampAr: 'خدمة مجتمعية مقدمة من منصة طريقة الحل',
  stampAltAr: 'أُعد هذا البلاغ عبر منصة طريقة الحل',
