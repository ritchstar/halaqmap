...
export const STORE_HALANA_LIVE_COPY = {
  documentTitle: 'حلانا1 — منصة طريقة الحل',
  kickerAr: 'من معرض أعمالك إلى طلب مخصص وموعد مؤكّد',
  titleAr: 'حلانا1',
  leadAr:
    'مقر رقمي لمتخصصة الحلويات الخاصة؛ اعرضي أعمالك، واستقبلي تفاصيل المناسبة، وقدّمي عرض السعر، ثم ثبّتي الموعد بعد تأكيد العربون يدوياً. تحوّل العميلة العربون مباشرةً إلى وسيلة الدفع التي تحددينها، ولا تستلم منصة طريقة الحل مبالغ عميلاتك.',
  ...
  payIndependenceAr:
    'لا تستلم منصة طريقة الحل مبالغ عميلات المتخصصة، ولا تحتفظ بالعربون، ولا تؤكد حجز الموعد نيابةً عنها. تتولى المتخصصة التحقق من وصول المبلغ واعتماد الموعد من لوحة التشغيل.',
  payNoPlatformGateAr: 'لا توجد بوابة دفع تابعة لمنصة طريقة الحل داخل طلب العميلة.',
  ...
  legalTitleAr: 'منتج من منظومة منصة طريقة الحل',
  legalBodyAr:
    'حلانا1 منتج برمجي من متجر منصة طريقة الحل. يمكن الاطلاع على بيانات توثيق المنشأة وروابط التحقق من صفحة «التوثيق والتحقق».',
  ...
  orderConsentAr:
    'أقرّ بقراءة شروط الخدمة والخصوصية، وأوافق على سداد قيمة اشتراكي في حلانا1 عبر بوابة الدفع التابعة لمنصة طريقة الحل. مدفوعات عميلاتي لا تستلمها منصة طريقة الحل، وتتم مباشرةً بيني وبين العميلة وفق وسائل الدفع التي أحددها.',
  ...
  payInstructionsLeadAr:
    'التحويل إلى وسيلة المتخصصة مباشرة. منصة طريقة الحل لا تستلم المبلغ ولا تؤكد وصوله نيابة عنها.',
  ...
  galleryDeskTitleAr: 'الاختيارات والأعمال المعروضة',
  galleryDeskLeadAr:
    'أضيفي أعمالاً للإلهام أو مميزة في المعرض. لا تُعرض تفاصيل الوصفات. «جاهز للطلب» يُدار من قسم النصوص.',
  galleryUploadAr: 'اختيار صورة للعمل',
  ...
  galleryUploadHintAr: 'صورة واضحة بنسبة موحّدة — يمكن ضبط العرض بعد الرفع.',
  galleryKindLabelAr: 'نوع العرض',
  galleryPickImageAr: 'اختيار صورة للعمل',
  galleryAddWorkAr: 'إضافة عمل',
  deskStudioTitleAr: 'استوديو واجهة العميلات',
  deskStudioLeadAr:
    'رتّبي هوية نشاطك والمعروض للعميلات، وشاهدي النتيجة مباشرة. الطلبات وعروض الأسعار من صندوق الطلبات.',
  deskPreviewAr: 'معاينة صفحة العميلات',
  deskEditTabAr: 'تعديل',
  deskPreviewTabAr: 'معاينة',
  ...
  deskOccasionsTitleAr: 'مستكشف «وش المناسبة؟»',
  deskOccasionsLeadAr: 'اختياري. اختاري ما يظهر للعميلات في شريط التصفية.',
  deskOccasionsMinAr: 'يجب إبقاء خيار واحد على الأقل ظاهراً.',
  deskOccasionsPendingAr: 'حُفظت بقية اللوحة. ضبط المستكشف يُفعَّل بعد اكتمال الترقية التقنية.',
  deskProgressIdentityAr: 'الهوية',
  deskProgressContentAr: 'المعرض',
  deskProgressTextsAr: 'النصوص',
  deskProgressReviewAr: 'المراجعة',
  deskTitleAr: 'لوحة حلانا1',
  deskLeadAr:
    'هذه الأداة لتنظيم ما يظهر للعميلات. أما الطلبات الخاصة وعروض الأسعار وتأكيد الموعد فمن صندوق الطلبات.',
  shopNameLabelAr: 'اسم النشاط',
  logoLeadAr: 'ارفعي أيقونة مربعة واضحة لتظهر دائرة صغيرة بجوار اسم النشاط في صفحة العميلات.',
  identitySaveAr: 'حفظ الهوية والشعار',
  orderShareTitleAr: 'مشاركة صفحة الطلب',
  orderShareLeadAr: 'رابط مستقل للعميلات اللاتي يردن الطلب مباشرة — بلا لوحة التشغيل.',
  orderShareWhatsappAr: 'واتساب · رابط الطلب',
