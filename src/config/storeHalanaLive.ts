...
export const STORE_HALANA_LIVE_COPY = {
  documentTitle: 'حلانا1 — منصة خريطة الحل',
  kickerAr: 'من معرض أعمالك إلى طلب مخصص وموعد مؤكّد',
  titleAr: 'حلانا1',
  leadAr:
    'مقر رقمي لمتخصصة الحلويات الخاصة؛ اعرضي أعمالك، واستقبلي تفاصيل المناسبة، وقدّمي عرض السعر، ثم ثبّتي الموعد بعد تأكيد العربون يدوياً. تحوّل العميلة العربون مباشرةً إلى وسيلة الدفع التي تحددينها، ولا تستلم منصة خريطة الحل مبالغ عميلاتك.',
  ...
  payIndependenceAr:
    'لا تستلم منصة خريطة الحل مبالغ عميلات المتخصصة، ولا تحتفظ بالعربون، ولا تؤكد حجز الموعد نيابةً عنها. تتولى المتخصصة التحقق من وصول المبلغ واعتماد الموعد من لوحة التشغيل.',
  payNoPlatformGateAr: 'لا توجد بوابة دفع تابعة لمنصة خريطة الحل داخل طلب العميلة.',
  ...
  legalBodyAr:
    'حلانا1 منتج برمجي من متجر منصة خريطة الحل. يمكن الاطلاع على بيانات توثيق المنشأة وروابط التحقق من صفحة «التوثيق والتحقق».',
  ...
  orderConsentAr:
    'أقرّ بقراءة شروط الخدمة والخصوصية، وأوافق على سداد قيمة اشتراكي في حلانا1 عبر بوابة الدفع التابعة لمنصة خريطة الحل. مدفوعات عميلاتي لا تستلمها منصة خريطة الحل، وتتم مباشرةً بيني وبين العميلة وفق وسائل الدفع التي أحددها.',
  ...
  payInstructionsLeadAr:
    'التحويل إلى وسيلة المتخصصة مباشرة. منصة خريطة الحل لا تستلم المبلغ ولا تؤكد وصوله نيابة عنها.',
