...
export const PLATFORM_IDENTITY_PARAGRAPH_AR =
  ...
  'العلاقة التعاقدية على خدمة الحلاقة قائمة **مباشرةً بين الصالون والعميل**؛ ومسؤولية حلاق ماب التقنية تنحصر في تشغيل البنية البرمجية التي تُتيح المعالجة اللحظية لطلب المستخدم وعرض مقدم الخدمة المناسب ضمن نظام الاستجابة الذكية (الظهور عند الطلب) خلال مدة حزمة رخصة النفاذ المدفوعة.';
