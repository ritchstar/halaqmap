 ...
 * في تطوير وبيع منتجات برمجية (حزم إدراج مسبقة الدفع على نظام الاستجابة الذكية)
...
export const PLATFORM_IDENTITY_PARAGRAPH_AR =
  ...
  'العلاقة التعاقدية على خدمة الحلاقة قائمة **مباشرةً بين الصالون والعميل**؛ وتعمل المنصة بنظام الاستجابة الذكية، ويقتصر دورها على المعالجة والفلترة اللحظية بين استعلام المستخدمين وبيانات الحلاقين المتاحة داخلها، ثم عرض النتيجة المناسبة وفق البيانات المتاحة ضمن نظام الاستجابة الذكية (الظهور عند الطلب) خلال مدة حزمة رخصة النفاذ المدفوعة.';
...
export const PLATFORM_IDENTITY_BOILERPLATE_AR =
  'حلاق ماب — مزوّد خدمة رقمية للربط والعرض اللحظي ضمن نظام الاستجابة الذكية (الظهور عند الطلب · On-Demand Visibility). ليست وسيطاً تجارياً ولا تتقاضى عمولة على خدمة الحلاقة.';
...
export const PLATFORM_IDENTITY_LEGAL_DISCLAIMER_AR =
  'يُقرّ المستخدم بأن المنصة تعمل بنظام الاستجابة الذكية، ويقتصر دورها على المعالجة والفلترة اللحظية بين استعلام المستخدمين وبيانات الحلاقين المتاحة داخلها، ثم عرض النتيجة المناسبة وفق البيانات المتاحة من الأطراف أنفسهم. لا تُعدّ المنصة وكيلاً تجارياً ولا وسيطاً مالياً ولا مقدّماً لخدمة الحجز بالعمولة، ولا تتحمّل مسؤولية جودة أو دقة أو سلامة الخدمة البدنية (الحلاقة وما يرتبط بها) التي يقدّمها الصالون — تلك مسؤولية الصالون مباشرة تجاه العميل ووفق الأنظمة السعودية ذات الصلة.';
