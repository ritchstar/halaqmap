...
export const SUBSCRIPTION_POLICY_PACKAGE_RENEWAL = {
  ...
  lead:
    'حزم الرخصة مسبقة الدفع بمدة محددة. لا يوجد ترقية تناسبية أو تخفيض منتصف المدة — عند الرغبة في مستوى أعلى أو تجديد الإدراج، تُشترى حزمة رخصة جديدة.',
  items: [
    {
      title: 'انتهاء المدة',
    ...
    },
    {
      ...
      body: 'إضافة برمجية متقدمة للباقة الماسية فقط — +25 ر.س لكل حزمة رخصة عند اختيار «المناوب الرقمي الذكي» في التسعير أو الدفع. منفصلة عن الرخصة التقنية وتعزّز قيمتها بأتمتة الضيافة والشات.',
    },
  ],
} as const;
...
export const SUBSCRIPTION_POLICY_EXPIRY = {
  ...
  items: [
    ...
    {
      title: 'إعادة التفعيل',
      body: 'يمكنك شراء حزمة رخصة جديدة أو استرداد كود تفعيل في أي وقت لاستعادة الظهور.',
    },
  ],
} as const;
