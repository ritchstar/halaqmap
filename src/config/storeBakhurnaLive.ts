...
export const STORE_BAKHURNA_LIVE = {
  documentTitle: 'بخورنا1 — منصة طريقة الحل',
  ...
  legalBodyAr:
    'بخورنا1 منتج برمجي من متجر منصة طريقة الحل. يمكن الاطلاع على بيانات توثيق المتجر والأنشطة التجارية وروابط التحقق من خلال صفحة «التوثيق والتحقق».',
  legalPrivacyAr:
