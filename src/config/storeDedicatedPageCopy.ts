...
export const STORE_DEDICATED_PAGE_COPY = {
  ...
  leadAr:
    'ليست متجراً مشتركاً، ولا مساحة تجمعك مع أنشطة أخرى. عند اختيار أحد منتجات منصة خريطة الحل، تُخصّص لك صفحة مستقلة باسم نشاطك، تعرض ما تقدمه وتوجّه زبونك إلى الطلب أو التواصل معك.',
  ...
  storeLandingLeadAr:
    'تنشر منتجاتك في حساباتك، لكن أين يتصفحها العميل ويبدأ طلبه؟ مع منتجات منصة خريطة الحل تحصل على صفحة مستقلة مخصصة لنشاطك، وليست صفحة مشتركة مع أنشطة أخرى.',
