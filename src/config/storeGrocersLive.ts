...
export const STORE_GROCERS_LIVE = {
  ...
  termsFoldBodyAr:
    'تمويناتا1 صفحة لجار الحي ولوحة للكاشير. المسار الثابت: 599 ر.س لستة أشهر، أو 899 ر.س لاثني عشر شهراً. المسار المتحرك من نموذج الطلب مشمول في سعره، بلا إضافة مدفوعة. صندوق المحادثة إضافة اختيارية على المسار الثابت: 299 ر.س مع باقة ستة أشهر، أو 499 ر.س مع باقة اثني عشر شهراً. صندوق في صفحة الزبون وصندوق استقبال في اللوحة، بلا غرفة دردشة عامة. طلب الزبون نقداً أو شبكة مع التوصيل. التفاصيل في شروط الخدمة.',
