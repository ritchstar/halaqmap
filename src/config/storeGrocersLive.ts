...
export const STORE_GROCERS_LIVE = {
  documentTitle: 'تمويناتا1 — منصة طريقة الحل',
  ...
  payIndependenceAr:
    'لا تتولى منصة طريقة الحل تحصيل قيمة طلبات عملاء التموينات، ولا تفرض عمولة على السلة. تكون العلاقة المالية مباشرة بين صاحب التموينات وعميله، ويكون الدفع نقداً أو عبر الشبكة عند التسليم أو الاستلام، بحسب الخيارات التي يتيحها المحل.',
  ...
  legalBodyAr:
    'تمويناتا1 منتج من منظومة منصة طريقة الحل. متجر منصة طريقة الحل موثّق لدى المركز السعودي للأعمال، ويمكن الاطلاع على بيانات المنشأة وروابط التحقق من صفحة «التوثيق والتحقق».',
  legalCertAr:
  ...
  orderNoCollectAr:
    'لا تتولى منصة طريقة الحل تحصيل قيمة طلبات العملاء أو التسوية المالية بين صاحب النشاط وعملائه.',
  orderScopeAr: 'هذا الاشتراك خاص بتمويناتا1 ولا يشمل منتجات أو خدمات أخرى من منصة طريقة الحل.',
