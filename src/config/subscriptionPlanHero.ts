...
/**
 * ملاحظة تشغيلية لباقتي الذهبي والماسي (تحتويان لوحة تحكم).
 * تُعرض في بطاقات الباقات وصفحات السياسة والتسويق.
 */
export const BARBER_DASHBOARD_DEVICE_REQUIREMENT_NOTE_AR =
  'ملاحظة: هذه الباقة تشمل لوحة تحكم — يلزم توفير جهاز آيباد أو لابتوب خاص بالصالون لإدارة حسابكم في منصة حلاق ماب واستقبال العملاء وإدارة التواصل معهم.';
