...
export const SHOP_OPEN_STATUS_FEATURE_BRONZE =
  'أيقونة «مفتوح الآن / مغلق» عبر نظام الرصد الذكي: تحديثها برابط سري خفيف دون لوحة تحكم (يُزوّدك به فريقنا بعد تفعيل حزمة الإدراج البرمجية).';
export const SHOP_OPEN_STATUS_FEATURE_GOLD_DIAMOND =
  'أيقونة «مفتوح الآن / مغلق» عبر نظام الرصد الذكي: تحديثها من لوحة التحكم، مع نفس الرابط السري للطوارئ أو للمحمول.';
