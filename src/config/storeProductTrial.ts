...
export const STORE_PRODUCT_TRIAL_COPY = {
  ...
  giftCourtesyAr:
    'إهداء من متجر منصة طريقة الحل للعرسان: تجربة واحدة مجانية تنتهي تلقائياً بلا مطالبة بسداد.',
  firstVisitAr:
...
export const STORE_GENERAL_TRIAL_COPY = {
  documentTitle: 'التجربة العامة | منصة طريقة الحل',
...
export const STORE_GENERAL_TRIAL_TERMS_COPY = {
  documentTitle: 'شروط التجربة العامة | منصة طريقة الحل',
  kickerAr: 'شروط التجربة العامة',
  titleAr: 'شروط نظام التجربة العام',
  subtitleAr:
    'هذه الشروط خاصة بنظام التجربة العام، ومستقلة عن هدية منصة طريقة الحل وعن هدية طبختنا1 وعن كاردي8 وعن رخصة النفاذ.',
