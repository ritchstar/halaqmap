...
export const STORE_PRODUCT_TRIAL_COPY = {
  ...
  giftCourtesyAr:
    'إهداء من متجر منصة خريطة الحل للعرسان: تجربة واحدة مجانية تنتهي تلقائياً بلا مطالبة بسداد.',
  firstVisitAr:
...
export const STORE_GENERAL_TRIAL_COPY = {
  documentTitle: 'التجربة العامة | منصة خريطة الحل',
  kickerAr: 'نظام التجربة العام',
  titleAr: 'شغّل صفحتك ستين يوماً ثم قرر',
  leadAr:
    'للمشغّل الجاد في الحي: تشغيل كامل بلا رسوم تأسيس وبلا التزام بالشراء. سجل ثم أكد ايميلك واستلم متجرك فوراً. الساعة ستون يوماً من أول دخول، وبعدها تمدّد نفس الصفحة بالشراء أو توقف.',
  pickTitleAr: 'اختر المنتج',
  formTitleAr: 'طلب التجربة',
  shopLabelAr: 'اسم المشغّل / المتجر',
  emailLabelAr: 'البريد الإلكتروني',
  emailHintAr: 'سجل ثم أكد ايميلك واستلم متجرك فوراً.',
  cityLabelAr: 'المدينة',
  ...
  confirmSentAr: 'وصل الطلب. افتح رسالة التأكيد على بريدك — سجل ثم أكد ايميلك واستلم متجرك فوراً.',
  confirmTitleAr: 'تأكيد البريد',
  confirmLeadAr: 'يجري التحقق من رابط التأكيد.',
  confirmOkAr: 'تأكد بريدك. سجل ثم أكد ايميلك واستلم متجرك فوراً.',
  confirmFailAr: 'تعذر تأكيد الرابط. أعد الطلب من صفحة التجربة العامة إن لزم.',
  notMeTitleAr: 'إنهاء الطلب',
  notMeLeadAr: 'يجري التحقق من رابط الإنهاء.',
  notMeOkAr: 'تم إنهاء الطلب. شكراً لتنبيهنا — لن يُستخدم بريدك في شيء.',
  notMeFailAr: 'تعذر إنهاء الطلب بهذا الرابط. إن لم تطلب التجربة فتجاهل أي رسالة لاحقة.',
  ...
  promoLeadAr: 'لاونجا1 وتمويناتا1 ومطعمنا1 وخضارنا1 وكافينا1 وطبختنا1 وحلانا1 وتمرتنا1 وبخورنا1. سجل ثم أكد ايميلك واستلم متجرك فوراً.',
...
export const STORE_GENERAL_TRIAL_TERMS_COPY = {
  documentTitle: 'شروط التجربة العامة | منصة خريطة الحل',
  kickerAr: 'شروط التجربة العامة',
  titleAr: 'شروط نظام التجربة العام',
  subtitleAr:
    'هذه الشروط خاصة بنظام التجربة العام، ومستقلة عن هدية منصة خريطة الحل وعن هدية طبختنا1 وعن كاردي8 وعن رخصة النفاذ.',
  ...
  sections: [
    ...
    {
      titleAr: 'التسجيل والروابط',
      bodyAr:
        'سجل ثم أكد ايميلك واستلم متجرك فوراً. الساعة تبدأ عند أول دخول لا عند الإرسال.',
    },
    {
