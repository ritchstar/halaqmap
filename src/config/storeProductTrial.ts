...
export const STORE_GENERAL_TRIAL_COPY = {
  ...
  leadAr:
    'للمشغّل الجاد في الحي: تشغيل كامل بلا رسوم تأسيس وبلا التزام بالشراء. بعد المراجعة الإدارية تصل روابط الصفحة واللوحة إلى بريدك. الساعة ستون يوماً من أول دخول، وبعدها تمدّد نفس الصفحة بالشراء أو توقف.',
  pickTitleAr: 'اختر المنتج',
  formTitleAr: 'طلب التجربة',
  shopLabelAr: 'اسم المشغّل / المتجر',
  emailLabelAr: 'البريد الإلكتروني',
  emailHintAr: 'ستُرسل رسالة لتأكيد البريد. روابط التشغيل تصل إلى هذا البريد بعد المراجعة الإدارية.',
  cityLabelAr: 'المدينة',
