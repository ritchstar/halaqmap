...
export const STORE_PRODUCT_TRIAL_COPY = {
  ...
  opsLeadAr:
    'هنا طلبات التجربة ومسوّقو المتجر وإصدار النماذج. لا خلط بفاتورة الرخصة ولا بعمولة القص.',
  issueFieldAr: 'أصدر تجربة إلى هذا الإيميل',
  ...
  marketerLeadAr:
    'لكل منتج خمسة نماذج. الطلب يصل للإدارة: موافقة أو اعتذار. التجربة مجانية ولا تُحسب من العمولة. إن سدّد المستفيد لاحقاً تُقيَّد العمولة كبيع اعتيادي من رابطك.',
  giftCourtesyAr:
