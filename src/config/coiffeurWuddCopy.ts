...
export const COIFFEUR_WUDD_PITCH_LINES_AR = [
  'أشرح فكرة كوافير ماب للمستعلمة: بحث من المتصفح، موقعك، ثم بنرات المشاغل المفعّلة.',
  'لا تطبيق ولا حساب ولا إدراج رقمك أو بريدك. زر الاتجاهات يفتح الخرائط إلى المشغل.',
  'الاستعلام مجاني. التحصيل من صاحبات المشاغل فقط باشتراك شهري بحسب الباقة.',
  'هذه الصفحة اهتمام ومتابعة. مسار تسجيل الحساب لم يُفتح للتعاقد بعد.',
] as const;

export const COIFFEUR_WUDD_QUICK_TOPICS = [
  { id: 'idea', label: 'ما هي المنصة', prompt: 'ما فكرة كوافير ماب للمستعلمة وكيف تعمل من غير تطبيق ولا حساب؟' },
  { id: 'smart', label: 'الاستجابة الذكية', prompt: 'اشرحي نظام الاستجابة الذكية وكيف يظهر المشغل عند الطلب.' },
  { id: 'inquiry', label: 'الاستعلام', prompt: 'كيف أبحث عن مشغل قريب وهل تحتاجين رقم جوالي أو تسجيلاً؟' },
  { id: 'summi', label: 'صفحات سمي', prompt: 'ما هي صفحات سمي وهل هي علامة غير كوافير ماب؟' },
