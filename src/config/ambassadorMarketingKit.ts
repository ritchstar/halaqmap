  ...
  return [
    {
      ...
      links: [
        page(
          ...
          'training-deck',
          'ابدأ التدريب الميداني (شرائح)',
          '14 شريحة: الرحلة، GPS والصور، قاعدة 50م، المحفظة، الفنادق والشقق المخدومة، والمحظورات.',
        ),
        {
          id: 'pdf-training',
    ...
    {
      id: 'hospitality',
      titleAr: 'فنادق وشقق مخدومة',
      blurbAr: 'مسار المكافأة 25 ر.س بعد الاستلام بلا شكوى — يُفتح بعد أول إغلاق صالون.',
      links: [
        page(
          ROUTE_PATHS.HOSPITALITY_B2B_REQUEST,
          'hospitality',
          'طلب بنرات للفنادق والشقق المخدومة',
          'نموذج طلب B2B للبنرات مع الشحن — اربطه بطلب استهداف فنادق وشقق مخدومة.',
        ),
      ],
    },
    {
