 ...
 * لا تُستورد من App.
 */
export const STORE_PRODUCT_PASS_KINDS = ['lounge', 'grocers', 'restaurant', 'cafe', 'kitchen', 'produce', 'halana', 'dates', 'bakhurna'] as const;
...
export const STORE_PRODUCT_PASS_ROLES = [
  ...
  { id: 'specialist', labelAr: 'المتخصصة' },
...
> = {
  ...
  bakhurna: { skuAr: 'بخورنا1', accent: '#6E4A26', ink: '#2A2016', shopPath: '/b/:token' },
};
