 ...
 *
 * لوحة مشغّلي منصة خريطة الحل. لا تُستورد من App.
...
export const STORE_OPERATORS_DESK_COPY = {
  documentTitle: 'لوحة مشغّلي منصة خريطة الحل',
  kickerAr: 'للمشغّل فقط',
  titleAr: 'لوحة مشغّلي منصة خريطة الحل',
  ...
  storeHomeAr: 'منصة خريطة الحل',
  storeHomeLeadAr: 'العودة إلى واجهة منصة خريطة الحل.',
  logoutAr: 'خروج',
