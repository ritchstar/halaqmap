...
export const STORE_PRODUCE_LIVE = {
  documentTitle: 'خضارنا1 — منصة طريقة الحل',
  ...
  payIndependenceAr:
    'لا تتولى منصة طريقة الحل تحصيل قيمة طلبات العملاء، ولا تفرض عمولة على قيمة السلة. تكون العلاقة المالية مباشرة بين المشغّل وعميله، ويكون الدفع نقداً أو عبر الشبكة عند التسليم أو الاستلام، بحسب الخيارات التي يتيحها صاحب النشاط.',
  ...
  legalBodyAr:
    'خضارنا1 منتج برمجي من متجر منصة طريقة الحل. يمكن الاطلاع على بيانات توثيق المتجر والأنشطة التجارية وروابط التحقق من خلال صفحة «التوثيق والتحقق».',
  legalCertAr:
  ...
  shopKickerAr: 'جار الحي',
  shopHeroTaglineAr: 'خضار طازجة من حيك.',
  ...
  orderNoCollectAr: 'لا تتولى منصة طريقة الحل تحصيل قيمة سلة العميل أو تسوية المدفوعات بين المشغّل وعملائه.',
