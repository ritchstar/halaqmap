...
export const STORE_PRODUCE_LIVE = {
  ...
  problemBodyAr:
    'يسأل جار الحي: «فيه رمّان اليوم؟ بكم الكيلو؟»، وصاحب الصندوق يجيب من ذاكرته أو من لوحة مكتوبة بخط اليد تتغيّر كل صباح. صنف وصل، وآخر نفد، وسعر تغيّر قبل العصر، وطلب يضيع بين المكالمات. ولا صفحة تعرض صندوق اليوم بوضوح، ولا لوحة تصل إليها الطلبات مكتوبة بدل أن تُملى وسط الزحمة.',
  solutionTitleAr: 'خضارنا1: صندوق اليوم بواجهة حية ولوحة تشغيل',
  leadAr:
    'خضارنا1 صفحة لجار الحي ولوحة لصاحب الصندوق: بنك خضار وفواكه بالحبة أو الكيلو، وشريط ما وصل هذا الصباح، وطلب من الجوال، ومذكرة واتساب من جهاز المحل. الصندوق والعربة مسار واحد مشمول في السعر.',
  ...
  chatBuyerHintAr: 'اسأل: فيه رمّان اليوم؟ أو اطلب توصية. ليس دردشة عامة.',
...
export const STORE_PRODUCE_LIVE_FEATURES = [
  ...
  },
  {
    ...
    bodyAr: 'جار الحي يسأل: فيه رمّان اليوم؟ الرد من اللوحة. ليست غرفة عامة وليست إضافة مدفوعة.',
  },
  {
