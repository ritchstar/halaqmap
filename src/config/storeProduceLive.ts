...
export const STORE_PRODUCE_LIVE = {
  ...
  serviceComeAr: 'تعال',
  serviceComeLeadAr:
    'تسوق من الصندوق عند بابك أو عند مطعم أو بوفيه. أرسل موقعك وفعّل تنبيه المتصفح ليصلك عند اقتراب السيارة.',
  ...
  comeNeedPlaceAr: 'حدد موقعك بزر حدد موقعي ثم تأكد من الدبوس.',
