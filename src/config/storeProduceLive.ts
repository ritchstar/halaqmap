...
export const STORE_PRODUCE_LIVE = {
  documentTitle: 'خضارنا1 — منصة خريطة الحل',
  ...
  legalBodyAr:
    'خضارنا1 منتج برمجي من متجر منصة خريطة الحل. يمكن الاطلاع على بيانات توثيق المتجر والأنشطة التجارية وروابط التحقق من خلال صفحة «التوثيق والتحقق».',
  legalCertAr:
