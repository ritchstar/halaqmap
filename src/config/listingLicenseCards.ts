...
export const LISTING_LICENSE_PRICING_CARDS: readonly ListingLicenseCardConfig[] = [
  ...
  },
  {
    ...
    badge: '💎',
    premiumRibbonAr: 'الأقوى للنمو والتميّز',
    productTitleAr: SOFTWARE_PACKAGE_GEO_PRESENCE_TITLE_AR,
    subtitleAr: 'حضور فاخر للصالونات التي تريد أقوى انطباع وأعلى جاهزية',
    priceSar: TIER_MONTHLY_SAR[SubscriptionTier.DIAMOND],
    packageUnitLabelAr: SOFTWARE_PACKAGE_UNIT_LABEL_AR,
    validityLabel: SOFTWARE_PACKAGE_VALIDITY_LABEL_AR,
    highlights: [
      'تمييز ماسي في الظهور لمن يريد أن يكون الخيار الأول في منطقته',
      'معرض أعمال حتى 40 صورة مع واجهة فاخرة وشارة نخبة',
      'شات خاص بترجمة ذكية فورية لتواصل أسهل مع شرائح عملاء أوسع',
      'مواعيد وحجوزات من اللوحة، مع خيار المناوب الرقمي الذكي',
    ],
