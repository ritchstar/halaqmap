...
import { STORE_DIRECT_PAY_TERMS_SUMMARY_AR } from '@/config/storeDirectPayLegal';

export const STORE_ISSUED_CARDS_POLICY_VERSION = '2026-09-03';
...
export const STORE_ISSUED_CARDS_LEGAL_SECTIONS: readonly StoreIssuedLegalSection[] = [
  {
    ...
    content:
      ...
      '- **كاردي8:** بطاقة مناسبة تشاركها برابط، مع تحميل صورة.\n' +
      '- **افراحي1:** قاعة زواج على الشاشة بأسماء العريس والعروس.\n' +
      '- **اجواء1:** قاعة حيّة لمناسبة تسميها بنفسك.\n' +
      '- **لاونجا1:** تشغيل شاشات اللاونج ثلاثة أشهر، مع ترحيب باسم الزبون.\n' +
      '- **تمويناتا1:** متجر لجار الحي ولوحة كاشير، 599 ر.س لستة أشهر أو 899 ر.س لاثني عشر شهراً، وصندوق محادثة اختياري بـ 299 ر.س لستة أشهر أو 499 ر.س لاثني عشر شهراً.\n' +
      '- **مطعمنا1:** صفحة لضيف الحي ولوحة مطبخ، 699 ر.س لستة أشهر أو 999 ر.س لاثني عشر شهراً، وصندوق المحادثة مدرج.\n' +
      '- **كافينا1:** صفحة لجار الحي ولوحة كاشير وشاشات داخل المقهى، 1199 ر.س لستة أشهر أو 2099 ر.س لاثني عشر شهراً، وصندوق المحادثة مدرج.\n' +
      '- **طبختنا1:** صفحة للزبون ولوحة نشاط للأسرة المنتجة، 300 ر.س لمئة وثمانين يوماً أو 600 ر.س لثلاثمئة وستين يوماً.\n\n' +
  ...
  },
  {
    ...
    content:
      ...
      'الدفع عبر **بوابة الدفع** المعتمدة على النطاق **www.halaqmap.com**.\n\n' +
  ...
  },
  {
    ...
    content:
      '**كاردي8.** بطاقة مناسبة حيّة. جرّب المعاينة مجاناً بلا حساب. ثلاث طبقات بالريال السعودي: **سريعة 12** للتهنئة السريعة، **مميزة 29** للميلاد والتخرج والعيد واستقبال المولود، **فاخرة 59** للقران والملكة والاستقبال العائلي. بعد الدفع تحصل على رابط حي وصورة جاهزة للمشاركة. تظهر على البطاقة علامة: **صُممت عبر halaqmap · خريطة الحل**.\n\n' +
      '**افراحي1.** قاعة زواج حيّة: تهاني الضيوف، صور أو يوتيوب، وكرت بأسماء العريس والعروس. السعر **899 ر.س**. رابط للضيوف، ورابط لك لإدارة الصفحة.\n\n' +
      '**اجواء1.** نفس روح القاعة، لمناسبة تختار اسمها: أمسية، تخرج، تكريم أو غير ذلك. صنّف الدعوة رجالية أو نسائية من البداية. السعر **899 ر.س**.\n\n' +
      ...
      '**تمويناتا1.** متجر لجار الحي ولوحة كاشير: بنك سلع جاهز، طلب من الجوال، ومذكرة واتساب للتوصيل. **599 ر.س** لستة أشهر، أو **899 ر.س** لاثني عشر شهراً. **صندوق محادثة جار الحي** إضافة برمجية اختيارية: **299 ر.س** مع باقة ستة أشهر، أو **499 ر.س** مع باقة اثني عشر شهراً. صندوق في صفحة الزبون وصندوق استقبال في اللوحة، بلا غرفة دردشة عامة. طلب الزبون نقداً أو شبكة عند الباب، بلا تحصيل سلّته عبر بوابة الدفع. اشتراك صاحب التموينات عبر بوابة الدفع الآمنة.\n\n' +
      '**مطعمنا1.** صفحة لضيف الحي ولوحة مطبخ: أطباق وطلب من الجوال، وصندوق محادثة مدرج، وملصق QR. **699 ر.س** لستة أشهر، أو **999 ر.س** لاثني عشر شهراً. طلب الضيف نقداً أو شبكة مع التوصيل أو عند الاستلام.\n\n' +
      '**كافينا1.** صفحة لجار الحي ولوحة كاشير وشاشات داخل المقهى، وصندوق محادثة مدرج، وملصق QR. **1199 ر.س** لستة أشهر، أو **2099 ر.س** لاثني عشر شهراً. طلب جار الحي نقداً أو شبكة مع التوصيل في الحي أو الاستلام من المحل.\n\n' +
      '**طبختنا1.** صفحة أسرة منتجة: أصناف منزلية وطلب من الجوال، ولوحة نشاط وملصق QR. **300 ر.س** لمئة وثمانين يوماً، أو **600 ر.س** لثلاثمئة وستين يوماً، أسعار مخصصة للأسر المنتجة دعماً من متجر خريطة الحل. طلب الزبون نقداً أو شبكة عند التسليم، أو بتعليمات تحويل يعرضها صاحب النشاط إن فعّلها.\n\n' +
      STORE_DIRECT_PAY_TERMS_SUMMARY_AR,
  },
  {
    id: 'experience',
    title: 'كيف تعمل الخدمة',
    content:
      'المعاينة مجانية. الرابط الحي يُفتح بعد نجاح الدفع عبر بوابة الدفع.\n\n' +
      ...
      'في صفحات الحي لتمويناتا1 ومطعمنا1 وكافينا1 وطبختنا1 يظهر في لوحة التشغيل رقم لحظي بعنوان: عدد المتواجدون الان. تفاصيل هذا النبض في مادة الخصوصية أدناه.',
  },
  {
    id: 'payment',
    title: 'الأسعار والدفع',
    content:
      'الأسعار المعتمدة بالريال السعودي كما تظهر على صفحة كل منتج. تحصيل **اشتراك المنتج** عبر **بوابة الدفع** على **www.halaqmap.com**.\n\n' +
      'المعاينة تبقى مجانية. لا يُفتح الرابط الحي إلا بعد نجاح الدفع.\n\n' +
      STORE_DIRECT_PAY_TERMS_SUMMARY_AR +
      '\n\nفي القاعات والبطاقات لا يُحصَّل من الضيف ثمن تهنئة أو دخول. اشتراك المنتج عبر بوابة الدفع فقط.',
  },
  {
    id: 'refund',
    title: 'الاسترجاع',
  ...
  },
  {
    ...
    content:
      ...
      '**افراحي1 واجواء1.** حماية الخصوصية الصارمة لعملاء المناسبات الخاصة والعائلية هي منطلق هذين النموذجين، وتحاط بأنظمة حماية وسرية تامة ورقابة برمجية صارمة. روابط المدعوين لا تُقبل إلا إذا صدرت من لوحة المضيف وأُرسلت من جهازه؛ كل رابط لمدعو واحد يُربط بجهازه بعد الدخول. إعادة إرسال الرابط من أي مدعو تُحظر برمجياً. ليست دفتر حضور ولا تتبعاً للمدعوين ولا قائمة أسماء.\n\n' +
      '**عدد المتواجدين في صفحات الحي.** في تمويناتا1 ومطعمنا1 وكافينا1 وطبختنا1 يظهر في لوحة التشغيل رقم لحظي لمن يفتح صفحة الطلب في تلك اللحظة، بالعبارة: عدد المتواجدون الان. النبض مجهول: بلا اسم ولا هاتف ولا دفتر زيارات ولا دفتر زبائن. يزول الرقم عند إغلاق الصفحة. في كافينا1 يقتصر النبض على صفحة الحي، لا شاشات العرض ولا رابط الضيف. لا يُستخدم هذا النبض في افراحي1 ولا اجواء1 ولا لاونجا1، وليس تتبعاً للحضور ولا قائمة ضيوف.\n\n' +
      '**وسائل الدفع المباشر.** إن فعّل المشغّل التحويل أو الرابط الخارجي، تُعرض تعليماته بعد الطلب أو عرض السعر. الآيبان والمعرّفات تُشفَّر. إثبات التحويل للمراجعة اليدوية فقط، ثم يُحذف أو يُقيَّد. لا تُحفظ بيانات بطاقة. التفاصيل في سياسة وسائل الدفع المباشر.\n\n' +
      '**المعالجون:** الاستضافة السحابية، وبوابة الدفع المعتمدة.\n\n' +
...
export const STORE_ISSUED_CARDS_CONSENT_CHECKS: readonly StoreIssuedConsentCheck[] = [
  ...
  },
  {
    ...
    required: true,
    label:
      'أفهم أن المعاينة مجانية، وأن الرابط الحي يُفتح بعد الدفع عبر بوابة الدفع بالمبلغ المعروض، وأنه لا استرداد بعد تسليم الرابط.',
  },
  {
    id: 'paidStamp',
    track: 'paid',
...
export function unifiedConsentLabelForTrack(_track: StoreIssuedCardTrack): string {
  return 'أوافق على شروط الخدمة وسياسة وسائل الدفع المباشر، وصحة ما أنشره، وأن المنتج رقمي بلا استرداد بعد تسليم الرابط، وبقاء علامة خريطة الحل على البطاقة.';
}
