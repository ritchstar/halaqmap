...
export const STORE_ISSUED_CARDS_POLICY_VERSION = '2026-08-27';
...
export const STORE_ISSUED_CARDS_LEGAL_SECTIONS: readonly StoreIssuedLegalSection[] = [
  ...
  },
  {
    ...
    content:
      ...
      '**طبختنا1.** صفحة أسرة منتجة: أصناف منزلية وطلب من الجوال، ولوحة نشاط وملصق QR. **300 ر.س** لمئة وثمانين يوماً، أو **600 ر.س** لثلاثمئة وستين يوماً، أسعار مخصصة للأسر المنتجة دعماً من متجر خريطة الحل. طلب الزبون نقداً أو شبكة عند التسليم.',
  },
  {
    id: 'experience',
  ...
  },
  {
    ...
    content:
      'الأسعار المعتمدة بالريال السعودي كما تظهر على صفحة كل منتج. التحصيل عبر **بوابة الدفع** على **www.halaqmap.com**.\n\n' +
