...
export const STORE_KITCHEN_LIVE = {
  documentTitle: 'طبختنا1 — منصة خريطة الحل',
  ...
  supportLineAr: 'أسعار مخصصة للأسر المنتجة دعماً من متجر منصة خريطة الحل.',
  durationLineAr:
    'لا تحصيل من الزبون عبر المنصة، ولا عمولة على قيمة الوجبات.',
  legalTitleAr: 'منتج من منشأة موثّقة نظامياً',
  legalLeadBeforeAr: 'طبختنا1 من متجر منصة خريطة الحل ',
  ...
  locateSavedAr: 'لُصق رابط موقعك في الحقل. اضغط «تأكد من موقعي» لرؤية الدبوس.',
  ...
  termsFoldBodyAr:
    'طبختنا1 صفحة للزبون ولوحة لصاحب النشاط. 300 ر.س لمئة وثمانين يوماً، أو 600 ر.س لثلاثمئة وستين يوماً، أسعار مخصصة للأسر المنتجة دعماً من متجر منصة خريطة الحل. الطلب يصل خلال ثوانٍ مع تنبيه. إرسال بطاقة التسليم عبر واتساب بنقرة واحدة من جهاز التشغيل. لا تحصيل إلكتروني للزبون ولا عمولة على قيمة الوجبات. بيانات الزبون لتنفيذ الطلب فقط وتُحفظ على جهازه إن وافق. النسخة الأولى لمالك واحد. التفاصيل في شروط الخدمة.',
  ...
  heroImage: '/images/store/kitchen/kitchen-07.jpg',
