...
export const PLATFORM_YOUTUBE_GALLERY_COPY = {
  ...
  store: {
    documentTitle: 'مشاهدة منصة طريقة الحل',
    kickerAr: 'منصة طريقة الحل',
    titleAr: 'مشاهدة منصة طريقة الحل',
    leadAr: 'شغّل مقاطع منتجات المتجر هنا داخل الصندوق، دون مغادرة الصفحة ودون إعلانات من المنصة.',
  },
  switchHalaqAr: 'حلاق ماب',
  switchStoreAr: 'منصة طريقة الحل',
  backAr: 'رجوع',
  backStoreAr: 'العودة إلى المتجر',
  backHalaqAr: 'العودة إلى الرئيسية',
