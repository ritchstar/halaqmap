...
export const PARTNER_BANNERS_PREVIEW_TIERS: readonly BannerPreviewTierConfig[] = [
  ...
  },
  {
    ...
    marketingParagraphs: [
      'الذهبية لا تكتفي بتفعيلك؛ بل تجعل صالونك أكثر بروزاً وثقة عند استجابة النظام للاستعلامات النشطة المناسبة، مع مساحة أكبر لعرض جودة المكان قبل أن يضغط العميل زر التواصل.',
