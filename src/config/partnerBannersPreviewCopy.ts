...
export const PARTNER_BANNERS_PREVIEW_TIERS: readonly BannerPreviewTierConfig[] = [
  ...
  },
  {
    ...
    marketingParagraphs: [
      ...
      `معرض الأعمال حتى ${PARTNER_BANNERS_PREVIEW_DIAMOND_GALLERY_MAX} صورة وإدارة المواعيد تكمل رخصة النفاذ الماسية — و«المناوب الرقمي الذكي» إضافة برمجية متقدمة (Add-on) اختيارية ترد عند الإغلاق أو الانشغال وتخفف ضغط الشات.`,
    ],
  },
] as const;
