/**
 * Pulse Map — southern pilot slot registry (client).
 * Keep slot seeds in sync with `api/_lib/pulseMapSlots.ts`.
 */
...
export { PULSE_MAP_VIEWBOX } from '@/modules/pulse-map/lib/pulseMapGeo';
export {
  PULSE_MAP_SOUTHERN_BOUNDS,
...
/** WGS-84 city centres — projected then nudged inside clipped KSA outline. */
