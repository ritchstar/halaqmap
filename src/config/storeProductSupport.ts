...
export const STORE_PRODUCT_SUPPORT_TAB_IDS = ['activate', 'identity', 'orders', 'auction', 'qr', 'neighborhood'] as const;
...
export const STORE_PRODUCE_SUPPORT: StoreProductSupportGuide = {
  ...
  leadAr:
    'خطة عملية لصاحب خضارنا1: من اكتمال التفعيل وترتيب المتوفر إلى تحويل البيع الميداني داخل الحي إلى طريق رقمي يطلب منه الزبون لاحقاً من جواله.',
  landingPath: ROUTE_PATHS.STORE_PRODUCE,
  landingCtaAr: 'خطة التشغيل والتسويق',
  deskLeadAr: 'خطة تشغيل ميداني وتسويق خضارنا1 — من التفعيل إلى ثبّت حضورك في الحي.',
...
export const STORE_DATES_SUPPORT: StoreProductSupportGuide = {
  ...
  leadAr:
    'خطة عمل لصاحب صندوق التمر: إن كنت تعمل الآن أو تبحث عن عمل، ارسم يومك على المسار المتحرك أو الثابت من نقطة الشراء إلى جار الحي، مع مزاد علني للصناديق وخيار شحن خارج النطاق. لا عمولة على قيمة السلة، ولا تحصيل من جار الحي عبر بوابة الدفع.',
  ...
  tabs: tabs([
    ...
    },
    {
      ...
      sections: [
        ...
        {
          headingAr: 'شحن خارج النطاق',
          bodyAr: [
            'من إعدادات اللوحة فعّل الشحن خارج النطاق واكتب نصاً حراً عن شركة الشحن والتكلفة التقريبية ومدة الوصول.',
            'يظهر النص للعميل عند اختيار الشحن. المنصة لا تتوسط في الشحن ولا تحصّل أجرته؛ الاتفاق والتنفيذ بينك وبين العميل.',
          ],
        },
      ],
    },
    {
      id: 'auction',
      titleAr: 'المزاد العلني',
      sections: [
        {
          headingAr: 'إنشاء ونشر الصندوق',
          bodyAr: [
            'من قسم «المزاد» في اللوحة أنشئ صندوقاً: عنوان ووصف وسعر ابتدائي وحد أدنى للزيادة، مع صور وحتى رابط فيديو `HTTPS`.',
            'اضغط «حفظ ونشر الآن» ليظهر في صفحة المزاد فوراً. المسودة لا تظهر للعامة حتى تنشرها.',
            'انسخ رابط `/t/` ثم الرمز ثم `/auction` وشاركه فقط مع من تعتمدهم للمزاودة. لا فهرس عام للمزاد.',
          ],
        },
        {
          headingAr: 'المزايدة والإغلاق',
          bodyAr: [
            'المزايدات علنية لحظية؛ يظهر الاسم مختصراً للعامة ورقم الجوال في اللوحة فقط.',
            'أغلق المزاد يدوياً عندما تستقر السومة. تواصل مع الفائز خارج المنصة لإتمام البيع والتسليم والدفع.',
            'المنصة أداة عرض ومزايدة فقط، بلا تحصيل ثمن الصندوق وبلا مسؤولية على تنفيذ الصفقة.',
          ],
        },
      ],
    },
      ...
      sections: [
        {
          ...
          itemsAr: [
            ...
            'فعّلي وسيلة الدفع التي تعتمدينها لاستلام العربون مباشرة — منصة خريطة الحل لا تستلم أي مبالغ من عميلاتك.',
          ],
        },
      ],
    },
      ...
      sections: [
        ...
        },
        {
          ...
          bodyAr: [
            ...
            'الدعم التقني متاح عبر قنوات منصة خريطة الحل المعتمدة.',
          ],
        },
      ],
    },
