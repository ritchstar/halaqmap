...
export function buildCoiffeurInterestBriefAr(): string {
  ...
  return [
    ...
    '',
    'ما هي المنصة',
    'سطح قطاعي نسائي تحت مظلة حلاق ماب. المستعلمة تدخل من المتصفح وتضغط البحث وتسمح بموقعها. تظهر المشاغل المفعّلة بنرات بالاسم والصور ورقم التواصل، وزر يفتح الخرائط. بلا تطبيق وبلا حساب وبلا إدراج رقمها أو بريدها. التحصيل من صاحبات المشاغل فقط باشتراك شهري بحسب الباقة.',
    '',
    'الكيان والدفع',
    'الكيان التجاري والتوثيق وبوابة الدفع على www.halaqmap.com. لا حساب تاجر منفصل لكوافير ماب.',
    '',
    'التعاقد',
