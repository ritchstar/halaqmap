...
export const STORE_LOUNGE_LIVE = {
  ...
  termsFoldBodyAr:
    'شغّل شاشة اللاونج ثلاثة أشهر: فعاليات، لوحة تحكم، ورابط ترحيب باسم الزبون. السعر 600 ر.س مرة واحدة عبر بوابة الدفع الآمنة. عند التجديد تبقى الروابط وتمتد المدة على الشاشة ذاتها. التفاصيل في شروط الخدمة.',
