...
export const STORE_LOUNGE_LIVE = {
  ...
  termsFoldBodyAr:
    'لاونجا1 منتج مستقل عن رخصة النفاذ وعن بطاقة المناسبة وعن دعوة الزواج وعن الدعوة الحرة. السعر الافتتاحي 600 ر.س لمدة ثلاثة أشهر، والدفع عبر ميسر على نطاق www.halaqmap.com مرة واحدة. عند انتهاء المدة تبقى الروابط وتحيل إلى صفحة المنتج لإعادة الشراء على نفس الشاشة. الترحيبات جدار عام من رابط زبون واحد، بلا قائمة حضور وبلا إرسال جماعي وبلا شات وبلا إهداء مدفوع.',
