...
export const STORE_LOUNGE_LIVE = {
  ...
  featurePoints: [
    ...
    },
    {
      ...
      bodyAr: 'رابط يوزّعه اللاونج لإرسال ترحيبات وتبريكات تظهر فوراً على الشاشة.',
    },
    {
      titleAr: 'تحكم كامل',
      bodyAr: 'لوحة إدارة فورية لمراجعة ما يُعرض على الشاشات لضمان الملاءمة والخصوصية.',
    },
    {
      titleAr: 'بلا رسوم إضافية',
      bodyAr: 'لا يُحصَّل من الزائر أي مبلغ غير سعر الباقة.',
    },
  ],
