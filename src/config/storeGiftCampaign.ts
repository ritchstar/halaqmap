 ...
 *
 * هدية منصة خريطة الحل — نصوص الزائر والشروط. لا يُستورد من App.
 */
...
export const STORE_GIFT_COPY = {
  documentTitle: 'هدية منصة خريطة الحل | منصة خريطة الحل',
  kickerAr: 'هدية منصة خريطة الحل',
  ...
  optionalAr: 'اختياري',
  termsFoldTriggerAr: 'شروط هدايا منصة خريطة الحل',
  termsLinkAr: 'اقرأ شروط هدايا منصة خريطة الحل',
  consentAr: 'اطلعت على شروط هدايا منصة خريطة الحل وأوافق عليها التزاماً بمبادئ الإهداء.',
  ...
  needConsentAr: 'الموافقة على شروط هدايا منصة خريطة الحل مطلوبة.',
  headerShortAr: 'هدية',
  promoBadgeAr: 'هدية منصة خريطة الحل',
  ...
  promoAriaAr: 'إعلان هدية منصة خريطة الحل',
} as const;

export const STORE_GIFT_TERMS_COPY = {
  documentTitle: 'شروط هدايا منصة خريطة الحل | منصة خريطة الحل',
  kickerAr: 'شروط هدايا منصة خريطة الحل',
  titleAr: 'مبادئ الإهداء',
  subtitleAr:
    'هذه الشروط خاصة بهدية منصة خريطة الحل، ومستقلة عن شروط كاردي8 وعن رخصة النفاذ وعن عمولة المسوّق. الموافقة عليها من نموذج المشاركة التزام بمبادئ الإهداء.',
