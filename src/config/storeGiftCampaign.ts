 ...
 *
 * هدية منصة طريقة الحل — نصوص الزائر والشروط. لا يُستورد من App.
 */
...
export const STORE_GIFT_COPY = {
  documentTitle: 'هدية منصة طريقة الحل | منصة طريقة الحل',
  kickerAr: 'هدية منصة طريقة الحل',
  ...
  optionalAr: 'اختياري',
  termsFoldTriggerAr: 'شروط هدايا منصة طريقة الحل',
  termsLinkAr: 'اقرأ شروط هدايا منصة طريقة الحل',
  consentAr: 'اطلعت على شروط هدايا منصة طريقة الحل وأوافق عليها التزاماً بمبادئ الإهداء.',
  ...
  needConsentAr: 'الموافقة على شروط هدايا منصة طريقة الحل مطلوبة.',
  headerShortAr: 'هدية',
  promoBadgeAr: 'هدية منصة طريقة الحل',
  ...
  promoAriaAr: 'إعلان هدية منصة طريقة الحل',
} as const;

export const STORE_GIFT_TERMS_COPY = {
  documentTitle: 'شروط هدايا منصة طريقة الحل | منصة طريقة الحل',
  kickerAr: 'شروط هدايا منصة طريقة الحل',
  titleAr: 'مبادئ الإهداء',
  subtitleAr:
    'هذه الشروط خاصة بهدية منصة طريقة الحل، ومستقلة عن شروط كاردي8 وعن رخصة النفاذ وعن عمولة المسوّق. الموافقة عليها من نموذج المشاركة التزام بمبادئ الإهداء.',
