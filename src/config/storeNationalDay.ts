...
export const STORE_NATIONAL_DAY_COPY = {
  documentTitle: 'عزّ شغلك من طبعك | اليوم الوطني | منصة طريقة الحل',
  kickerAr: 'اليوم الوطني السعودي الـ96',
  heroTitleAr: 'عزّنا بطبعنا',
  heroLeadAr:
    'تهنئكم منصة طريقة الحل بمناسبة اليوم الوطني السعودي الـ96، ونحتفل بكل صاحب نشاط يبني عمله ويخدم حيه ويصنع أثره بطريقته.',
  ...
  packLeadAr:
    'للطلبات أو التجارب المقبولة خلال الحملة — عند جاهزية الأدوات — تمنح منصة طريقة الحل صاحب النشاط أدوات عرض موسمية لا خصماً على السعر:',
  packItemsAr: [
  ...
  packFootnoteAr: 'منصة طريقة الحل لا تحدد عرض نشاطك — بل تمنحك الأداة لتقديمه بطريقتك.',
  ...
  closingLeadAr:
    'في منصة طريقة الحل نصمم منتجات رقمية تراعي اختلاف الأنشطة، وتساعد أصحابها على عرض أعمالهم وتنظيم وصولهم إلى زبائنهم.',
  closingPrimaryCtaAr: 'اكتشف منتجك',
  closingSecondaryCtaAr: 'اطلب تجربة',
  backStoreAr: 'واجهة المتجر',
  identityNoteAr:
    'الهوية الوطنية الرسمية «عزّنا بطبعنا» للهيئة العامة للترفيه — تُستخدم في المواد المعتمدة وفق دليلها، من دون تعديل الشعار أو دمجه في شعار منصة طريقة الحل.',
} as const;
...
export const NATIONAL_DAY_PRODUCTS: readonly NationalDayProductStory[] = [
  ...
  },
  {
    id: 'barber_map',
    labelAr: 'حلاق ماب',
    headlineAr: 'حضور الصالون في منصة طريقة الحل',
