...
export const STORE_RESTAURANT_LIVE = {
  documentTitle: 'مطعمنا1 — منصة خريطة الحل',
  ...
  financialLineAr:
    'تتم مدفوعات الطلب مباشرةً بين المطعم والضيف. منصة خريطة الحل لا تستلم قيمة الطلب ولا تقتطع عمولة منها.',
  ...
  payLeadAr:
    'منصة خريطة الحل مزود تقني لصفحة الطلب، ولا تستلم قيمة الطلب ولا تتحقق من وصولها ولا تقتطع عمولة منها. يحدد المطعم وسائل الدفع التي يتيحها لضيفه، ويتولى مسؤولية بياناتها وتأكيد المدفوعات الواردة إليه.',
  payMethodsAr:
  ...
  payIndependenceAr:
    'لا تحصيل لقيمة الطلب عبر منصة خريطة الحل. يحدد المطعم وسائل الدفع المباشر المتاحة لضيفه، وتتم العلاقة المالية مباشرةً بينهما دون اقتطاع عمولة من قيمة الطلب.',
  ...
  privacyAr:
    'تُستخدم بيانات الضيف لتنفيذ الطلب وإدارته داخل لوحة المطعم. وعند موافقته يمكن حفظ بياناته الأساسية على جهازه لتسهيل طلبه القادم. تحفظ تذاكر الطلبات في لوحة المشغّل وفق سياسة الخصوصية ومدة الاحتفاظ المعتمدة، ولا تستخدم منصة خريطة الحل بيانات الضيوف لإنشاء قوائم تسويقية خاصة بها.',
  privacyArchiveAr:
  ...
  legalBodyAr:
    'مطعمنا1 منتج من منظومة منصة خريطة الحل. متجر منصة خريطة الحل موثّق لدى المركز السعودي للأعمال، ويمكن الاطلاع على بيانات المنشأة من صفحة «التوثيق والتحقق».',
  ...
  orderConsentAr:
    'أقرّ بقراءة شروط الخدمة والخصوصية، وأوافق على سداد قيمة اشتراكي في مطعمنا1 عبر بوابة الدفع التابعة لمنصة خريطة الحل. أما مدفوعات طلبات ضيوف المطعم فتتم مباشرةً بين المطعم والضيف وفق الوسائل التي يفعّلها المطعم، ولا تستلم منصة خريطة الحل قيمتها ولا تقتطع عمولة منها.',
  orderSubmitAr: 'متابعة الدفع',
  orderNoCollectAr: 'لا تستلم منصة خريطة الحل مدفوعات طلبات ضيوف المطعم.',
...
export const STORE_RESTAURANT_LIVE_FEATURES = [
  ...
  },
  {
    ...
    bodyAr: 'لا تحصيل لقيمة الطلب عبر منصة خريطة الحل. المحاسبة مباشرة بين المطعم والضيف.',
  },
  {
