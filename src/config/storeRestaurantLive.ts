...
export const STORE_RESTAURANT_LIVE = {
  ...
  durationLineAr: 'صندوق المحادثة مدرج في الباقة. اشتراك صاحب المطعم عبر بوابة الدفع الآمنة.',
  ...
  termsFoldBodyAr:
    'مطعمنا1 صفحة لضيف الحي ولوحة للمطبخ. 699 ر.س لستة أشهر، أو 999 ر.س لاثني عشر شهراً، عبر بوابة الدفع الآمنة. صندوق المحادثة مدرج، بلا غرفة عامة. طلب الضيف نقداً أو شبكة عند التسليم. التفاصيل في شروط الخدمة.',
