...
export const STORE_RESTAURANT_LIVE = {
  ...
  termsFoldBodyAr:
    'مطعمنا1 صفحة لضيف الحي ولوحة للكاشير والمطبخ. المسار الثابت: 699 ر.س لستة أشهر، أو 999 ر.س لاثني عشر شهراً. المسار المتحرك من نموذج الطلب مشمول في سعره، بلا إضافة مدفوعة. صندوق المحادثة مدرج، بلا غرفة عامة. الطلب يصل خلال ثوانٍ مع تنبيه. إرسال بطاقة التوصيل عبر واتساب بنقرة واحدة من جهاز التشغيل. لا تحصيل إلكتروني لضيف الحي ولا عمولة على قيمة الطلبات. بيانات الضيف لتنفيذ الطلب فقط وتُحفظ على جهازه إن وافق. الباقة لجهاز تشغيل واحد. التفاصيل في شروط الخدمة.',
