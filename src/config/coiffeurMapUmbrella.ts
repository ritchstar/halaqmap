...
export const COIFFEUR_LANDING_COPY = {
  ...
  trust: [
    ...
    },
    {
      ...
      body: 'بوابة الدفع وصفحة النجاح على www.halaqmap.com فقط — لا حساب تاجر لكوافير ماب.',
    },
  ],
} as const;
...
export const COIFFEUR_PARTNERS_COPY = {
  ...
  title: 'ليصل إلى صالونك من تبحث عن خدمتك بوضوح',
  lead:
    'انضمي إلى كوافير ماب لتمنحي نشاطك حضوراً رقمياً منظماً، وتساعدي العميلات على التعرّف على معلومات الصالون وخدماته قبل التواصل أو الزيارة.',
  benefitsTitle: 'فوائد الشريكة',
  benefits: [
    {
      title: 'قدّمي نشاطك بوضوح',
      body: 'معلومات وخدمات مرتبة للعميلات.',
    },
    {
      title: 'اجعلي الوصول أسهل',
      body: 'طريق أوضح من التعرف على الصالون إلى التواصل معه.',
    },
    {
      title: 'حافظي على حضورك',
      body: 'تحديث منظم لما يظهر للعميلات وفق ما يتاح في المنتج.',
    },
  ],
  boundary:
    'كوافير ماب لا يحل محل إدارة الصالون ولا يعد بنتيجة أو حجز مضمون؛ هو منتج قطاعي يساعدك على بناء حضور أوضح وتشغيل رقمي أقرب لطبيعة نشاطك.',
  stepsTitle: 'ثلاث خطوات — لا تُختصر',
  steps: [
    'أكمل طلب الانضمام والتعهدات في مسار الشركاء المعتمد.',
    'ادفعي الرخصة البرمجية عبر بوابة الدفع على www.halaqmap.com بعد اكتمال الطلب فقط.',
    'بعد نجاح الدفع يُفعَّل ظهور صالونك عند الطلب المناسب.',
  ],
  registerCta: 'ابدئي طلب الانضمام',
  secondaryCta: 'شاهدي ما تحصل عليه الشريكة',
  paymentNote: 'الدفع يتم على النطاق الأم عبر بوابة الدفع بعد اكتمال الطلب. لا بوابة دفع منفصلة لكوافير ماب.',
} as const;
