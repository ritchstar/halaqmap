...
export const PLATFORM_REGISTER_INTRO =
  'انضم إلى شبكة الرصد الذكي: بعد تفعيل حزمة الرخصة يُرصد صالونك للعملاء الباحثين في محيطك عبر محرك بحث جغرافي فائق السرعة — اختر الباقة المناسبة وابدأ الظهور بدقة.';
