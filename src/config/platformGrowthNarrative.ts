...
export const PLATFORM_GOAL_ITEMS = [
  {
    ...
    body:
      'نبني قاعدة شركاء مُرصَدين على الخريطة قبل توسيع الوصول — حتى يكون كل بحث في محيط جاهز ذا معنى.',
  },
  {
...
export const PLATFORM_GOALS_SECTION_LEDE =
  'نشر المنصة المدعومة بنظام الرصد الذكي: نُرصد الشركاء على الخريطة ثم نصل بالباحثين بدقة وسرعة على مستوى المملكة.';
