...
export const PLATFORM_DIGITAL_PRODUCT_INTRO_PARAGRAPHS = [
  ...
  'وتقدم المنصة من خلال بنيتها الذكية حلولاً ومنتجات رقمية واشتراكات مخصصة لقطاع الأعمال ومزودي الخدمة (B2B) بمميزات متطورة وأسعار محددة وواضحة، وهو المبرر القانوني والتجاري لعمليات بيع المنتجات الرقمية والاشتراكات الحصرية للمنشآت عبر المنصة، في حين تظل خدمة البحث الجغرافية متطورة ومجانية بالكامل لقطاع الأفراد (B2C) لتسهيل اكتشاف الخدمات، تماشياً وتدعيماً للرؤية المباركة للمملكة العربية السعودية (2030).',
] as const;
