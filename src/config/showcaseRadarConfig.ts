...
export const SHOWCASE_RADAR_CONFIG = {
  ...
  heroSubtitleAr:
    'عرض حي لمسارات النبض والتفاعل على مستوى المملكة — ظهور عند الطلب، لا إشغال دائم.',
  onDemandTaglineAr:
    'مستخدم يستعلم · حلاق متوفر — والصالون يظهر حين يصدر طلب مناسب.',
  userPulseHintAr: 'نبض مستخدم — بداية الاستعلام من المدينة.',
  barberLinkHintAr: 'تفاعل حلاق — استجابة ظاهرة عبر مسارات النبض.',
