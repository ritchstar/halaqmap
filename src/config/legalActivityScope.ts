...
export const LICENSED_ACTIVITY_ENTITY_STRIP_AR =
  `${LEGAL_ENTITY_TYPE_AR} · ${LEGAL_UNIFIED_NUMBER_LABEL_AR}: ${LEGAL_NATIONAL_UNIFIED_NUMBER} · سجل **${LEGAL_REGISTRATION_STATUS_AR}** (${LEGAL_REGISTRATION_ISSUING_AUTHORITY_AR} · إصدار ${LEGAL_COMMERCIAL_REGISTRATION_ISSUED_AT_AR}).`;
