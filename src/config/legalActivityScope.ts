...
export const LICENSED_ACTIVITY_SCOPE_PARAGRAPH_AR =
  ...
  'يقتصر دور المنصة على المعالجة اللحظية لطلب المستخدم وعرض مقدم الخدمة المناسب استنادًا إلى البيانات المتاحة من الأطراف أنفسهم، وأي علاقة بين المستخدم النهائي والصالون في تنفيذ الخدمة الحِرفية **مباشرة** بينهما دون وساطة المنصة أو عمولة عليها.';
