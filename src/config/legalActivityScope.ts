...
export const LICENSED_ACTIVITY_SCOPE_PARAGRAPH_AR =
  ...
  'خدمة البحث الجغرافي للمستخدم النهائي **مجانية** ولا تُعدّ بيعاً منفصلاً للأفراد؛ إيراد المنصة من **بيع المنتجات البرمجية B2B** فقط. ' +
  'أي علاقة بين المستخدم النهائي والصالون في تنفيذ الخدمة الحِرفية **مباشرة** بينهما دون وساطة المنصة أو عمولة عليها.';
...
export const LICENSED_ACTIVITY_IN_SCOPE_AR: readonly string[] = [
  ...
  'تشغيل نظام رصد وبحث جغرافي كبنية تقنية مرفقة بالرخصة',
...
export const SOFTWARE_PRODUCT_PURCHASE_ACK_MODAL_AR =
  ...
  'يُفعَّل الظهور على نظام الرصد الذكي بعد نجاح الدفع فقط، وفق مدة حزمة الرخصة المشتراة. لا تجديد تلقائي.';
