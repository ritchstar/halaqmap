...
export const STORE_WEDDING_LIVE = {
  documentTitle: 'أفراحي1 — منصة خريطة الحل',
  ...
  privacyBodyAr:
    'ينشئ أفراحي1 رابطاً فريداً لكل مدعو، ويحتفظ بالبيانات اللازمة لتخصيص الدعوة وإدارة حالة الرابط وإظهار إحصاءات الفتح لصاحب المناسبة. لا يتتبع النظام حضور المدعو الفعلي إلى القاعة، ولا تستخدم منصة خريطة الحل بيانات المناسبة أو المدعوين لأغراض إعلانية.',
  ...
  legalLeadBeforeAr: 'أفراحي1 أحد منتجات منصة خريطة الحل ',
  ...
  hallStampAr: 'منصة خريطة الحل - halaqmap',
  ...
  orderConsentAr:
    'أقرّ بقراءة شروط الخدمة والخصوصية، وأوافق على سداد قيمة تفعيل أفراحي1 لمناسبة واحدة وفق المدة وحدود الاستخدام الموضحة، بمبلغ 899 ر.س عبر بوابة الدفع التابعة لمنصة خريطة الحل.',
...
export const STORE_WEDDING_LIVE_WOMEN = {
  documentTitle: 'أفراحي1 نسائي — منصة خريطة الحل',
  ...
  privacyBodyAr:
    'ينشئ أفراحي1 رابطاً فريداً لكل مدعوة، ويحتفظ بالبيانات اللازمة لتخصيص الدعوة وإدارة حالة الرابط وإظهار إحصاءات الفتح لصاحبة المناسبة. لا يتتبع النظام حضور المدعوة الفعلي إلى القاعة، ولا تستخدم منصة خريطة الحل بيانات المناسبة أو المدعوات لأغراض إعلانية.',
