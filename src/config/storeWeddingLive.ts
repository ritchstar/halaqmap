...
export const STORE_WEDDING_LIVE = {
  documentTitle: 'أفراحي1 — منصة طريقة الحل',
  ...
  privacyBodyAr:
    'ينشئ أفراحي1 رابطاً فريداً لكل مدعو، ويحتفظ بالبيانات اللازمة لتخصيص الدعوة وإدارة حالة الرابط وإظهار إحصاءات الفتح لصاحب المناسبة. لا يتتبع النظام حضور المدعو الفعلي إلى القاعة، ولا تستخدم منصة طريقة الحل بيانات المناسبة أو المدعوين لأغراض إعلانية.',
  ...
  legalLeadBeforeAr: 'أفراحي1 أحد منتجات منصة طريقة الحل ',
  ...
  orderConsentAr:
    'أقرّ بقراءة شروط الخدمة والخصوصية، وأوافق على سداد قيمة تفعيل أفراحي1 لمناسبة واحدة وفق المدة وحدود الاستخدام الموضحة، بمبلغ 899 ر.س عبر بوابة الدفع التابعة لمنصة طريقة الحل.',
...
export const STORE_WEDDING_LIVE_WOMEN = {
  documentTitle: 'أفراحي1 نسائي — منصة طريقة الحل',
  ...
  privacyBodyAr:
    'ينشئ أفراحي1 رابطاً فريداً لكل مدعوة، ويحتفظ بالبيانات اللازمة لتخصيص الدعوة وإدارة حالة الرابط وإظهار إحصاءات الفتح لصاحبة المناسبة. لا يتتبع النظام حضور المدعوة الفعلي إلى القاعة، ولا تستخدم منصة طريقة الحل بيانات المناسبة أو المدعوات لأغراض إعلانية.',
