...
export const STORE_DATES_LIVE = {
  documentTitle: 'تمرتنا1 — منصة طريقة الحل',
  ...
  legalBodyAr:
    'تمرتنا1 منتج برمجي من متجر منصة طريقة الحل. يمكن الاطلاع على بيانات توثيق المتجر والأنشطة التجارية وروابط التحقق من خلال صفحة «التوثيق والتحقق».',
  legalPrivacyAr:
