...
export const STORE_DATES_LIVE = {
  documentTitle: 'تمرتنا1 — منصة خريطة الحل',
  kickerAr: 'من المحل إلى جوال الحي',
  titleAr: 'تمرتنا1',
  hookAr: 'ينقلك من انتظار زبون الحي… إلى استقبال طلبه من جواله.',
  leadAr:
    'مقر رقمي متخصص لمحلات وبسطات وعربات التمر. يعرض الأصناف المتوفرة وأسعار اليوم، ويستقبل طلبات التوصيل أو الاستلام أو الشحن خارج النطاق، مع لوحة تشغيل ومزاد علني حي لصناديق التمر يشاركه المشغّل برابط منفصل.',
  valueLineAr:
    'واجهة للعميل، ولوحة للمشغّل، ومزاد علني للصناديق، وطلبات منظمة بلا عمولة على قيمة السلة.',
  tryCtaAr: 'شاهد المعاينة',
  trialCtaAr: 'اطلب تجربة تمرتنا1',
  trialTitleAr: 'جرّب تمرتنا1 قبل أن تشتري',
  trialLeadAr:
    'سجل ثم أكد ايميلك واستلم متجرك فوراً. الساعة ستون يوماً من أول دخول إلى صفحة المنتج.',
  extensionTitleAr: 'باقات التمديد بعد التجربة',
  extensionLeadAr:
    'تشمل الباقتان واجهة العميل، ولوحة التشغيل، ورمز QR، ومزاداً علنياً للصناديق، وتشغيل النشاط الثابت أو المتحرك، وتحديث موقع العربة، وخيار الشحن خارج النطاق دون رسوم إضافية.',
  ...
  solutionBodyAr:
    'يحدّث صاحب النشاط الأصناف والأسعار والأوزان من لوحة التشغيل، ويعرض ما وصل اليوم وما نفد. يدخل العميل عبر الرابط أو رمز QR، يختار طلبه وطريقة الاستلام أو الشحن، ثم يصل الطلب منظماً إلى اللوحة. وللصناديق الخاصة يفتح مزاداً علنياً برابط مستقل يشاركه مع من يعتمدهم.',
  ...
  howSteps: [
    ...
    },
    {
      ...
      bodyAr: 'يتصفح العميل الأصناف من جواله دون تثبيت تطبيق، ويحدد الأوزان وطريقة الاستلام أو التوصيل أو الشحن خارج النطاق.',
    },
    {
  ...
  auctionTitleAr: 'صفحة المزاد العلني لصناديق التمر',
  auctionLeadAr:
    'مزاد علني حي برابط منفصل عن صفحة الطلب. يعرض الصندوق بصور ولقطة فيديو اختيارية، ويضع الحاضرون سعراً أعلى حتى يغلق المشغّل المزاد يدوياً ويتواصل مع الفائز خارج المنصة.',
  auctionOpsTitleAr: 'تشغيل المزاد من لوحة التشغيل',
  auctionOpsSteps: [
    {
      titleAr: 'افتح قسم المزاد',
      bodyAr: 'من لوحة التشغيل اختر «المزاد». انسخ رابط المزاد العام `/t/` ثم الرمز ثم `/auction` وشاركه فقط مع من تعتمدهم للمزاودة.',
    },
    {
      titleAr: 'أنشئ صندوق المزاد',
      bodyAr: 'أدخل العنوان والوصف والسعر الابتدائي والحد الأدنى للزيادة، وارفع حتى ست صور، وأضف رابط فيديو `HTTPS` إن رغبت.',
    },
    {
      titleAr: 'انشر ليظهر للعامة',
      bodyAr: 'اختر «حفظ ونشر الآن» ليظهر الصندوق فوراً في صفحة المزاد. المسودة تبقى في اللوحة فقط ولا تظهر للزائر حتى تنشرها.',
    },
    {
      titleAr: 'راقب المزايدات ثم أغلق يدوياً',
      bodyAr: 'ترى الاسم المختصر والسعر الحالي ومبلغ كل مزايدة. عندما تستقر السومة اضغط الإغلاق اليدوي؛ يظهر الفائز ورقم جواله في اللوحة فقط لتتواصل معه مباشرة.',
    },
  ],
  auctionUseTitleAr: 'استخدام صفحة المزاد للمزايد',
  auctionUseSteps: [
    {
      titleAr: 'افتح رابط المزاد',
      bodyAr: 'يدخل المزايد من الرابط الذي أرسله صاحب النشاط. لا فهرس عام للمزاد؛ من معه الرابط يرى الصناديق المنشورة فقط.',
    },
    {
      titleAr: 'اطلع على الصندوق',
      bodyAr: 'يشاهد الصور والفيديو إن وُجد، والسعر الحالي، والحد الأدنى للمزايدة التالية.',
    },
    {
      titleAr: 'ضع مزايدتك',
      bodyAr: 'يكتب الاسم ورقم الجوال ومبلغاً أعلى من السعر الحالي بحد الزيادة المعتمد. المزايدات علنية ويظهر الاسم مختصراً للعامة.',
    },
    {
      titleAr: 'بعد الإغلاق',
      bodyAr: 'يتواصل صاحب النشاط مع الفائز خارج المنصة لإتمام البيع والتسليم والدفع. المنصة لا تحصّل ثمن الصندوق ولا تتوسط في الصفقة.',
    },
  ],
  auctionDisclaimerAr:
    'صفحة المزاد أداة عرض ومزايدة فقط. الاتفاق على إتمام البيع والتسليم والدفع بين النشاط والفائز مباشرة، دون وساطة أو مسؤولية من منصة خريطة الحل على تنفيذ الصفقة.',
  shippingFeatureLineAr:
    'الشحن خارج النطاق: يفعّله المشغّل من اللوحة بنص حر عن شركة الشحن والتكلفة التقريبية، ويظهر للعميل عند الطلب مع إخلاء مسؤولية المنصة.',
  ingestLineAr:
  ...
  legalBodyAr:
    'تمرتنا1 منتج برمجي من متجر منصة خريطة الحل. يمكن الاطلاع على بيانات توثيق المتجر والأنشطة التجارية وروابط التحقق من خلال صفحة «التوثيق والتحقق».',
  legalPrivacyAr:
...
export const STORE_DATES_LIVE_FEATURES = [
  {
    titleAr: 'مزاد علني حي للصناديق',
    bodyAr:
      'صفحة منفصلة `/t/.../auction` بصور وفيديو، مزايدة علنية لحظية، وإغلاق يدوي من اللوحة. البيع والتسليم بينك وبين الفائز خارج المنصة.',
    pulse: true,
  },
  {
    titleAr: 'شحن خارج النطاق',
    bodyAr:
      'فعّل خدمة الشحن من اللوحة واكتب تعليماتك لشركة الشحن والتكلفة التقريبية. المنصة تعرض النص فقط ولا تتوسط في الشحن.',
  },
  {
