...
const OCCASION_QUICK = [
  '/images/store/lab/lab-quick-sand.png',
  '/images/store/lab/lab-quick-sage.png',
  '/images/store/lab/lab-quick-ink.png',
  '/images/store/lab/lab-quick-blush.png',
  '/images/store/lab/lab-quick-sky.png',
  '/images/store/lab/lab-quick-honey.png',
] as const;

const OCCASION_FEATURED = [
  '/images/store/lab/lab-featured-rose.png',
  '/images/store/lab/lab-featured-navy.png',
  '/images/store/lab/lab-featured-olive.png',
  '/images/store/lab/lab-featured-plum.png',
  '/images/store/lab/lab-featured-charcoal.png',
  '/images/store/lab/lab-featured-terracotta.png',
  '/images/store/lab/lab-featured-teal.png',
  '/images/store/lab/lab-featured-champagne.png',
] as const;

const OCCASION_LUXURY = [
  '/images/store/lab/lab-luxury-gold.png',
  '/images/store/lab/lab-luxury-ivory.png',
  '/images/store/lab/lab-luxury-emerald.png',
  '/images/store/lab/lab-luxury-garnet.png',
  '/images/store/lab/lab-luxury-onyx.png',
  '/images/store/lab/lab-luxury-sapphire.png',
  '/images/store/lab/lab-luxury-bronze.png',
  '/images/store/lab/lab-luxury-pearl.png',
  '/images/store/lab/lab-luxury-burgundy.png',
  '/images/store/lab/lab-luxury-amber.png',
  '/images/store/lab/lab-luxury-silver.png',
...
export const STORE_WEDDING_MARKETING_FRAMES = [
  ...
  '/images/store/lab/lab-luxury-amber.png',
  '/images/store/lab/lab-luxury-silver.png',
  '/images/store/lab/lab-wedding-panorama.png',
