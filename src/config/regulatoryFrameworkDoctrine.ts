...
import { REGULATORY_FRAMEWORK_HIGHLIGHT_ACTIVITIES_AR } from '@/config/licensedCommercialActivities';
import {
...
/** قالب جاهز — مدير المبيعات / الناظر / المتحدث */
...
═══════════════════════════════════════════════════
【الإطار النظامي المعتمد — عقيدة إلزامية】
═══════════════════════════════════════════════════
