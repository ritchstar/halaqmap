...
export const STORE_DIRECT_PAY_COPY = {
  ...
  leadAr:
    'منصة خريطة الحل شريك تقني: تعرض تعليمات أدخلها المشغّل، ولا تستلم المبلغ ولا تؤكد وصوله ولا تأخذ عمولة على الحرفة. العلاقة المالية بين المشغّل وعميله بمسؤوليتهما.',
  deskLeadAr:
