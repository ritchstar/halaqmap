...
export const PLATFORM_NEAR_SEARCH_PHRASES_AR = [
  ...
  'أبي حلاق قريب',
  'عطني اقرب حلاق',
  'شف لي اقرب حلاق رجالي من موقعي',
  'barber near me',
] as const;

export const PLATFORM_NEAR_SEARCH_BLURB_AR =
  'أبي أو عطني أو شف لي: اقرب حلاق رجالي من موقعي، اقرب حلاق 200 متر حتى 1000 متر، اقرب حلاق رجالي من موقعي مفتوح الآن، أو اقرب حلاق المدينة المنورة — ابدأ فزعة الاستعلام من حلاق ماب.';
