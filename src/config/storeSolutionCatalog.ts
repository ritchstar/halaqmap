 ...
 *
 * فهرس منصة خريطة الحل — كتالوج مصنع عربي (شاتلي). لا يُستورد من App.tsx.
 */
...
export const STORE_SOLUTION_CATALOG_COPY = {
  documentTitle: 'منصة خريطة الحل — متجر المنتجات الرقمية | معاينة الفهرس',
  brandAr: 'منصة خريطة الحل',
  ...
  heroCountAr: '14 منتجًا جاهزًا لمسارات عمل مختلفة',
...
export const STORE_SOLUTION_CATALOG_PRODUCTS: readonly SolutionCatalogProduct[] = [
  {
    ...
    summaryAr: 'حضور الصالون في منصة خريطة الحل',
    descriptionAr:
  ...
  },
  {
    ...
    categoryId: 'neighbor',
    categoryAr: 'جار الحي',
    summaryAr: 'قائمة بيتك، تذكرة واحدة، بلا عمولة',
    descriptionAr:
      'صفحة قائمة أطباق منزلية وتذكرة طلب واحدة بدل السلة، مع دفع نقدي أو بطاقة عند الاستلام بلا عمولة على قيمة الوجبات، ولوحة تشغيل بمساري طلبات ومركز نمو للإحالة.',
    tags: ['قائمة منزلية', 'تذكرة طلب', 'بلا عمولة'],
    stripe: 'yellow',
    logoSrc: solutionCatalogMarkSrc('B-03'),
    cardImageSrc: solutionCatalogCardImageSrc('B-03'),
    href: ROUTE_PATHS.STORE_KITCHEN,
    pathItems: ['قائمة أصناف مصنّفة', 'تذكرة طلب برقم متابعة', 'لوحة تشغيل ومركز نمو'],
  },
  {
    code: 'B-04',
    nameAr: 'حلانا1',
    ...
    categoryId: 'neighbor',
    categoryAr: 'جار الحي',
    summaryAr: 'اطلبي حلا مستوحى مما صنعته سابقًا',
    descriptionAr:
      'صفحة عرض لأعمالك الجاهزة وطلب حلا مخصص بعرض سعر، برحلة طلب واضحة من الفكرة إلى الجدولة والمراجعة، بدل سلة تسوق عامة.',
    tags: ['عرض أعمال', 'طلب مخصص', 'عربون'],
    stripe: 'yellow',
    logoSrc: solutionCatalogMarkSrc('B-04'),
    cardImageSrc: solutionCatalogCardImageSrc('B-04'),
    href: ROUTE_PATHS.STORE_HALANA,
    pathItems: ['معرض أعمال جاهزة', 'تخصيص وجدولة', 'تسعير وعربون قبل التحضير'],
  },
  {
    code: 'B-05',
    nameAr: 'تمرتنا1',
    ...
    categoryId: 'neighbor',
    categoryAr: 'جار الحي',
    summaryAr: 'أصناف التمر اليوم ومزاد الصناديق أقرب من جوال الحي',
    descriptionAr:
      'صفحة رقمية لمحلات وبسطات وعربات التمر تعرض الأصناف والأسعار والأوزان يومياً، وتستقبل طلبات التوصيل أو الاستلام أو الشحن خارج النطاق، مع مزاد علني حي لصناديق التمر ولوحة تشغيل بلا عمولة على قيمة السلة.',
    tags: ['أصناف اليوم', 'مزاد علني', 'شحن خارج النطاق'],
    stripe: 'yellow',
    logoSrc: solutionCatalogMarkSrc('B-05'),
    cardImageSrc: '/images/store/dates/dates-field-snapshot-scene.jpg',
    href: ROUTE_PATHS.STORE_DATES,
    pathItems: ['أصناف وأسعار اليوم', 'مزاد علني للصناديق', 'شحن خارج النطاق ولوحة تشغيل'],
  },
  {
    code: 'B-06',
    nameAr: 'بخورنا1',
    ...
    categoryId: 'neighbor',
    categoryAr: 'جار الحي',
    summaryAr: 'أصناف البخور والعود اليوم أقرب من جوال الحي',
    descriptionAr:
      'صفحة رقمية لمحلات وبسطات وعربات البخور والعود والعطور تعرض الأصناف والأسعار يومياً، وتستقبل طلبات التوصيل أو الاستلام بلا عمولة على قيمة السلة، مع لوحة تشغيل لتحديث الأصناف وموقع العربة.',
    tags: ['بخور وعود وعطور', 'موقع العربة', 'بلا عمولة'],
    stripe: 'yellow',
    logoSrc: solutionCatalogMarkSrc('B-06'),
