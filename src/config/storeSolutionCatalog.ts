...
export const STORE_SOLUTION_CATALOG_PRODUCTS: readonly SolutionCatalogProduct[] = [
  ...
  },
  {
    ...
    categoryId: 'neighbor',
    categoryAr: 'جار الحي',
    summaryAr: 'أصناف التمر اليوم أقرب من جوال الحي',
    descriptionAr:
      'صفحة رقمية لمحلات وبسطات وعربات التمر تعرض الأصناف والأسعار والأوزان يومياً، وتستقبل طلبات التوصيل أو الاستلام بلا عمولة على قيمة السلة، مع لوحة تشغيل لتحديث الأصناف وموقع العربة.',
    tags: ['أصناف اليوم', 'موقع العربة', 'بلا عمولة'],
    stripe: 'yellow',
    logoSrc: null,
    cardImageSrc: '/images/store/dates-hero-marketing.jpg',
    href: ROUTE_PATHS.STORE_DATES,
    pathItems: ['أصناف وأسعار اليوم', 'طلب منظم بالوزن', 'لوحة تشغيل وموقع العربة'],
  },
  {
    code: 'B-06',
    nameAr: 'بخورنا1',
