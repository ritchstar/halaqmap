    ...
    >
      ...
      >
        {/* ── خلفية الهيرو المصوَّرة — صالون فاخر بإضاءة زمردية وذهبية،
            ...
            صورتان مختلفتان حسب الجهاز (2026-09-22 — طلب مستخدم مباشر:
            "ضع الصورة خلفية لمتصفح الجوال ... بدل الخلفية التي موجودة الان"):

            · الحاسوب: landing-hero-barbershop.webp (أفقية 2848×1600) — دون
              تغيير، بلا مشكلة أصلاً لأن نسبة حاوية الحاسوب أقرب لنسبة الصورة.

            · الجوال: landing-hero-mobile-corridor.webp — صورة صالون مختلفة
              بعمودية أصلية (1600×2848، نسبة ≈0.56) صُمِّمت خصيصاً لتناسب
              حاوية الهيرو الطويلة والضيقة على الجوال (~0.49) — تحلّ هذه
              الصورة الجديدة مباشرةً المشكلة الجذرية التي عالجها الإصلاح
              السابق بحيلة bg-position (10% بدل المركز، على صورة الحاسوب
              الأفقية نفسها): تلك الحيلة عادت غير ضرورية الآن لأن هذه الصورة
              الجديدة، لكونها عمودية أصلاً، تُظهر بـbg-cover bg-center عادية
              تقريباً كامل ارتفاعها (الرفوف الخشبية المضاءة على الجانبين
              + النبتة أسفل اليمين) بقصّ أفقي طفيف فقط (~13%) — محاكاة حسابية
              دقيقة لقصّ bg-cover أكّدت هذا قبل الاعتماد. طبقتا التعتيم
              أدناه (العمودية والأفقية) لم تتغيّرا — تعملان بنفس الكفاءة فوق
              كلتا الصورتين لحماية تباين النص الأبيض. ── */}
        <div
          className="pointer-events-none absolute inset-0 z-0 bg-cover bg-center"
          style={{
            backgroundImage: isMobile
              ? "url('/images/landing-hero-mobile-corridor.webp')"
              : "url('/images/landing-hero-barbershop.webp')",
          }}
          aria-hidden
        />
        <div
