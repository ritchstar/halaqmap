 ...
 *
 * يُرسَل مع إيصال حزمة الرخصة الماسية
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-4xl space-y-14 px-5 py-12">
        ...
        <section>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {[
              { q: 'كم يوم باقي في حزمتي؟', a: 'يُظهر الأيام المتبقية ويوجّهك لزر التجديد أسفل اللوحة', icon: CreditCard },
              { q: 'كيف أجدّد الحزمة؟', a: 'يوجّهك لزر «تجديد / شحن الحزمة» أسفل اللوحة (لا رابط دفع ناقص)', icon: CreditCard },
