...
export default function PartnerBannersPreviewLanding() {
  ...
  return (
    <div
      ...
      dir="rtl"
    >
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(251,191,36,0.10),transparent_24%),radial-gradient(circle_at_20%_18%,rgba(34,211,238,0.08),transparent_22%),radial-gradient(circle_at_bottom_left,rgba(16,185,129,0.06),transparent_20%)]" />

      <div className="relative z-10 border-b border-slate-200/85 bg-white/82 backdrop-blur-xl">
        <div className="container mx-auto max-w-6xl px-4 py-8 md:py-10">
          ...
          <div className="flex flex-wrap items-start justify-between gap-6">
            ...
            <div className="max-w-xl rounded-[1.4rem] border border-slate-200 bg-white/92 p-4 shadow-[0_16px_38px_rgba(148,163,184,0.10)]">
      ...
      <div className="relative z-10 container mx-auto max-w-6xl space-y-20 px-4 py-10 md:py-14">
        ...
        >
          <Sparkles className="mx-auto mb-3 h-8 w-8 text-emerald-600" aria-hidden />
