...
export default function Privacy() {
  const sections = [
    ...
    },
    {
      ...
      content:
        "إن فعّل المشغّل تحويلًا بنكيًا أو STC Bank أو معرّف سريع أو رابطًا خارجيًا، تعرض منصة طريقة الحل تعليماته فقط. لا تستلم ثمن الحرفة ولا تؤكد وصوله ولا تأخذ عليه عمولة. الآيبان والمعرّفات تُشفَّر، وإثبات التحويل للمراجعة اليدوية ثم يُحذف أو يُقيَّد. لا تُحفظ بيانات بطاقة. التفاصيل في سياسة وسائل الدفع المباشر: /store/direct-pay"
    },
    {
      icon: MessageSquare,
