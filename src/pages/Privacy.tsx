  ...
  const sections = [
    ...
    },
    {
      ...
      content:
        ...
        "**بيانات الموقع:** تُعالَج **لحظياً (Instantaneous / Real-Time)** عند الإذن؛ **تنتهي المعالجة** عند إغلاق المتصفح/التطبيق أو انتهاء الجلسة. **لا نحتفظ بها كسجل تاريخي في قاعدة بيانات المنصة** و**لا نُجري تتبعاً تاريخياً** لتحركاتك، مع احتمال مرورها تقنياً عبر مزوّدي البنية أو الخدمات المساندة بالقدر اللازم لتنفيذ الطلب."
    },
    {
      icon: Eye,
    ...
    {
      icon: Lock,
      title: "وسائل الدفع المباشر في منتجات المتجر",
      content:
        "إن فعّل المشغّل تحويلًا بنكيًا أو STC Bank أو معرّف سريع أو رابطًا خارجيًا، تعرض منصة خريطة الحل تعليماته فقط. لا تستلم ثمن الحرفة ولا تؤكد وصوله ولا تأخذ عليه عمولة. الآيبان والمعرّفات تُشفَّر، وإثبات التحويل للمراجعة اليدوية ثم يُحذف أو يُقيَّد. لا تُحفظ بيانات بطاقة. التفاصيل في سياسة وسائل الدفع المباشر: /store/direct-pay"
    },
    {
      icon: MessageSquare,
      title: "الشات والترجمة والمساعدات القانونية",
      content:
        "عند استخدام **الشات الكتابي** مع صالون على حلاق ماب، تُعالَج رسائلك في سياق التشغيل والأمان وفق هذه السياسة. في **الباقة الماسية** قد تُعرض طبقة **ترجمة آلية** تهدف إلى تسهيل التواصل **بينك وبين الصالون كمزوّد خدمة** داخل المنصة؛ لا تُعدّ الترجمة استشارة أو وثيقة رسمية، وقد تُسجَّل محتويات المحادثة بقدر ما يلزم للتشغيل والامتثال والحد الأدنى من الاحتفاظ. كما أن محادثات **الناظر القانوني** أو المساعدات الإرشادية المشابهة قد تُسجَّل للتقارير والتحسين، ولا تُعدّ استشارة قانونية شخصية أو مرجعاً نظامياً ملزماً. راجع أيضاً سياسة الشركاء عند الحاجة.",
    },
    {
      icon: Shield,
      ...
      <div className="container mx-auto px-4 py-16" dir="rtl">
        ...
        >
          <p className="text-sm text-muted-foreground leading-relaxed mb-3">
            ولمن يريد قراءة الأساس التأسيسي للمنصة من زاوية تقنية أوسع، يمكن الرجوع إلى الصفحة المرجعية الخاصة
            **بحوكمة المعالجة اللحظية** وحدود **إتلاف الأثر البرمجي** بعد انتهاء الجلسة.
          </p>
          <NavLink
