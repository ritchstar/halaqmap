...
export default function PartnerMarketingCommitmentsPage() {
  ...
  return (
    // data-contrast-guard-manual-bg: هذه الصفحة كانفاس داكن مقصود (تدرّج
    // #020912→#041422→#020912) ولا تتبع الكانفاس الفاتح الذي انضم له مسار
    // الشركاء عموماً (راجع isStoreCustomerSurface في storeCustomerSurface.ts
    // — يُدرج `/partners/*` كله ضمن نطاق حارسي التباين). كل ألوان النص هنا
    // فاتحة صراحة ومتعمَّدة (text-teal-50/100/200/300, text-slate-100/200/300,
    // text-white) وتباينها مضمون فعلياً فوق هذا التدرّج الداكن — فتُستثنى
    // الصفحة كاملة من الحارسين ليُعتمد لون النص المكتوب هنا دائماً دون قراءة
    // خلفية "فعّالة" محسوبة آلياً قد تُخطئ (تأكيد مباشر على الموقع الحي:
    // صناديق «الفائدة للصالون» كانت تُصحَّح خطأً إلى الحبر الداكن #2e2418
    // شبه المختفي فوق هذا التدرّج، رغم كونها مصممة فاتحة أصلاً — النسخة
    // المنشورة حالياً للحارس أقدم من إصلاحات المقارنة اللونية المحلية غير
    // المدفوعة بعد لفرع الإنتاج، وهذا الاستثناء يضمن سلامة العرض بصرف النظر
    // عن أي إصدار من الحارس).
    <div
      dir="rtl"
