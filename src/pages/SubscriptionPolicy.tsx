              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      عند انتهاء مدة الترخيص تتوقف صلاحية الإدراج عبر نظام الرصد الذكي حتى شراء ترخيص جديد أو استرداد كود تفعيل.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <CardContent className="pt-6">
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground pr-7">
                    إذا لم يُجدَّد الترخيص بعد انتهاء الصلاحية، تتوقف خدمة الإدراج عبر نظام الرصد الذكي دون حذف تلقائي للبيانات إلا وفق طلب صريح.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold mb-2 flex items-center gap-2">
