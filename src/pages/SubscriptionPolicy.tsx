...
export default function SubscriptionPolicy() {
  ...
  const paymentMethods = [
    {
      ...
      description:
        "الطريقة المتاحة لشراء حزم الرخصة الحالية: دفع لمرة واحدة عبر بوابة ميسر (Moyasar) المعتمدة وفق الأنظمة المعمول بها في المملكة — برونزي 200 ر.س، ذهبي 300 ر.س، ماسي 400 ر.س — لمدة 30 يوماً لكل حزمة، دون تجديد تلقائي أو خصم دوري. للماسية: إضافة «المناوب الرقمي الذكي» إضافة برمجية متقدمة (Add-on) اختيارية +50 ر.س/حزمة — منفصلة عن الرخصة التقنية.",
      icon: CheckCircle2,
      benefits: [
        "دفع لمرة واحدة مقابل حزمة رخصة شهرية (30 يوماً) — برونزي 200 · ذهبي 300 · ماسي 400 ر.س — كما في جدول الباقات أعلاه",
        "لا يخزن الموقع رقم البطاقة أو رمز الأمان — تتم المعالجة لدى مزود الدفع المعتمد",
        "إيصال إلكتروني وإشعار بريد بعد إتمام الدفع",
        "تفعيل تلقائي عبر نظام الاستجابة الذكية بعد نجاح الدفع ومعالجة الويب هوك",
      ],
    },
  ];
  ...
  const cancellationSteps = [
    ...
    {
      step: "4",
      title: "إخفاء من نظام الاستجابة الذكية",
          ...
          <Card className="max-w-4xl mx-auto border-primary/30 bg-primary/5">
            ...
            <CardContent className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed text-justify">
                ...
                موحدة) ضمن نظام الاستجابة الذكية لمنصة (حلاق ماب). ويُعامل بيان الموقع فيها باعتباره عنصرًا وصفيًا ضمن
                سجل بيانات المنشأة، بينما تقوم المنصة على استرجاع المعلومات عند الطلب، والمعالجة والفلترة اللحظية بين
                استعلام المستخدمين وبيانات الحلاقين المتاحة، ثم عرض مقدم الخدمة المناسب وفق البيانات المتاحة.
