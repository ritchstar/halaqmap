...
export default function SubscriptionPolicy() {
  ...
  const paymentMethods = [
    ...
    },
    {
      ...
      description:
        "دفع مقدم لستة أشهر (أسعار الشهر الواحد للباقة دون تغيير). خلال فترة العرض التشغيلي: خصم 10% على إجمالي أتعاب الـ6 أشهر + 3 أشهر صلاحية إضافية (عرض تشغيلي) — أي 9 أشهر صلاحية. أمثلة مع العرض: برونزي 540 ر.س، ذهبي 810 ر.س، ماسي 1080 ر.س. بعد انتهاء العرض: السعر الكامل لـ6 أشهر (600 / 900 / 1200 ر.س).",
      icon: CheckCircle2,
      benefits: [
