          ...
          <Card className="max-w-4xl mx-auto border-primary/30 bg-primary/5">
            ...
            <CardContent className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed text-justify">
                ...
                موحدة) ضمن نظام الاستجابة الذكية لمنصة (حلاق ماب). هذا المنتج هو مساحة برمجية مخصصة ومطورة لعرض بيانات
                الصالون ومعلوماته التشغيلية وتحديثها تقنيًا لربطه وإدراج بياناته للباحثين القريبين منه عند الطلب.
