...
export default function SubscriptionPolicy() {
  ...
  const paymentMethods = [
    {
      title: "شراء حزمة رخصة النفاذ الرقمية (بوابة الدفع)",
      description:
        "الطريقة المتاحة لشراء حزم الرخصة الحالية: دفع لمرة واحدة عبر بوابة الدفع المعتمدة وفق الأنظمة المعمول بها في المملكة — برونزي 200 ر.س، ذهبي 300 ر.س، ماسي 400 ر.س — لمدة 30 يوماً لكل حزمة، دون تجديد تلقائي أو خصم دوري. للماسية: إضافة «المناوب الرقمي الذكي» إضافة برمجية متقدمة (Add-on) اختيارية +50 ر.س/حزمة — منفصلة عن الرخصة التقنية.",
      icon: CheckCircle2,
      benefits: [
