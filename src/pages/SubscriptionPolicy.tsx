  ...
  const paymentMethods = [
    {
      ...
      description:
        "معالجة دفع لمرة واحدة عبر بوابة ميسر (Moyasar) المعتمدة وفق الأنظمة المعمول بها في المملكة، لشراء حزمة برمجية لخدمات الإدراج البرمجية الموحدة — دون تجديد تلقائي أو خصم دوري.",
      icon: CheckCircle2,
      benefits: [
        "دفع لمرة واحدة مقابل مدة حزمة برمجية محددة (مثال: 30 يوماً للحزمة البرمجية الشهرية المعروض)",
    ...
    {
      title: "التحويل البنكي (حزم برمجية ممتدة المدة)",
      description:
        "دفع مقدم لحزم برمجية إدراج برمجية بمدد أطول (مثل 180 أو 270 يوماً حسب الباقة والعرض). عند السداد عبر التحويل البنكي، يُتحقق من الإيصال يدوياً وتُصدر الإدارة كود التفعيل الرقمي خلال 24 ساعة كحد أقصى.",
      icon: CheckCircle2,
      benefits: [
        "التحقق من الإيصال يدوياً من الإدارة قبل إصدار كود التفعيل",
        "إرسال كود التفعيل الرقمي للحزمة البرمجية عبر البريد المسجل",
          ...
          <Card className="mt-8 max-w-3xl mx-auto bg-muted/50">
            <CardContent className="pt-6">
              <p className="text-sm text-muted-foreground text-center">
                <strong>ملاحظة هامة:</strong> الحزم البرمجية الرقمية مسبقة الدفع غير قابلة للإلغاء أو الاسترداد بعد تفعيل كود الحزمة البرمجية. التحويلات البنكية تُعالَج بإصدار كود تفعيل خلال 24 ساعة كحد أقصى بعد التحقق من الإيصال.
              </p>
            </CardContent>
          </Card>
