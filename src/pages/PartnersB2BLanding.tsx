...
export default function PartnersB2BLanding() {
  useDocumentTitle('حلاق ماب — مسار الشركاء');
  ...
  return (
    <div dir="rtl" className="min-h-screen font-sans overflow-x-hidden" style={{ background: "#0A1628", color: "#F8FAFC" }}>
      ...
      <div className="sticky top-0 z-[60]">
        ...
        <PartnerPlatformLaunchTicker surface="b2b" />
      ...
      <PartnerOwnerWatchSpotlight variant="dark" />
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.15 }} variants={stagger}>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <motion.div variants={fadeUp} className="p-6 rounded-2xl flex flex-col" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(205,127,50,0.35)" }}>
                ...
                <Link to={ROUTE_PATHS.REGISTER} className="mt-6 block text-center py-3 rounded-xl font-bold text-sm transition-all hover:opacity-90" style={{ border: '1px solid rgba(205,127,50,0.5)', color: '#cd7f32' }}>
                  اشترك الآن
                </Link>
              </motion.div>
              ...
              <motion.div variants={fadeUp} className="p-6 rounded-2xl flex flex-col relative" style={{ background: "rgba(212,175,55,0.07)", border: "2px solid rgba(212,175,55,0.55)", boxShadow: "0 0 32px rgba(212,175,55,0.12)" }}>
                ...
                <Link to={ROUTE_PATHS.REGISTER} className="mt-6 block text-center py-3 rounded-xl font-bold text-sm transition-all hover:opacity-90" style={{ background: '#D4AF37', color: '#0A1628' }}>
                  اشترك الآن
                </Link>
              </motion.div>
              ...
              <motion.div variants={fadeUp} className="p-6 rounded-2xl flex flex-col" style={{ background: "rgba(6,182,212,0.06)", border: "1px solid rgba(6,182,212,0.35)" }}>
                ...
                <Link to={ROUTE_PATHS.REGISTER} className="mt-6 block text-center py-3 rounded-xl font-bold text-sm transition-all hover:opacity-90" style={{ border: '1px solid rgba(6,182,212,0.5)', color: '#06B6D4' }}>
                  اشترك الآن
                </Link>
              </motion.div>
            </div>
