...
const MOMENTUM_STRIPS = [
  ...
  'كل حلاق مفعّل اليوم يظهر عند الاستعلام المناسب في منطقته.',
  'الجاهزية الآن تعني حضوراً أمام باحث قائم، لا انتظاراً لوصول مؤجّل.',
  'كل موضع يُبنى اليوم داخل المنصة يمكن أن يتحول لاحقًا إلى أفضلية تنافسية يصعب تعويضها.',
  'القيمة ليست في الوجود الرقمي فقط، بل في الحضور المهني أمام استعلام حي.',
  'المستثمر الذكي يقرأ التفعيل الآن كفرصة موضع لا كتكلفة عابرة.',
] as const;
...
const INVESTMENT_CARDS = [
  ...
  {
    icon: Users,
    title: 'الاستعلام يعمل الآن',
    body: 'الباحث يصل ويسأل عن حلاق مناسب في محيطه. رخصتك هي ما يضع صالونك في تلك الاستجابة.',
    tone: 'emerald',
  },
  {
    icon: Store,
    title: 'خذ موضعك والجماهيرية قائمة',
    body: 'تفعيل الرخصة الآن يضع صالونك أمام الاستعلام القائم — والمزيد من الباحثين في الطريق.',
    tone: 'cyan',
  },
  {
    icon: TrendingUp,
  ...
  },
  {
    ...
    body: 'المسار بسيط: رخصة ظهور عند الطلب، تواصل مباشر بعد الظهور، والمزيد من الباحثين في الطريق.',
    tone: 'emerald',
  },
  {
    icon: TrendingUp,
  ...
  },
  {
    ...
    body: 'وجود الصالون داخل المنصة لا يبقى حضورًا شكليًا، بل يدعم الظهور والاستقبال أمام استعلام حي في حيّك.',
    tone: 'emerald',
  },
  {
    icon: MapPinned,
  ...
  {
    icon: Users,
    title: 'حضور أمام عادة البحث',
    body: 'عادات الاستعلام تتشكّل الآن. المفعّل أقرب للظهور حين يتحوّل البحث إلى تواصل مباشر.',
    tone: 'amber',
  },
  {
    icon: Megaphone,
