...
import { STORE_GENERAL_TRIAL_TERMS_COPY, STORE_GENERAL_TRIAL_TERMS_VERSION } from '@/config/storeProductTrial';
import { useDocumentTitle } from '@/hooks/useDocumentTitle';
import { ROUTE_PATHS } from '@/lib/routePaths';

export default function StoreGeneralTrialTermsPage() {
  useDocumentTitle(STORE_GENERAL_TRIAL_TERMS_COPY.documentTitle);
  const copy = STORE_GENERAL_TRIAL_TERMS_COPY;
      ...
      <article className="px-4 py-10 md:py-14">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-2 text-xs text-white/45">
            {copy.versionLabelAr}: {STORE_GENERAL_TRIAL_TERMS_VERSION}
          </p>
          ...
          <Link
            ...
            className="mt-8 inline-flex rounded-full bg-teal-400 px-5 py-2.5 text-sm font-extrabold text-[#061018]"
          >
            {copy.backAr}
          </Link>
        </div>
