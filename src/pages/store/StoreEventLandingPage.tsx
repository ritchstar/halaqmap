...
const FEATURES_MEN = [
  ...
  'كرت باسم الداعي والتاريخ والمكان، وانسخ رابط الموقع.',
  'قاعة حيّة: تهاني، تنويهات، صور، ويوتيوب في وسط الشاشة.',
...
const FEATURES_WOMEN = [
  ...
  'كرت باسم الداعية والتاريخ والمكان، وانسخن رابط الموقع.',
  'قاعة حيّة بطابع نسائي: تهاني، تنويهات، صور، ويوتيوب في وسط الشاشة.',
