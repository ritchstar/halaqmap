...
const FEATURES_MEN = [
  'يسرنا دعوتكم إلى حفل زفاف ابننا أو ابنتنا، مع التاريخ بالعربية والإنجليزية ومكان العشاء.',
  'انسخ رابط الموقع ليظهر على الكرت وشاشة القاعة.',
  'قاعة حيّة: تهاني الضيوف، تنويهات، صور، ويوتيوب في وسط الشاشة.',
  'نموذجان للتحميل: الكرت الذهبي والكرت العاجي.',
] as const;

const FEATURES_WOMEN = [
  'يسرنا دعوتكن إلى حفل زفاف ابننا أو ابنتنا، مع التاريخ بالعربية والإنجليزية ومكان العشاء.',
  'انسخن رابط الموقع ليظهر على الكرت وشاشة القاعة.',
  'قاعة حيّة بطابع نسائي: تهاني الضيفات، تنويهات، صور، ويوتيوب في وسط الشاشة.',
  'نموذجان للتحميل: الكرت الوردي الذهبي والكرت اللؤلؤي.',
] as const;
