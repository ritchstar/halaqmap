...
const FEATURES_MEN = [
  ...
  'روابط المدعوين تصدر من لوحة المشتري فقط؛ كل رابط لمدعو واحد وجهاز واحد، وإعادة الإرسال تُحظر. حماية الخصوصية العائلية منطلق النموذج.',
] as const;
...
const FEATURES_WOMEN = [
  ...
  'روابط المدعوات تصدر من لوحة المشترية فقط؛ كل رابط لمدعوة واحدة وجهاز واحد، وإعادة الإرسال تُحظر. حماية الخصوصية العائلية منطلق النموذج.',
] as const;
