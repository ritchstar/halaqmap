...
/**
 * سياسة خصوصية المستخدمين — بيانات موقع لحظية فقط (بدون تخزين)، وعدم مشاركة مع أطراف خارجية.
  ...
  const sections = [
    {
      ...
      content:
        ...
        'فيما يخص **بيانات الموقع**، نعالجها **لحظياً (Instantaneous / Real-Time)** عند موافقتك فقط، ولأغراض محددة موضّحة أدناه — **دون تخزينها في قاعدة بيانات** و**دون تتبع تاريخي** لمسارك أو تحركاتك.',
    },
    {
      icon: Users,
    ...
    },
    {
      ...
      content:
        ...
        '- **لا نُخزّن** بيانات موقعك التاريخية في قاعدة بيانات لدينا، و**لا نُنشئ ملفاً تتبعياً** لتحركاتك السابقة.\n' +
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              معالجة **لحظية** لبيانات الموقع عند الإذن فقط — لعرض الخدمات المتاحة المناسبة، **دون تخزين أو تتبع تاريخي**، وفق نظام حماية البيانات الشخصية (PDPL).
            </p>
