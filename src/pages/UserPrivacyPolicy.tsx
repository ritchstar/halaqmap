 ...
 * ودون بيعها أو استخدامها للتسويق المستقل.
  ...
  const sections = [
    {
      ...
      content:
        ...
        'فيما يخص **بيانات الموقع**، نعالجها **لحظياً (Instantaneous / Real-Time)** عند موافقتك فقط، ولأغراض محددة موضّحة أدناه — **دون الاحتفاظ بها كسجل تاريخي في قاعدة بيانات المنصة** و**دون إنشاء تتبع تاريخي** لمسارك أو تحركاتك.',
    },
    {
      icon: Users,
    ...
    },
    {
      ...
      content:
        ...
        '- لا نطلب منك رفع مستندات أو بيانات مالية ضمن تجربة التصفح العامة عبر نظام الاستجابة الذكية',
    },
    {
      icon: Eye,
      title: 'صفحات الحي في متجر منصة طريقة الحل',
      content:
        'في تمويناتا1 ومطعمنا1 وكافينا1 وطبختنا1 يظهر في لوحة التشغيل رقم لحظي بعنوان: عدد المتواجدون الان.\n\n' +
        'النبض مجهول: بلا اسم ولا هاتف ولا دفتر زيارات ولا دفتر زبائن. يزول عند إغلاق صفحة الطلب. في كافينا1 يقتصر النبض على صفحة الحي، لا شاشات العرض ولا رابط الضيف. لا يُستخدم هذا النبض في افراحي1 ولا اجواء1 ولا لاونجا1، وليس تتبعاً للحضور ولا قائمة ضيوف.',
    },
    {
      icon: MapPin,
      title: 'بيانات الموقع اللحظية — المعالجة والاستخدام',
      content:
        'عندما تمنح إذن الموقع من المتصفح أو الجهاز، تُستخدم بيانات موقعك **لحظياً** **فقط** من أجل:\n\n' +
        '- عرض الخدمات والحلاقين المناسبين لك عبر نظام الاستجابة الذكية ضمن جلسة التصفح الحالية.\n' +
        '- تطبيق الفلترة والعرض اللحظي أثناء استخدامك النشط — بعد منح إذن الموقع فقط.\n' +
        '- تمرير البيانات التشغيلية اللازمة تقنياً إلى مزوّدي البنية أو الخدمات المساندة بالقدر اللازم لإتمام الطلب فقط.\n\n' +
        '**لا نقوم ببيع موقعك أو مشاركته مع أطراف خارجية لأغراض إعلانية أو تسويقية**، ولا نحتفظ به كسجل تاريخي مستقل للمستخدم.',
    },
    {
      icon: Lock,
      title: 'المعالجة اللحظية — دون حفظ تاريخي أو تتبع',
      content:
        ...
        '- **لا نُخزّن** بيانات موقعك التاريخية في قاعدة بيانات المنصة، و**لا نُنشئ ملفاً تتبعياً** لتحركاتك السابقة.\n' +
        '- قد تمر بيانات التشغيل الضرورية عبر مزوّدي بنية تحتية أو خدمات تقنية مساندة **كمعالجين** وبحدّ ما يلزم لتقديم الخدمة فقط، وقد تظهر ضمن سجلات تقنية قصيرة الأمد وفق سياسات المزود، دون استخدامها من جانبنا لاستهدافك إعلانياً.',
    },
    {
      icon: Users,
      title: 'المساعد القانوني الذكي',
      content:
        'إذا استخدمت واجهة **الناظر القانوني** أو أي مساعد قانوني/إرشادي مشابه داخل المنصة، فقد تُسجَّل المحادثة لأغراض التشغيل والتقارير والتحسين، مع عدم اعتبار الردود استشارة قانونية شخصية أو مرجعاً نظامياً ملزماً.\n\n' +
        'ننصح بالرجوع إلى الوثائق الرسمية أو المختصين المرخّصين في المسائل القانونية الفردية أو التنظيمية الحساسة.',
    },
    {
      icon: Eye,
      title: 'الشفافية',
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              معالجة **لحظية** لبيانات الموقع عند الإذن فقط — لعرض الخدمات المتاحة المناسبة، **دون حفظ تاريخي في قاعدة بيانات المنصة أو تتبع تاريخي**، وفق نظام حماية البيانات الشخصية (PDPL).
            </p>
