...
const subscriptionPlans: {
  ...
  },
  {
    ...
    features: [
      ...
      { kind: 'row', text: 'أولوية في الظهور عبر نظام الرصد الذكي والبحث', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { kind: 'row', text: 'شارة ماسية مميزة عبر نظام الرصد الذكي', included: true },
      { kind: 'row', text: 'إدارة صور المحل والبنر من لوحة التحكم بعد التفعيل', included: true },
      { kind: 'row', text: 'جدول أسبوعي لأوقات العمل من لوحة التحكم (تحكم كامل بكل يوم)', included: true },
      { kind: 'row', text: 'أولوية قصوى في الظهور عبر نظام الرصد الذكي والبحث', included: true },
