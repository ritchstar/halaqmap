        ...
        <Card className="border-primary/20 shadow-lg">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-center leading-relaxed">
              طلبك مسجّل على المنصة. بعد إتمام الدفع وتفعيل حزمة الرخصة الرقمية يمكنك البدء فوراً. في هذا المسار{' '}
          ...
          <CardContent className="space-y-6">
            ...
            <div className="rounded-lg border border-primary/20 bg-primary/5 p-4 text-sm leading-relaxed text-right">
              <p className="font-semibold text-foreground mb-1">إتمام الدفع وتفعيل حزمة الرخصة الرقمية</p>
