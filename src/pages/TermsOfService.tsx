  ...
  const sections = [
    ...
    },
    {
      ...
      content:
        ...
        '- لا يمنحك استخدام المنصّة أي حقوق ملكية؛ يقتصر استخدامك على **ترخيص محدود وغير حصري** للوصول إلى الخدمات وفق هذه الشروط.\n' +
        '- أي انتهاك للملكية الفكرية قد يعرّضك للمساءلة المدنية أو الجزائية وفق الأنظمة.',
    },
    {
      icon: CreditCard,
      title: 'اشتراك الحلاقين الشهري والباقات',
      content:
        'خدمات **الشركاء من الحلاقين والصالونات** تُقدَّم ضمن **اشتراك شهري** أو دورة فوترة يحددها عرض الاشتراك المعروض وقت التسجيل أو الدفع، وفق الباقة المختارة (مثل برونزية، ذهبية، ماسية).\n\n' +
        '- يُعدّ إتمام الدفع أو قبول عرض الاشتراك إقرارًا بالالتزام بالرسوم الدورية المعروضة ومزايا كل باقة.\n' +
        '- قد تتضمن الباقات حقوق ظهور على الخريطة، وأدوات إدارة الملف، وتقييمات، وميزات إضافية وفق ما تعلنه المنصّة في وقتها.\n' +
        '- **التجديد:** ما لم يُعلَن خلاف ذلك صراحةً، يُفترض أن تكون دورة الاشتراك شهرية؛ يُحدَّد موعد التجديد وسعر الباقة وفق سياسة الاشتراك وسعر الدفع المعروض في مسار الشركاء.\n' +
        '- **التعليق أو الإيقاف:** يحق للمنصّة وفق سياساتها المعتمدة تعليق أو تقييد الخدمة عند مخالفة الشروط أو عدم السداد أو لأسباب أمنية أو امتثالية، دون إخلال بحقوق المستخدمين أو الشركاء بحسب الحالة.\n' +
        '- للتفاصيل الإضافية حول الاشتراك والاسترداد والخصوصية الخاصة بالشركاء، راجع **سياسة الاشتراك** و**خصوصية الشركاء** في مسار الشركاء.',
    },
    {
      icon: ShieldAlert,
      ...
      content:
        ...
        '- المنصّة تُقدَّم «كما هي» ضمن حدود الجهد المعقول؛ لا نضمن خلوّ الخدمة من الانقطاعات النادرة أو أخطاء الطرف الثالث (مثل مزوّدي الخرائط أو الدفع).',
    },
    {
      icon: FileText,
      title: 'تعديل الشروط',
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              الحقوق، والملكية الفكرية، واشتراك الشركاء الشهري في منصة حلاق ماب.
            </p>
          </div>
        </motion.div>
      </div>
