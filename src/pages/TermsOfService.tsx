...
export default function TermsOfService() {
  const sections = [
    ...
    {
      icon: CreditCard,
      title: 'اتفاقية حزمة الرخصة للشركاء',
      content:
        ...
        '- **انتهاء الصلاحية:** تنتهي صلاحية الإدراج في تاريخ انتهاء حزمة الرخصة المدفوع؛ يمكن شراء حزمة رخصة جديدة أو استرداد كود لمدة إضافية.\n' +
        '- **التعليق أو الإيقاف:** يحق للمنصّة تعليق أو تقييد الخدمة عند مخالفة الشروط أو انتهاء حزمة الرخصة أو لأسباب أمنية أو امتثالية.\n' +
        '- للتفاصيل، راجع **سياسة حزم الرخصة الرقمية** و**خصوصية الشركاء** في مسار الخدمات البرمجية للمنصة. لا تُعد المنصّة وساطة مالية أو تجارية أو تقديم حجز بالعمولة.',
    },
    {
      icon: ShieldAlert,
      ...
      <div className="container mx-auto px-4 py-16" dir="rtl">
        ...
        >
          ...
          <NavLink
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border border-border bg-card text-sm font-medium hover:bg-muted transition-colors"
          >
            سياسة حزم الرخصة الرقمية (الشركاء)
          </NavLink>
        </motion.div>
