...
export default function TermsOfService() {
  const sections = [
    ...
    },
    {
      ...
      content:
        'تعمل **منصة حلاق ماب** و/أو الجهة المعتمدة لتشغيلها تحتفظ بكافة الحقوق في **البرمجيات والشفرة المصدرية والتصميمات والعلامات التجارية والمحتوى التقني والواجهات** الخاصة بالمنصة، بما في ذلك ما يُعرَض من بنية، خوارزميات بحث، قواعد بيانات منظمة، وواجهات المستخدم، ضمن ما يحميه نظام الملكية الفكرية والأنظمة ذات الصلة في المملكة العربية السعودية.\n\n' +
    ...
    },
    {
      ...
      content:
        'خدمات **الشركاء من الحلاقين والصالونات** تُقدَّم عبر **شراء حزم رخصة نفاذ رقمية مسبقة الدفع** ضمن نظام الاستجابة الذكية على منصة حلاق ماب، وفق الباقة المختارة (برونزية، ذهبية، ماسية).\n\n' +
        '- **منطق الرخصة:** حضور رقمي غير ثابت يُفعَّل ظهور المزود برمجياً حصراً عند وجود طلب فعلي تنطبق عليه البيانات المتاحة والفلترة (الظهور عند الطلب · On-Demand Visibility). لا التزام بظهور دائم، بل كفاءة استهداف ودقة ربط.\n' +
    ...
    },
    {
      ...
      content:
        'تُعرَض **سياسة الاسترجاع والاسترداد** الكاملة ضمن **سياسة رخصة النفاذ الرقمية** على المنصة. حزم الرخصة منتجات رقمية مسبقة الدفع؛ بعد تفعيل كود الحزمة لا يترتب استرداد مالي إلا في حالات الخلل التقني الموثّق أو بقرار إداري.\n\n' +
        'للاطلاع: راجع قسم «سياسة الاسترجاع والاسترداد» في صفحة سياسة رخصة النفاذ الرقمية في مسار الشركاء.',
    },
    {
      icon: FileText,
      title: 'تعديل الشروط',
      ...
      <div className="relative overflow-hidden bg-gradient-to-b from-accent/8 via-background to-background py-28">
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-accent/30 bg-accent/10 px-4 py-1.5 text-xs font-bold text-accent">
              ✦ الحقوق والالتزامات
            </div>
            <motion.div
              ...
              className="inline-flex items-center justify-center w-20 h-20 rounded-2xl border border-accent/25 bg-accent/10 mb-6 shadow-[0_0_30px_rgba(212,175,55,0.12)]"
            >
            ...
            <div className="mt-8 mx-auto h-px max-w-sm bg-gradient-to-r from-transparent via-accent/50 to-transparent" />
          </div>
        </motion.div>
      </div>
