...
export default function TermsOfService() {
  const sections = [
    ...
    {
      icon: CreditCard,
      title: 'اتفاقية الحزمة البرمجية للشركاء',
      content:
        'خدمات **الشركاء من الحلاقين والصالونات** تُقدَّم عبر **شراء حزم برمجية رقمية مسبقة الدفع** لخدمات الإدراج البرمجية الموحدة على منصة حلاق ماب، وفق الباقة المختارة (برونزية، ذهبية، ماسية).\n\n' +
        '- يُعدّ إتمام الدفع أو استرداد كود التفعيل إقرارًا بشراء منتج رقمي (حزمة إدراج برمجية) بمدة محددة — **دون تجديد تلقائي أو خصم دوري**.\n' +
        '- تتضمن الباقات صلاحية الظهور عبر نظام الرصد الذكي وأدوات إدارة الملف والتقييمات وميزات إضافية وفق ما تعلنه المنصّة.\n' +
        '- **انتهاء الصلاحية:** تنتهي صلاحية الإدراج في تاريخ انتهاء الحزمة البرمجية المدفوع؛ يمكن شراء حزمة برمجية جديدة أو استرداد كود لمدة إضافية.\n' +
        '- **التعليق أو الإيقاف:** يحق للمنصّة تعليق أو تقييد الخدمة عند مخالفة الشروط أو انتهاء الحزمة البرمجية أو لأسباب أمنية أو امتثالية.\n' +
        '- للتفاصيل، راجع **سياسة الحزم البرمجية الرقمية** و**خصوصية الشركاء** في مسار الخدمات البرمجية للمنصة. لا تُعد المنصّة وساطة مالية أو تجارية أو تقديم حجز بالعمولة.',
    },
    {
      icon: ShieldAlert,
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              الحقوق، والملكية الفكرية، واتفاقية الحزمة البرمجية للشركاء في منصة حلاق ماب.
            </p>
          </div>
        </motion.div>
      </div>
      ...
      <div className="container mx-auto px-4 py-16" dir="rtl">
        ...
        >
          ...
          <NavLink
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border border-border bg-card text-sm font-medium hover:bg-muted transition-colors"
          >
            سياسة الحزم البرمجية الرقمية (الشركاء)
          </NavLink>
        </motion.div>
