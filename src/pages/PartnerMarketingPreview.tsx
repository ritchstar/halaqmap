        ...
        >
          ...
          <span
            ...
            style={{
              ...
              background: hasNewMapCommunityPosts ? 'rgba(217,70,239,0.16)' : 'rgba(34,211,238,0.12)',
            }}
          >
            <MessageCircle className={hasNewMapCommunityPosts ? 'h-6 w-6 text-fuchsia-200' : 'h-6 w-6 text-cyan-200'} />
            <motion.span
