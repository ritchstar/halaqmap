  ...
  const sections = [
    ...
    },
    {
      ...
      content:
        ...
        "- **المعالجون التقنيون (أمثلة):** مزود البنية السحابية لقاعدة البيانات والتخزين (Supabase)، واستضافة الواجهة والدوال (Vercel)، و**بوابة الدفع المعتمدة** لمعالجة المدفوعات الإلكترونية، وقد تُستخدم قنوات أو مزودات خارجية للتواصل التشغيلي مثل البريد الإلكتروني أو واتساب أو ما يماثله عند اختيارك التواصل عبرها — دون بيع بياناتك لجهات تسويقية.\n" +
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="partner-legal-section rounded-2xl border border-white/12 bg-[#0b1628]/95 p-6 text-right text-slate-100">
            <h2 className="mb-3 text-lg font-bold text-slate-50">الدعم الفني والشكاوى</h2>
