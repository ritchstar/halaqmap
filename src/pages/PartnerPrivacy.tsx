  ...
  const sections = [
    {
      ...
      content:
        "هذه السياسة مخصصة للشركاء (الحلاقين/الصالونات) المتقدمين عبر مسار الخدمات البرمجية للمنصة. توضح كيف نجمع بيانات طلب شراء حزمة الرخصة، وكيف نستخدمها ونحميها ضمن إجراءات الاعتماد والتشغيل على المنصة.",
    },
    {
      icon: Server,
