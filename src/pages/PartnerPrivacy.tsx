...
export default function PartnerPrivacy() {
  ...
  const sections = [
    ...
    },
    {
      ...
      content:
        "- نقل البيانات عبر اتصالات مشفرة (TLS).\n- تقييد الوصول للبيانات حسب الصلاحيات التشغيلية.\n- **طلب الاشتراك:** قد تُحفظ حقول النموذج (بما فيها **نص التحقق النظامي** الذي تُدخله) في سجل الطلب لدى الإدارة للمدة اللازمة للمراجعة والتشغيل والامتثال؛ **لا نخزّن ملفات السجل التجاري أو رخص البلدية أو الشهادات الصحية كمرفقات على خوادمنا.**\n- **معاينة الإدارة:** عند مراجعة رابط رسمي يُستخرج من الرمز تُجرى **معاينة لحظية في متصفح المسؤول**؛ لا نُخزّن محتوى الوثيقة أو الرابط في سجل الأمان إلا كوقت المعاينة ورقم الطلب (للتوثيق النظامي).\n- الاحتفاظ بالبيانات للفترة اللازمة للتشغيل أو الالتزام النظامي، مع إمكانية الحذف أو التصحيح وفق المسارات المعتمدة.\n- يحق للشريك طلب تحديث أو تصحيح بياناته عبر قنوات الدعم.",
    },
    {
      icon: Bell,
      title: "التحديثات",
