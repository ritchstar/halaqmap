...
export default function About() {
  ...
  const howItWorks = [
    ...
    },
    {
      ...
      description: "شاهد قائمة الحلاقين المحترفين المتاحين لك مع التقييمات وبيانات الخدمة",
    },
    {
      step: "3",
      title: "اختر وتواصل",
  ...
  const userPrinciples = [
    {
      title: "سهولة البدء",
      body: "لا تحتاج إلى إنشاء حساب. تبدأ مباشرة بأن تسمح بموقعك واستكشاف الخيارات المناسبة المتاحة لك.",
    },
    {
      title: "اختيار أوضح",
