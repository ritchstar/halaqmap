...
export default function About() {
  ...
  const userPrinciples = [
    {
      title: "سهولة البدء",
      body: "لا تحتاج إلى إنشاء حساب. تبدأ مباشرة بأن تسمح بموقعك واستكشاف الخيارات الأقرب.",
    },
    {
      title: "اختيار أوضح",
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                ننمو خطوة بخطوة: نبني جسراً بين الحرفة التقليدية والتكنولوجيا، ونعطي الأولوية لتكثيف الشركاء الحلّاقين عبر نظام الرصد الذكي ثم توسيع الوصول للمستخدمين بما يلائم كل منطقة — صدق التجربة قبل حجم الإعلان.
              </p>
            </div>
