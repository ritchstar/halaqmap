    ...
    <div className="relative overflow-hidden rounded-3xl border border-teal-400/20 bg-[#fbf6ec] p-5 shadow-2xl shadow-teal-500/10">
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <h3 className="mt-3 text-xl font-black leading-snug text-[#2e2418]">رادار المملكة — نبض حي</h3>
          <p className="mt-2 text-sm leading-relaxed text-[#3d3226]">
      ...
      <div
        className="relative mt-4 w-full overflow-hidden rounded-2xl border border-[#dac8aa] bg-[#2e2418] shadow-inner"
