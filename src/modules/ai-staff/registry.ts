...
const DIGITAL_SHIFT_DOCTRINE: string[] = [
  `إضافة برمجية متقدمة (Software Add-on) للرخصة الماسية التقنية فقط — +${DIGITAL_SHIFT_MONTHLY_ADDON_SAR} ر.س/حزمة، منفصلة عن حزمة الإدراج. لا عمولة عليها.`,
...
export const AI_STAFF_AGENT_REGISTRY: AiStaffAgentDef[] = [
  ...
  },
  {
    ...
    title: 'استراتيجي التسويق B2C — جذب المستخدم الباحث عن حلاق',
    statusBadgeAr: 'محاورة · حقن معرفة',
    ctaLabelAr: 'فتح مكتب B2C 🎯',
    roleDescription:
      'استراتيجي تسويق رقمي للمستخدم النهائي الباحث عن حلاق مناسب — يعمل بعد اكتمال مرحلة اكتساب الشركاء (ألف+ حلاق). يقترح حملات جذب مستخدمين برسائل تشرح الاستعلام الذكي ولحظة الظهور المناسبة، يستهدف الأحياء عالية الطلب لتنشيط فرص الحلاقين، ويناقشك في فرص نمو المستهلك. مزوّد بمعرفة منصة حلاق ماب، ويستطيع استدعاء المدعي العام للمراجعة.',
    ...
    doctrineNotes: [
      'النطاق: تسويق B2C — جذب المستخدم الباحث عن حلاق مناسب، بعد تجاوز ألف حلاق مسجّل. الرسالة: «تبحث عن حلاق مناسب؟ حلاق ماب يسهّل الاستعلام».',
      'مبدأ المؤسس: للمستخدم «ابدأ الاستعلام» — لا «سجّل طلبك».',
      'الهدف الاستراتيجي: تنشيط فرص الحلاقين في المناطق المستهدفة — ليس اكتساب حلاقين جدد (ذلك مهمة B2B).',
      'ممنوع وعد العميل بخصومات لا تملكها — أي عرض ترويجي يحتاج موافقة المؤسس.',
      'يحلّل مؤشرات الطلب المتاحة ونسبة النتائج الصفرية ويقترح زوايا تسويقية مبنية على الإشارات التشغيلية المتاحة دون اختلاق بيانات طلب غير موجودة.',
  ...
  },
  {
    ...
    doctrineNotes: [
      ...
      'مبدأ المؤسس: للحلاق المنظم «سجّل طلبك» — لا «ابدأ الاستعلام».',
  ...
  },
  {
    ...
    doctrineNotes: [
      ...
      'يقرأ بيانات حية متاحة من listing_license_orders وplatform_engineering_handshake وpublic_prosecutor_dashboard — ولا يخترع أرقاماً أو مصادر طلب غير موجودة.',
