...
const STORE_GENERAL_TRIAL_PATH =
  (ROUTE_PATHS as { STORE_GENERAL_TRIAL?: string }).STORE_GENERAL_TRIAL || "/store/try";
const STORE_GENERAL_TRIAL_TERMS_PATH =
...
const STORE_LOUNGE_SUPPORT_PATH =
  (ROUTE_PATHS as { STORE_LOUNGE_SUPPORT?: string }).STORE_LOUNGE_SUPPORT || "/store/lounge/support";
const STORE_HALLS_SUPPORT_PATH =
  (ROUTE_PATHS as { STORE_HALLS_SUPPORT?: string }).STORE_HALLS_SUPPORT || "/store/halls/support";
...
const STORE_GROCERS_SUPPORT_PATH =
  (ROUTE_PATHS as { STORE_GROCERS_SUPPORT?: string }).STORE_GROCERS_SUPPORT || "/store/grocers/support";
...
const STORE_RESTAURANT_SUPPORT_PATH =
  (ROUTE_PATHS as { STORE_RESTAURANT_SUPPORT?: string }).STORE_RESTAURANT_SUPPORT || "/store/restaurant/support";
...
const STORE_CAFE_SUPPORT_PATH =
  (ROUTE_PATHS as { STORE_CAFE_SUPPORT?: string }).STORE_CAFE_SUPPORT || "/store/cafe/support";
...
const STORE_KITCHEN_GIFT_TERMS_PATH =
  (ROUTE_PATHS as { STORE_KITCHEN_GIFT_TERMS?: string }).STORE_KITCHEN_GIFT_TERMS || "/store/kitchen/gift/terms";
const STORE_KITCHEN_GIFT_CONFIRM_PATH =
  (ROUTE_PATHS as { STORE_KITCHEN_GIFT_CONFIRM?: string }).STORE_KITCHEN_GIFT_CONFIRM || "/store/kitchen/gift/confirm";
const STORE_KITCHEN_VIEW_PATH =
...
const STORE_HALANA_READ_PATH =
  (ROUTE_PATHS as { STORE_HALANA_READ?: string }).STORE_HALANA_READ || "/store/halana/read";
const STORE_HALANA_VIEW_PATH =
  (ROUTE_PATHS as { STORE_HALANA_VIEW?: string }).STORE_HALANA_VIEW || "/h/:token";
const STORE_HALANA_ORDER_PATH =
...
const STORE_HALANA_PAY_PATH =
  (ROUTE_PATHS as { STORE_HALANA_PAY?: string }).STORE_HALANA_PAY || "/pay/halana/:token";
...
const Payment = lazyPage(() => import("@/pages/Payment"), "Payment");
const PartnerPackagesPage = lazyPage(() => import("@/pages/PartnerPackagesPage"), "PartnerPackagesPage");
const PaymentSuccess = lazyPage(() => import("@/pages/PaymentSuccess"), "PaymentSuccess");
    ...
    <TooltipProvider>
      ...
      <HashRouter>
        ...
        <Routes>
          ...
          <Route
            path={ROUTE_PATHS.STORE_LANDING_PITCH_PREVIEW}
            element={<LazyRoute><StoreLandingPitchPreviewPage /></LazyRoute>}
          />
          ...
          <Route path={STORE_LOUNGE_SUPPORT_PATH} element={<LazyRoute><StoreProductSupportPage /></LazyRoute>} />
          ...
          <Route path={STORE_RESTAURANT_SUPPORT_PATH} element={<LazyRoute><StoreProductSupportPage /></LazyRoute>} />
          ...
          <Route path={STORE_CAFE_SUPPORT_PATH} element={<LazyRoute><StoreProductSupportPage /></LazyRoute>} />
          ...
          <Route path={STORE_KITCHEN_PAY_PATH} element={<LazyRoute><StoreKitchenPayPage /></LazyRoute>} />
