...
/** ู?ุชุถู?ู? PartnerLayout ู?ุณุงุนุฏ ุงู?ุดุฑู?ุงุก ุงู?ุฑู?ู?ู? ุนุจุฑ PartnerDigitalBarberAssistant โ?? ุงู?ู?ุณุงุฑ ุงู?ู?ุญู?ุฏ ู?ู?ู?ุณุงุนุฏ ูู? ู?ุณุงุฑ ุงู?ุฎุฏู?ุงุช ุงู?ุจุฑู?ุฌู?ุฉ ู?ู?ู?ู?ุตุฉ. */
  ...
  <Layout>
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="text-center space-y-6 px-4">
        ...
        <h2 className="text-2xl font-semibold text-foreground">ุงู?ุตูุญุฉ ุบู?ุฑ ู?ู?ุฌู?ุฏุฉ</h2>
        <p className="text-muted-foreground">ุนุฐุฑุงู?ุ? ุงู?ุตูุญุฉ ุงู?ุชู? ุชุจุญุซ ุนู?ู?ุง ุบู?ุฑ ู?ุชู?ูุฑุฉ</p>
        <a
          href="#/"
 ...
 * was aligned across build and runtime: any `/admin/in?email=โ?ฆ` or
...
// โ??โ?? Dedicated Map Community domain โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??
  ...
  <QueryClientProvider client={queryClient}>
    ...
    <TooltipProvider>
      ...
      <HashRouter>
        ...
        <ScrollToTop />
        <Routes>
          {/* โ??โ?? ุงู?ุตูุญุชุงู? ุงู?ุฑุฆู?ุณู?ุชุงู? ุงู?ุฌุฏู?ุฏุชุงู? โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ?? */}
          ...
          {/* โ??โ?? ุฃุฑุดู?ู ุงู?ุตูุญุงุช ุงู?ู?ุฏู?ู?ุฉ โ?? ุฐู?ุฑู? ุงู?ุจุฏุงู?ุงุช โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ?? */}
          ...
          {/* โ??โ?? ุตูุญุงุช ุงู?ู?ุนุงู?ู?ุฉ โ?? ุชุจู?ู? ู?ุฑุฌุนุงู? โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ??โ?? */}
          ...
          {/* ู?ุณุงุฑ ุงู?ุดุฑู?ุงุก โ?? ุงู?ุตูุญุฉ ุงู?ุฌุฏู?ุฏุฉ */}
