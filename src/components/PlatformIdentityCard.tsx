...
const IS_POINTS = [
  ...
  'مزوّد خدمة رقمية للربط والعرض اللحظي',
...
const PROOF_POINTS = [
  ...
  { icon: '🤝', text: 'شريك تقني للصالون — لا عمولة على القص، والعلاقة مع الزبون مباشرة' },
    ...
    >
      ...
      <div className="px-5 pb-3 pt-5">
        ...
        <p className="mt-2 text-sm leading-relaxed text-slate-400 md:text-[0.9rem]">
          تعمل المنصة بنظام الاستجابة الذكية، ويقتصر دورها على المعالجة والفلترة اللحظية بين استعلام المستخدمين
          وبيانات الحلاقين المتاحة داخلها، ثم عرض النتيجة المناسبة وفق البيانات المتاحة، دون وساطة أو عمولة.
        </p>
      </div>
