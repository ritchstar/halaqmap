...
أساعدك تفهم كيف تبدأ الاستعلام، كيف يعمل نظام الاستجابة الذكية، ولماذا الخدمة مجانية للمستخدم.
...
function getAudienceCopy(audience: Audience): AudienceCopy {
  if (audience === 'consumer') {
    return {
      pitchLines: [
        '🌟 نظام استجابة ذكي يعرض الصالونات المناسبة عند بدء الاستعلام',
        'بيانات حقيقية وتقييمات موثوقة — بدون وسيط',
        'تواصل مباشر مع الصالون — هاتف أو واتساب',
        'حلاق ماب مجاني للمستخدم — ابدأ الاستعلام واختر الأنسب',
        'نظام الاستجابة الذكية · On-Demand Visibility',
      ],
      quick: [
        'كيف أبحث عن حلاق؟',
        'هل الخدمة مجانية؟',
        'كيف يعمل نظام الاستجابة الذكية؟',
        'هل تحفظون موقعي؟',
      ...
      stats: [
        { icon: MapPin, label: 'استجابة', val: 'ذكية' },
      ...
      teaserLinkLabel: 'أو ابدأ الاستعلام الآن',
      ctaTitle: 'صاحب صالون؟ 💼',
  ...
  return {
    pitchLines: [
      ...
      'قصة المنصة: من الفكرة الأولى إلى نظام الاستجابة الذكية',
    ],
    quick: [
