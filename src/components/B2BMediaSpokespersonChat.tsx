...
export function B2BMediaSpokespersonChat({
  ...
  const wrapClass = mode === 'inline'
    ...
    : 'hidden sm:block fixed top-24 right-0 z-[49]';
  ...
  if (mode === 'panel' && minimized && !open) {
    return (
      <motion.button
        ...
        className="hidden sm:flex fixed top-24 right-4 z-[49] h-10 w-10 items-center justify-center rounded-full border-2 border-cyan-400/60 bg-[#020912] shadow-[0_0_20px_rgba(34,211,238,0.35)]"
