...
const QUICK_TOPICS = [
  ...
  { label: 'الظهور الجغرافي', prompt: 'كيف يعمل الظهور الجغرافي فعلياً للصالون؟' },
...
const PITCH_LINES = [
  ...
  'مكتب المبيعات يشرح العائد، الاعتراض، والإغلاق بلغة أقرب لواقع الصالون.',
  'إضافة المكتب الخاص ترفع جودة التشغيل وتحوّل الصفحة إلى قناة متابعة أدق.',
  'الهدف هنا ليس الشرح العام، بل تسريع قرار الاشتراك وتوضيح قيمة الباقة.',
] as const;

function getGreeting(): string {
  const hour = new Date().getHours();
  const greeting = hour < 12 ? 'صباح المبيعات' : hour < 17 ? 'مساء الإنجاز' : 'مساء الإقفال الذكي';
  return `${greeting}.\n\nأنا مدير المبيعات التجاري لمنصة حلاق ماب.\nمهمتي هنا أن أشرح لك الباقات، مضاعفة الرخص، الظهور الجغرافي، وإضافة المكتب الخاص بلغة بيع واضحة ومباشرة.\n\nاذكر لي ما الذي تريد حسمه أولاً: السعر، الباقة، العائد، أم طريقة الإقفال؟`;
}
