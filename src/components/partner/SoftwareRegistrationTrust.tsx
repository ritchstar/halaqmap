...
export function SoftwareRegistrationTrust({ className, id = 'تسجيل-المصنف' }: Props) {
  ...
  return (
    <section
      id={id}
      className={cn(
        'relative z-10 border-y border-[#dac8aa] bg-[#fbf6ec] py-12 md:py-16',
        className,
      )}
      dir="rtl"
    ...
    >
      <div className="mx-auto max-w-4xl px-5">
        <div className="rounded-2xl border border-teal-400/25 bg-gradient-to-br from-teal-50 via-[#fbf6ec] to-[#eee2ce] p-6 shadow-[0_20px_48px_rgba(46,36,24,0.12)] md:p-8">
            ...
            <div className="min-w-0 flex-1">
              ...
              <dl className="mt-5 grid gap-3 sm:grid-cols-2">
                <div className="rounded-xl border border-[#dac8aa] bg-[#f3ead1] px-4 py-3">
                  <dt className="text-[0.68rem] font-bold text-[#6f6250]">نوع المصنف</dt>
                  <dd className="mt-1 text-sm leading-relaxed text-[#3d3226]">{workTypeAr}</dd>
                </div>
                <div className="rounded-xl border border-[#dac8aa] bg-[#f3ead1] px-4 py-3">
                ...
                <div className="rounded-xl border border-[#dac8aa] bg-[#f3ead1] px-4 py-3 sm:col-span-2">
                  <dt className="text-[0.68rem] font-bold text-[#6f6250]">تاريخ التسجيل</dt>
                  <dd className="mt-1 text-sm font-semibold text-[#3d3226]">
                    <bdi dir="ltr">{registrationDateAr}</bdi>
                  </dd>
                </div>
              </dl>

              <p className="mt-5 text-sm leading-7 text-[#6f6250]">{PLATFORM_SOFTWARE_REGISTRATION_DISCLAIMER_AR}</p>
