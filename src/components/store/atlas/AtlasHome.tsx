 ...
 *
 * نموذج الرئيسية لأطلس الحلول V2. بلا طقس وبلا أسعار داخل البطاقات.
 */
...
import { AtlasPath } from '@/components/store/atlas/AtlasPath';
...
import { ServiceLane } from '@/components/store/atlas/ServiceLane';
