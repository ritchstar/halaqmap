...
export function StoreVisitorEngage() {
  ...
  const [panel, setPanel] = useState<'share' | 'menu' | null>(null);
      ...
      <div className="fixed bottom-4 left-4 z-40 pb-[env(safe-area-inset-bottom,0px)] sm:bottom-6 sm:left-6">
        {panel === 'share' ? (
          <div
            ...
            role="dialog"
            aria-labelledby="store-share-title-compact"
          >
            <div className="mb-2 flex items-center justify-between gap-2">
              <h3 id="store-share-title-compact" className="text-sm font-extrabold text-[#f4efe4]">
          ...
          <div className="mb-2 flex w-[min(14rem,calc(100vw-2rem))] flex-col gap-2 rounded-2xl border border-[#e8c547]/35 bg-[#061018]/95 p-3 shadow-2xl backdrop-blur-md">
            {onReviewsPage ? null : (
              <Link
                ...
                onClick={close}
                className="inline-flex items-center gap-2 rounded-full border border-[#e8c547]/40 px-3 py-2 text-sm font-extrabold text-[#e8c547]"
              >
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-full border border-white/20 px-3 py-2 text-sm font-extrabold text-[#f4efe4]"
            >
        ...
        <button
          ...
          aria-label="تفاعل مع خريطة الحل"
