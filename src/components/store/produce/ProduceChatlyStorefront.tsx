...
const PRODUCE_GRID_IMAGE_SIZES = '(max-width: 640px) 92vw, (max-width: 1024px) 46vw, 23vw';
  ...
  return (
    <main dir="rtl" className="produce-chatly-root min-h-dvh bg-[#f4f1e8] pb-32 text-[#22332b]">
      <div className="mx-auto w-full max-w-[1240px] px-4 sm:px-8 lg:px-10">
        ...
        <div className="mt-6">
          <StoreProduceBuyerChat state={state} onChange={onChange} theme="light" />
        </div>
      ...
      <Dialog open={cartOpen} onOpenChange={setCartOpen}>
        <DialogContent className="produce-chatly-root max-h-[90vh] max-w-lg overflow-y-auto border-[#d4dfcc] bg-[#fffdf5] p-0 text-right" dir="rtl">
      ...
      <Dialog open={serviceOpen} onOpenChange={setServiceOpen}>
        <DialogContent className="produce-chatly-root max-w-xl border-[#d4dfcc] bg-[#fffdf5] text-right" dir="rtl">
          <DialogHeader>
      ...
      <Dialog open={checkoutOpen} onOpenChange={setCheckoutOpen}>
        <DialogContent className="produce-chatly-root max-h-[90vh] max-w-lg overflow-y-auto border-[#d4dfcc] bg-[#fffdf5] text-right" dir="rtl">
          <DialogHeader>
...
function ProductVisual({ item, imageIndex, small = false }: { item: ShelfRow; imageIndex: number; small?: boolean }) {
  ...
  const visualSizes = small ? '64px' : PRODUCE_GRID_IMAGE_SIZES;
