...
export function StoreVendorPathPicker({
  ...
  return (
    <fieldset className="mt-4">
      <legend className="text-sm font-extrabold">{STORE_MOBILE_VENDOR.pathTitleAr}</legend>
      <div className="mt-2 grid gap-3 sm:grid-cols-2">
        ...
        >
          <p className="font-extrabold">{STORE_MOBILE_VENDOR.fixedTitleAr}</p>
        ...
        >
          <p className="font-extrabold">{STORE_MOBILE_VENDOR.mobileTitleAr}</p>
