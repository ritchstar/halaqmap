...
const SUBSCRIPTION_PLANS: {
...
}[] = [
  {
    ...
    features: [
      { kind: 'map_hero' },
      { kind: 'line', text: 'ظهور موثوق في حيّك عندما يبحث العميل عن صالون قريب منه' },
      { kind: 'line', text: 'بطاقة تعريف احترافية تعرض الاسم، الموقع، الاتصال، والواتساب بوضوح' },
      { kind: 'line', text: 'صورتان أساسيتان + أربع صور للبنر لإظهار واجهة الصالون وخدماته بسرعة' },
      { kind: 'line', text: 'مناسبة كبداية ذكية لاختبار الطلب المحلي وجذب أول العملاء من الخريطة' },
  ...
  },
  {
    ...
    features: [
      { kind: 'map_hero' },
      { kind: 'line', text: 'إبراز ذهبي في نتائج القرب يمنح صالونك حضوراً أوضح أمام المنافسين' },
      { kind: 'line', text: 'معرض أعمال موسّع حتى 20 صورة لإقناع العميل قبل أن يتواصل' },
      { kind: 'line', text: RATING_QR_PLAN_LINE },
      { kind: 'line', text: 'واتساب وشات مباشر لتقليل تردد العميل وتحويل المشاهدة إلى تواصل سريع' },
      { kind: 'line', text: 'لوحة تحكم لتحديث الصور، المنيو، الأسعار، وأوقات العمل بعد التفعيل' },
      { kind: 'line', text: 'إبراز خدمات الرعاية الميسّرة والزيارات الخاصة عند توفرها في صالونك' },
  ...
  },
  {
    ...
    features: [
      { kind: 'map_hero' },
      { kind: 'line', text: 'أعلى تمييز ماسي في الظهور لمن يريد أن يكون الخيار الأول في منطقته' },
