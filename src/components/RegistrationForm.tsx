...
interface FormData {
  ...
  plan: 'monthly';
  /** إضافة برمجية متقدمة (Add-on): المناوب الرقمي — ماسي فقط */
...
const SUBSCRIPTION_PLANS: {
  ...
  },
  {
    ...
    features: [
      ...
      { kind: 'line', text: `🏛️ Add-on اختياري (+${DIGITAL_SHIFT_MONTHLY_ADDON_SAR} ر.س): إضافة المكتب الخاص — مساعد داخلي في لوحتك + مناوب شات للزبائن، مترابطان` },
