...
/#/coiffeur/need                استعلام المستعلمة — قطاع نسائي فقط (مشغل/كوافير/سبا/تجميل)
...
**استعلام كوافير ماب منفصل عن بحث حلاق ماب للرجال.** المسار `/#/coiffeur/need` لا يستدعي قائمة الصالونات الرجالية ولا يحوّل المستعلمة إلى الرئيسية. النوايا: كوافير نسائي، مشغل تجميل، سبا، مكياج، أظافر، عناية بشرة. لا تُخلط النتائج مع حلاقة الرجال.
