...
assert.equal(
  resolveMensHostStoreRedirect({
    host: 'www.halaqmap.com',
    hashPath: ROUTE_PATHS.STORE_PRODUCT_BENEFITS,
  }),
  'https://store.halaqmap.com/#/store/benefits',
);
...
assert.equal(
  resolveMensHostStoreRedirect({
    host: 'www.halaqmap.com',
    hashPath: ROUTE_PATHS.STORE_GIFT,
  }),
  'https://store.halaqmap.com/#/store/gift',
);

assert.equal(
  resolveMensHostStoreRedirect({
    host: 'www.halaqmap.com',
    hashPath: ROUTE_PATHS.STORE_GIFT_TERMS,
  }),
  'https://store.halaqmap.com/#/store/gift/terms',
);
...
assert.equal(
  resolveMensHostStoreRedirect({
    host: 'www.halaqmap.com',
    hashPath: ROUTE_PATHS.STORE_KITCHEN_GIFT_TERMS,
  }),
  'https://store.halaqmap.com/#/store/kitchen/gift/terms',
);
