...
assert.deepEqual(
  ...
  [
    ...
    ['grocers_mobile_6', 799, 99],
    ['grocers_mobile_12', 1250, 250],
    ['restaurant_6', 699, 99],
    ['restaurant_12', 999, 199],
    ['restaurant_mobile_6', 799, 99],
    ['restaurant_mobile_12', 1250, 250],
    ['cafe_6', 1199, 199],
    ['cafe_12', 2099, 499],
    ['cafe_mobile_6', 799, 99],
    ['cafe_mobile_12', 1250, 250],
    ['kitchen_6', 300, 100],
    ['kitchen_12', 600, 200],
  ],
);
