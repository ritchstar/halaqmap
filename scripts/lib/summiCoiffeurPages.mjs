...
export const SUMMI_INTENT_PAGES = [
  {
    ...
    lead: 'تبحثين عن كوافير أو مشغل قريب؟ اضغطي البحث واسمحي بالمكان.',
    aliases: [
      'أقرب كوافير',
      'كوافير قريب',
      'كوافير قريب مني',
  ...
  },
  {
    ...
    lead: 'تبحثين عن كوافير نسائي قريب؟ اضغطي البحث واسمحي بالمكان.',
  ...
  },
  {
    ...
    lead: 'تبحثين عن مشغل تجميل قريب؟ اضغطي البحث واسمحي بالمكان.',
  ...
  },
  {
    ...
    lead: 'تبحثين عن سبا أو مساج قريب؟ اضغطي البحث واسمحي بالمكان.',
  ...
  },
  {
    ...
    description:
      'ابحثي من موقعك عن مكياج وسهرات. اضغطي البحث واسمحي بالمكان — تظهر المشاغل القريبة للتواصل والاتجاه.',
    lead: 'تبحثين عن مكياج وسهرات قريب؟ اضغطي البحث واسمحي بالمكان.',
  ...
  },
  {
    ...
    description:
      'ابحثي من موقعك عن عناية أظافر. اضغطي البحث واسمحي بالمكان — بلا تطبيق وبلا حساب.',
    lead: 'تبحثين عن عناية أظافر قريبة؟ اضغطي البحث واسمحي بالمكان.',
  ...
  },
  {
    ...
    lead: 'تبحثين عن عناية بشرة قريبة؟ اضغطي البحث واسمحي بالمكان.',
  ...
  },
  {
    ...
    lead: 'تبحثين عن مستقلة تجميل قريبة؟ اضغطي البحث واسمحي بالمكان.',
...
export const SUMMI_HUB = {
  ...
  description:
    'ابحثي من موقعك عن أقرب كوافير أو مشغل تجميل. اضغطي البحث واسمحي بالمكان — تظهر المشاغل القريبة للتواصل والاتجاه. بلا تطبيق وبلا حساب.',
  lead: 'تبحثين عن كوافير أو مشغل قريب؟ اضغطي البحث واسمحي بالمكان.',
};
