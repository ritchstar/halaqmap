...
function cityCopy(nameAr, slug) {
  return {
    ...
    h2: `حلاق قريب مني في ${nameAr} — مفتوح الآن ابحث واتصل فوراً`,
    content_paragraph: `تبحث عن اقرب حلاق أو حلاق قريب مني في ${nameAr}؟ حلاق ماب يسهّل عليك استعلاماً لحظياً عن صالونات رجالي قريبة ومفتوحة الآن في ${nameAr}، مع تقييمات حقيقية واتصال مباشر بالصالون — بدون تحميل تطبيق.`,
    title: `اقرب حلاق في ${nameAr} · حلاق قريب مني | حلاق ماب`,
    description: `اقرب حلاق وحلاق قريب مني في ${nameAr} — حلاق قريب من موقعي، صالون قريب، مفتوح الآن عبر فزعة حلاق ماب. ابحث واتصل فوراً.`,
...
const MAKKAH_PILLAR = {
  ...
  pillar: true,
  h1: 'اقرب حلاق في مكة 🕋',
  h2: 'حلاق قريب مني في مكة 🕋 — مفتوح الآن ابحث واتصل فوراً',
  content_paragraph:
    'تبحث عن اقرب حلاق أو حلاق قريب مني في مكة 🕋؟ حلاق ماب يسهّل عليك بدء استعلام لحظي عن صالونات رجالي قريبة ومفتوحة الآن حول مكة، مع تقييمات حقيقية واتصال مباشر بالصالون — بدون تحميل تطبيق.',
  title: 'اقرب حلاق في مكة 🕋 · حلاق قريب مني | حلاق ماب',
  description:
    'اقرب حلاق وحلاق قريب مني في مكة 🕋، حلاق قريب من موقعي، مفتوح الآن وحول الحرم والعزيزية. للحاج: حلق وتقصر عبر مركز النسك ثم ابدأ الاستعلام من فزعة حلاق ماب.',
