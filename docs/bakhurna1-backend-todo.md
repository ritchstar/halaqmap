...
هذا المستند يشرح ما تم بناؤه فعلياً لمنتج **بخورنا1** (محل بخور وعود وعطور في الحي)، وما تبقّى من عمل خلفي (Supabase / Vercel API / Moyasar) لتفعيله كمنتج كامل يماثل باقي منتجات "منصة طريقة الحل" الحيّة (تمرتنا1، خضارنا1، تمويناتا1...).
