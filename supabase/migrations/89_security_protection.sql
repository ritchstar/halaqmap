...
-- =====================================================================
-- ⚠️ بعد ترحيل 74: أي CREATE TABLE جديد يحتاج GRANT صريح لـ service_role
--    في نفس الملف — RLS وحدها لا تكفي. أُصلح لاحقاً في 20260910180000.
--    انظر supabase/migrations/README.md
