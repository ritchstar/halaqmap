-- بحث جغرافي قابل للتوسع: فلترة + ترتيب هجين داخل قاعدة البيانات
-- يعتمد على PostGIS ويعيد نتائج جاهزة للعرض دون تحميل كل السجلات للواجهة.
...
SELECT
  ...
  (
    ...
    END
    +
    -- distance decay component (35%)
    0.35 * EXP(-b.distance_km / 10.0)
    +
    -- bayesian rating component (30%)
    0.30 * (
      (
        (
