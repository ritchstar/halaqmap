...
CREATE TABLE IF NOT EXISTS public.listing_license_products (
  ...
  service_description_ar TEXT NOT NULL DEFAULT 'حزمة رخصة مسبقة الدفع لخدمات الإدراج الموحّد للبرمجيات',
...
INSERT INTO public.listing_license_products (
  ...
  ('bronze_30', 'bronze', 30, 100.00, 10000, 'حزمة رخصة — إدراج برونزي 30 يوماً'),
  ('gold_30', 'gold', 30, 150.00, 15000, 'حزمة رخصة — إدراج ذهبي 30 يوماً'),
  ('diamond_30', 'diamond', 30, 200.00, 20000, 'حزمة رخصة — إدراج ماسي 30 يوماً'),
  ('bronze_180', 'bronze', 180, 600.00, 60000, 'حزمة رخصة — إدراج برونزي 180 يوماً (تحويل بنكي 6 أشهر)'),
  ('gold_180', 'gold', 180, 900.00, 90000, 'حزمة رخصة — إدراج ذهبي 180 يوماً'),
  ('diamond_180', 'diamond', 180, 1200.00, 120000, 'حزمة رخصة — إدراج ماسي 180 يوماً'),
  ('bronze_270', 'bronze', 270, 810.00, 81000, 'حزمة رخصة — إدراج برونزي 270 يوماً (عرض 9 أشهر)'),
  ('gold_270', 'gold', 270, 1215.00, 121500, 'حزمة رخصة — إدراج ذهبي 270 يوماً'),
  ('diamond_270', 'diamond', 270, 1620.00, 162000, 'حزمة رخصة — إدراج ماسي 270 يوماً')
